---
id: 8210
title: "Claude 顶不住了：先限额，再封号，最贵那批用户开始被清退"
url: "https://mp.weixin.qq.com/s/mGZFNVCOOe5gsQ3NrCaxCQ"
publish_time: "2026-03-31 11:02:06"
account_name: "InfoQ"
read_count: 55338
like_count: 268
share_count: 1876
see_count: 75
comment_count: 85
stats_updated_at: "2026-07-04T08:55:10.975Z"
is_unavailable: 0
...
# Claude 顶不住了：先限额，再封号，最贵那批用户开始被清退
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNg38al8WZwpDy7eU9N1ZXISDSeBsCwljeQsLnKhyjkV1ZFX3mVWrOHfUmxyO5dbE0zLtVdvh57TyZSE1nPg4Rof3uryknOO2VI/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNjwbazG3EOpme2iclMQstcdb133nwl3MkhqJ1GibDWcyyqQxnsjEsvsdicrwic6ibMCnGvLfRwHADGL920ufnGEoG6hwElaaRGviaTQY/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNhhxicu8jy7uVrkQKbBgTelODSsFh1BdBlOFWpSanmkSPm0qgzhBgI8icQjoicNCEUyhu690zgZwBs0WOQh12RwkibTFYKMsvdzB5M/640?wx_fmt=png&from=appmsg)
...
在这一调整公布后，很快就有用户从实际体验中感受到了变化。

3 月 30 日，有订阅最高档 x200 套餐的用户表示，自己过去几乎从未触及每周限额，最多也只是偶尔在重置前的最后几个小时用尽额度；但在本周，仅仅到周一就已经耗尽了全部配额。

![](https://mmbiz.qpic.cn/mmbiz_jpg/hLLZnAbUwNjx5qT1dvX4HviboByNATSASPclxvQcSmTvibk8rzR8QqG8ibfOpWmHQsmicshkkdFzOANcb6ymG97nk2KpVbQc93UnotmONehPScQ/640?wx_fmt=jpeg&from=appmsg)

一位 Pro 用户表示，从 3 月 29 日开始，自己仅发出几个 prompt 就撞上了使用上限，而几天前，同样的操作最多只会消耗 5% 左右的额度。

![](https://mmbiz.qpic.cn/mmbiz_jpg/hLLZnAbUwNgrWibUGf0V5KETPP04ceQ8yUECu22Sf2NlJfDjCIAPxfO5H3TZuKozDAXUMxVb5arYsP8BtEpCvRFI2t35J1FiaJ1VkmIFh9O2I/640?wx_fmt=jpeg&from=appmsg)

![](https://mmbiz.qpic.cn/mmbiz_jpg/hLLZnAbUwNjxJLOiaCLsLxq4kuMWRqlsGialKtUsBBe9tPpTlu4MBteM3c6NRqMY7Fw679307U1GcnXRqEowZOZGNSVhFuiaicJYY7wqkeDhnMY/640?wx_fmt=jpeg&from=appmsg)

在 Opus 4.6 模型上，当会话 token 消耗超过约 20% 后，性能会出现显著下降，模型开始变得不稳定，甚至接近不可用，原本号称可支撑 1M 上下文的能力，在实际体验中也仿佛失效；相比之下，0% 至 15% 的使用区间反而最稳定、最好用。

![](https://mmbiz.qpic.cn/mmbiz_jpg/hLLZnAbUwNjVr0nHtbhhia5ErmDSjVPYWlrtp5fYdUI9eGtHXX2nibfj2AwJnNpcpQsFgML9Cz9jme16NIvWkkqwRuPJoLBKicWUrYfwJTAJEE/640?wx_fmt=jpeg&from=appmsg)

这些反馈并非零散个案，而是集中出现在高频使用、长上下文、多任务并行的用户群体中，也正是当前 Claude 成本最高、使用最重的一批用户。某种程度上，这也意味着，今天最先感受到“额度被收紧”的，并不是偶尔试用的轻度用户，而正是那些把 Claude 深度嵌入日常开发流程的高级用户。

3 月 29 日，一位重度用户表示，自己在持续高强度使用 Claude 一整年后，于当天被平台 **直接封号。**

**![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/hLLZnAbUwNhzPC4qIG5APR5WCIynBwwLY84wlgUibv9K4lhaibag0xKRQ0iaL0xj476sIMSoC6W6a214Ltck5RbmPo7aeUjZq0ITfIAMWk1DBw/640?wx_fmt=jpeg&from=appmsg)·**

他称，过去一年里自己长期打满使用额度，支付的费用甚至达到 Pro/Max 月费的 20 倍；与此同时，他并未使用 OpenClaw、第三方工具、Agent，或任何违反服务条款的方式，只是进行了合法的重度使用。

在他看来，平台这样“随机清退”付费最高、最忠诚的一批用户，不仅对客户极不友好，从商业上看也是一种极其糟糕的决策。“你要怎么用这种方式留住用户？还是说，你的目标本来就是把那些消耗算力最多的用户清理掉？”他质疑，Anthropic 需要给出更透明的解释。

**他随后讽刺道：“如果你还没因为太烧钱被封过号，那你还不算真正的 Claude Code 高级用户。”**

对此，Anthropic 官方也在第一时间作出回应。3 月 31 日凌晨，Anthropic 发言人 Lydia Hallie 表示，团队已经注意到“用户触达使用上限的速度远超预期”，正在积极调查，并将其列为当前最高优先级问题。

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/hLLZnAbUwNhkOt6w207ibl8CGoBjKOj6javibKLcX0OibkU8Mv1foaMKEQVwymqwibryFsEL4ctAFMicv3ticr1FhAd4ibUfNAskATZlbN7cfJvfmc/640?wx_fmt=jpeg&from=appmsg)

所以结合来看，尽管官方强调“总额度不变”，但在实际使用中，部分用户，尤其是高频用户，在当前阶段可实际使用的有效额度，**已经被实质性压缩。**

而且还有用户反馈 API 消耗也不正常。

![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNhSAtC917NaictXtibG5JLBibFUlQB1S6M01iaOae8pUxvzFhskzkfDRr3b1iaDeia8RvoCjrKXibpUibvnO2deTSnics4CatyDjABV1OS4/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNhYMIVibCDxtCMDjW7ykBnAec4fuRTC4IicKFCn3fibzYicWMITzRdYxEhTLuVDV08QOqLaT4Wuia5bUSbOB1vjXicQTiazkNOqRWE7MA/640?wx_fmt=png&from=appmsg)
...
https://www.theregister.com/2026/03/26/anthropic\_tweaks\_usage\_limits/?td=rt-3a

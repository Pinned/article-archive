...
url: "https://mp.weixin.qq.com/s/UmtvviB5d8liOoTXSGYD8w"
...
see_count: 60
comment_count: 13
stats_updated_at: "2026-07-08T09:58:32.107Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"大模型\",\"高吞吐\",\"代码生成\"]"
entities: "[\"小米\",\"Vibe Coding\"]"
---
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGFFVZ4esicYeOCicncnpX6N81D6pPIx7ADekQGlkRbd49eaKDAQDtFph9xTkYT37Caib9jQZO7GlfHGxicZ6dwt0NzdloZibbQm7HmE/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_gif/A6fTew8FFGHkZNqZvgvCuFdoicVOZxazlHCQXqoIBDzU409anef6vibR8zplskaribYRu58HZA6vfpdBSklbXh5C8aabTFTtlyzqN2Pe1BMU1M/640?wx_fmt=gif&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGFzUjHPn8m4SnvQcyVVh1ovftI6Vw5QIu1dIdnaCGRZ2lxXekRnb1ZUTEutXic0ESMo9cEib9Kx0Mx1JWOfr2libTTec7ib5GKIicPg/640?wx_fmt=png&from=appmsg)

如果看峰值，目测推理阶段最高吞吐量达到了600+ TPS，推理后的输出阶段更是飙到了3300+。

![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGFCJwiaribib0KC45XZtkuiaTeFhtGpSrTyceey9qYIxWpg32Lc4cn5ricDgnzg7gVJpZ94x8HiaEy9j5ezGgkltNnnyYfIqRRXcjZia8/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_gif/A6fTew8FFGH0Md3XQFBgl0Ewt2buFSuHZa7hnvasT3yzUlswJJqAicxQTaLckDicfgSGzfVLEcicUt46Qc6hSKcicTdbSZnwQylSsfeA2zBCQpA/640?wx_fmt=gif&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGGbpNg2vjLia9UVZtlgThJibno1M7rkcI5eSliaXymSnFmxOgapOhN8QEUEWklTcf0GJR1QnL4Mr55lHIBxy3pW4Ansib0XcsUqEwk/640?wx_fmt=png&from=appmsg)

我们直接看运行效果。

首先最基础的实时聊天、上下线提醒、输入提示，全都正常实现。

![](https://mmbiz.qpic.cn/mmbiz_gif/A6fTew8FFGGJKicDUCf5DbzgFZ8cAiapRPbOPFiaV1ZM7gaqCLGqoHbKgH92zKDIDahicFHuuyrp5mpTJ1H3ACFDpIZxMRHLtGAO8jib5G2wV4f8/640?wx_fmt=gif&from=appmsg)

代码、加粗这些特殊格式，也都能正常显示。

![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGF5jR6ygamQLetNI1WSxx8D73NvhM7dcUzqbFd31FyPgHSQ6pvXV6As7UhKJd8LSONYZGUfAiacQSGJbb3VRYpjia4IiaGLRBUVAs/640?wx_fmt=png&from=appmsg)

消息引用功能同样正常运转。

![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGF0hsJZmwk1l13FbOmdosBodSTwQMb67TI8uANl2WDC3iaUYHiaBLOicNHQmOKxdcSICEFmaYFBUEn8wiaibbzVx0mdOQJqjtRMFoCw/640?wx_fmt=png&from=appmsg)

刷新页面之后，之前设定的设备昵称按要求被保留了下来，并且另一端也正常出现了下线提示，在线列表同步变动。

![](https://mmbiz.qpic.cn/sz_mmbiz_gif/A6fTew8FFGGgGHg3xR8IcK9OibicNDqnqaf77rpUyfE8nQv4je77bGVBAIZ53gbxia8huXSlgiaHg4ULTKLhZhlI50UHO5IJaSicyt9Sy8Rr7icgU/640?wx_fmt=gif&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGGXkosQO8FM2XoHWbNibhaoycxAYwRia5mia690Liaj5fyw9PAYUbcQIDZYRblaibDbeDJwChD46LBP8LKE4Uc0ibCfO98zibYoWZvRDo/640?wx_fmt=png&from=appmsg)
...
1000 TPS在这里的价值，是**让多Agent协同从理论上可行变成用起来真的流畅**。
...
为此，小米**从模型层、引擎层、系统层三个层面同时下手，进行了全链路的联合设计**。

![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGE6vfONCLMyhFic70QsiboSesdibAkJPGvE6DxJmU5aRKoQHTmKRZEjibWjl8zj4iaiaZoJRiazlxRLnleW8xeMkicV2iaYHxPqLlUjSmDk/640?wx_fmt=png&from=appmsg)

模型层承担了两件事，一是解决1M超长上下文下的计算压力，二是处理参数带宽的压力。

针对上下文问题，MiMo-V2.5系列采用了**Hybrid SWA**（混合滑动窗口注意力）架构。把注意力机制拆成了两级。

具体来说，模型只针对最近的一段上下文继续做精细计算，更早的内容则先被压缩，以更低的成本参与后续步骤。

这种分层处理让整体计算量降到了Full Attention的约1/7，1M级超长上下文下，推理速度和成本依然能保持稳定。

而对于带宽问题，小米**对Expert模块引入了FP4量化**，把并行的Expert模块参数压缩到4bit，从源头减小显存占用和读写压力。

与此同时，负责信息路由和关键逻辑的注意力模块和Router模块继续保持高精度，再通过量化感知训练把FP4引入的误差压到最小。

模型层打好了基础，引擎层要解决的是decode阶段的成本问题。

小米采用的DFlash方案**对传统的Speculative Decoding草稿线做了结构性改造**，将草稿模型沿时间轴逐token串行生成的模式，改成对一整块位置同时并行加工。
...
在上述优化的基础上，小米又**与TileRT团队深度协作，在GPU执行路径上做了两项关键优化**。

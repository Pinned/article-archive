...
see_count: 10
comment_count: 0
stats_updated_at: "2026-07-09T02:21:19.748Z"
is_unavailable: 0
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYWic9Yic22KUe9n6cTZiaG1DibQ75VrayMnicmMUlc52e1rAQhaiamsphhaiaY5dWmVRhZ3iaAc23SnKwpYBBMD82Rjxy59YvqBzNliaETA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYWxG3shdficLv03yVPkRXlhhWmDicyA7JE8qVkn4qQvmic3oWPmiab82UgGtMTegB9vFgRicfGFSbvdjOfEMNzzTDib1Ccu4cZcVuvXI/640?wx_fmt=png&from=appmsg)

_图1　CUHK-X 在多房间真实家居环境中同步采集七种传感模态，并面向识别（HAR）、理解（HAU）与推理（HARn）三类任务统一建模。_
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYXTteGSNv91jt0HyNpHVFMP1Mcf6sNI06TDATd4XdIhyxEMlRIfqmlt3QxfkN9eLOhdJ0CaA8zjC6ibe6uycD7IblcRiayuB6Hsw/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYW6ibecrwribIgjicDAtX5P0ptLT8jj5qhvNph2wgZ3fgoUnFYVG87Gcibk8dicX6Ljparbu8ulyP5sShicvYpa0s53muTIyJvYmPYmA/640?wx_fmt=png&from=appmsg)

_图2　CUHK-X的数据生产链路，从动作筛选、场景化描述生成到按描述采集多模态数据，最终汇成三大基准。_
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYXzFnZzCEYFPBtxlcDYbRVR22IOiaCbrTcIu9RavUgNl6licTllsQFiagP24d1lu22KeYK4UUkib7O5L9QHnuvEvRy67062MU4HmHQ/640?wx_fmt=png&from=appmsg)

_图 3　环境侧传感器与可穿戴 IMU 的部署方案。_

![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYUoccxwLsibyBvxibLc5SicQbibmPVEKHpTHyO3uG1iaEPsAnZcR1xItGdRLShqdBZAxGKZ1yp3QjwaBFJiccic8icyHLP5uULJanJQd8g/640?wx_fmt=png&from=appmsg)

_图 4　同一组日常活动在七种模态下的同步可视化，直观体现各模态的信息密度差异。_

![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYXHHhcPktX3nBDFRJvMGh9S9SdTjicUWGpxZBvJGPLeae0rtrTU1bTvwgWBOkoGGCPx6B6k13dic8s4MtaUgKb1gibyfJ0icUpSpK0/640?wx_fmt=png&from=appmsg)

_图 5　CUHK-X 数据规模与类别分布概览。_

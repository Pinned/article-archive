...
url: "https://mp.weixin.qq.com/s/4iiOwMDh9YvN9NM3tJ6hsQ"
publish_time: "2026-04-27 14:32:53"
account_name: "InfoQ"
read_count: 4162
like_count: 74
share_count: 278
see_count: 65
comment_count: 0
stats_updated_at: "2026-07-09T03:13:33.993Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"数据分析师\",\"AI能力\",\"行动路线\"]"
entities: "[]"
---
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNjx7BCJFbiaicoOzvbE12k94KauKR1Y9EbSjyfEk1vb7AE8Iw2ianC7rK6kibxpC2AOt3lVRgRyUC4c21vbBjZLnyIuGOqA7m2gGcs/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNjeDWbyJp24JEd97rIp3VFsq6tHsR1P67UpcZAHuTVR74BI7V0u1RBHj3G9O8vb1GIICnoiaXiaxLv2vRR2tVOdiacf8Iq66kndgc/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNialXbPejvYBpicVk1yWJOJ7uyUa6V4vMrWMgNthr9cAWHUzIMhyaw8hTHNKGZicWQsLMcfktLPEmvmFMY7Kca2Rxx0WtJ8TdPdgo/640?wx_fmt=png&from=appmsg)

3 成为 AI 工程师之前，首先要成为一流的数据工程师

谈及数据叙事，也许很多人脑海中浮现的场景仍然是数据分析师一个人坐在格子间里，对着 Excel 绘制饼图，这个刻板印象已经彻底过时。

Snowflake 产品数据科学家 Soo Lee 还原了数据分析师真实的一天：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNj9h8KI1bobwCFEM0KK37XLxCp6yZks0xNAG7AztJcoAUH4fcic5MoQs9Cgc9qmrY4QD45DCjNRtjxPof0g0FGLm0WzcM3y86UI/640?wx_fmt=png&from=appmsg)

上午，他们往往不是在分析数据，而是在**寻找和清洗数据**。更关键的是定义指标。当产品经理问“用户喜欢新功能吗”时，分析师必须将其翻译成可测量的 DAU 或留存率。因为数据分析中最危险的情况，是所有人都以为在衡量同一件事，但实际上并非如此。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNjajd5WXck4knpbWSAhxO9ibvb2WAuDkibJ9iahxXQjeQgDiakPoUr0noHRuBhWFAgVWNaUawbLnJ8mPMiaN6jKoxs30yGjlZYa06YY/640?wx_fmt=png&from=appmsg)

4 普通职场人的 90 天 AI 逆袭指南
...
*   第 31-60 天：拒绝被动等待报表。学习 SQL，直接查询部门数据库，识别并解决一个没人注意到的数据瓶颈，构建一个真正有价值的数据故事。这会让你从「数据的接收者」变成「数据的探索者」。
    
*   第 61-90 天：识别工作流中的重大效率瓶颈，尝试用 RAG（检索增强生成）架构将团队散乱文档转化为企业知识库。组织内部分享，向管理层展示你的 AI 应用愿景。这一步要展示的是：你已从技术消费者蜕变为战略型高价值人才。
    

![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNiaicbbJ9ib8icdW3JmyNuRvILGf5KWPjkGZRtxB6vZWXt6nab1OSfiaESaqlECafGzAYuxoGxHmFlAouE9FyDficeYFzORke00NA2AI/640?wx_fmt=png&from=appmsg)

5 One More Thing

AI 写得了 SQL、画得了图表、生成得了报告，但它无法走进一间充满分歧的会议室，理解那个真正尚未被说出口的问题；也无法在数据与对业务的真正影响之间，完成最后一步带有责任的判断。

正如沃尔特·艾萨克森在《创新者》中的一句话：“创新需要清晰表达”，数据本身是原材料，AI 让这些原材料唾手可得。但将它们转化为真正驱动决策的故事，仍然是人类的工作，而且比以往任何时候都更重要。

如果你也在思考如何在 AI 时代建立这种能力，,可以点击【阅读原文】关注FastTrack的官网，可以尝试从 Snowflake 的 Data + AI 平台培训开始，课程涵盖⼈⼯智能、数据云等所有相关内容，你将能够亲⾃动⼿操作，处理业务真实场景中的问题，并获得专⽤账户进⾏练习。免费福利席位有限，欢迎扫码报名～

![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNjYibYqN1RQ4wtxEgk6EZliae8j80eGmXNKBxCQj9RYeH490U3qHiaBmmjFW1jFZ5b9xP9SREJicOz5cxjhusklCulOUARWAaLZbRE/640?wx_fmt=png&from=appmsg)

...
url: "https://mp.weixin.qq.com/s/55j_SxPGtIFTOhzkQQuGog"
...
see_count: 212
comment_count: 10
stats_updated_at: "2026-07-04T12:33:09.802Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"Skills\",\"Agent\",\"智能体趋势\"]"
entities: "[]"
---
...
![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtD2Sj5Ng8bygJiciaMuQEaSWqaNAZvjfWX3tuMkwl0x0ib0OFqyo6b7iauzghiauy371BgsuUbPDiazW6Ew/640?wx_fmt=png&from=appmsg)

是的，完全不需要人类伺候，也不用给AI师傅递板手、搬梯子。

工作中遇到啥需要用的装备，Agent能自己直接「进化」出来。

以Gemini 3 Pro为后端，在地狱级评测HLE_（Humanity’s Last Exam）_上一骑绝尘，仅次于GPT5.2-Pro智能体。
...
![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtD2Sj5Ng8bygJiciaMuQEaSWqm4DAPkawLdxlMsQfNGuXeMqKicGrib5P2pnJNs9x36NyBHhgW14JicMlQ/640?wx_fmt=png&from=appmsg)

然后Agent开始做分析、规划任务，挑选可能会用到的工具。

目前为止，一切都还很正常。

![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtD2Sj5Ng8bygJiciaMuQEaSWqGdnbGiaeqlIF5yyWTRicIfvjLJ8dpHMFrNfyibvw3YbdLt1xOFh1rP4JA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtCuZXBJGH8pIVtSjAfFpw7R0HLym8uUqGJFdJGLoQeo2AsQK0nyPa1FXl6f1G6PziajxViafRq0rVtA/640?wx_fmt=png&from=appmsg)

![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtCuZXBJGH8pIVtSjAfFpw7RGwEick0wOFOlGxR3AFdHQYV86FkDRkcCVfO74xDbnSORxF0gBicvAVdg/640?wx_fmt=png&from=appmsg)
...
更惨的是，研究人员还一上来就把它扔进了地狱级的Benchmark—HLE_（Humanity’s Last Exam）_上，和基于GPT、Claude、Gemini的这些Agent怪物同台竞争。
...
![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtCuZXBJGH8pIVtSjAfFpw7RJjMIGZukjWjNvFobpwJ5jAbQ0wicbe8CXFoLczMv0SgpAtEJfDeVMRQ/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtCuZXBJGH8pIVtSjAfFpw7R8Xdr8AeHPicNA3wkH8VPse2edichiay1bzOqKjP3mtqibL0Hl6rcqVSy5A/640?wx_fmt=png&from=appmsg)

###### **△**不同策略下的Agent性能统计

下面这张图更有意思，这是这个Agent最爱用的50个工具。

![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtCuZXBJGH8pIVtSjAfFpw7RSOKY1wVZecuL4ICicfGbFzLchPL8IfXCxmDxJnpEibwCFgMMa1t7FbuA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtCuZXBJGH8pIVtSjAfFpw7R2bwiacMib89oRzuHOgZhD962yybN6FE3ldZAiaGGK6nFPiaES4lpMZ6qCw/640?wx_fmt=png&from=appmsg)
...
研究团队用了一种**全新框架**，叫**原位自进化** _（In-situ Self-evolving Agent）_。

第一眼没太看懂，但隐约感觉是个很性感的概念。

仔细研究了一下，发现行业其实一直在做自进化_（Self-evolving Agent）_，但和原位自进化是两件事。
...
![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtD2Sj5Ng8bygJiciaMuQEaSWqxwmUqekSQyOwu9C7aTUwSEF4rzx2Cctp7ibjo1kRpTEyffNCsQp1icEA/640?wx_fmt=png&from=appmsg)
...
工作流好不好、记忆靠不靠谱，很主观；但工具能不能用，直接看代码报没报错就行。这就是所谓的**二元判别信号** _（Binary Feedback）_。
...
首先是**管理者** _（Manager）_，负责统筹大局。

在收到用户需求后，它会分析任务、拆解目标，并与现有工具库对齐，看看有没有现成工具可用。

如果发现能力不足，管理者就会指挥**工匠** _（Tool Developer）_，现场捏一个工具，并立刻在当前上下文中完成配置。

准备就绪后，**执行者** _（Executor）_会拿这些工具开始处理任务。

如果发现还是搞不定，它会暂停执行，向管理者汇报。

管理者收到信息后，重复前面的流程，继续补工具、补能力，直到任务能完整跑通为止。

任务完成后，交给**整合者** _（Integrator）_，对执行历史和中间结果进行整合，生成最终回答。

![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtCuZXBJGH8pIVtSjAfFpw7R79ictkaZBpCpHxRBwZBHibA8WMeEMTnuMkENibLEPXdSOm4TSPpHbyfYQ/640?wx_fmt=png&from=appmsg)

还有最后一步。

对话结束后，系统会对整个过程进行复盘，更新自己的工具库，并将迭代过程蒸馏、沉淀为可复用的方法论。

为了能更好地监测Agent的进化情况，团队还引入了个叫「测试时收敛」_（Test-Time Convergence）_的定量指标，作用和传统优化中的Training Loss类似，方便直观感受AI的学习情况。

![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtCuZXBJGH8pIVtSjAfFpw7R4TDH0dxxewMibrn3370BOamOib8n0V8RF0JCoibLT9aAdIvKwV3e4mj0Q/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtD2Sj5Ng8bygJiciaMuQEaSWqO4ibMakEVeJic9jdflGoialnYAJZjwWYtxkUqqIdxSyUunPH2f1C7mribA/640?wx_fmt=png&from=appmsg)

齐炜祯曾任中关村人工智能研究院研究员、中关村学院大模型博士培养方向导师。现在虽然投身AI创业，但仍以兼职身份担任中关村学院的科研共建导师。

他是MTP架构_（ProphetNet）_的第一作者。这套多词元预测方法，在Meta研究机构FAIR 2024年的高影响力论文 Better & Faster Large Language Models via Multi-token Prediction中，齐炜祯第一作者研发的ProphetNet，被明确视为提出多Token预测架构的原创来源和定义出处。
...
在推理优化方面，他是业界首批提出**KV Cache优化** _（EL-Attention）_的学者，其核心思想与后来DeepSeek提出的MLA等高效推理部署算法高度一致。

谷歌学术显示，齐炜祯的论文引用数已超过3000，h-index为17。

![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtCuZXBJGH8pIVtSjAfFpw7RUSy8tjzy3Nu2ibZcJO5lufp5ECqK4Sia2M5NqEYpVChNiapyrZibMYHrGw/640?wx_fmt=png&from=appmsg)

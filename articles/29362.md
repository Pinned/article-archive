...
url: "https://mp.weixin.qq.com/s/u6-CbyiQ-uhXi6cwyNlomA"
publish_time: "2026-07-08 09:24:54"
account_name: "机器之心"
read_count: 3024
like_count: 50
share_count: 254
see_count: 15
comment_count: 0
stats_updated_at: "2026-07-09T02:51:45.099Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"强化学习\",\"单层训练\",\"参数效率\"]"
entities: "[]"
---
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGefxac5uC4EdwcaLaAz7viaSs1ic0VkzGmoA3wG1h7DSxVvEq1RVfr9bfOhjWQH7P7o4c7WvdCRxeVib337micVRWibhaiatsh5e3Ck/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGMicBf3OCPcoRnv9EFWnssoiaiaa7ursfsHPTkibibPgNQCjVvibgJzaibMqQvZbBxavPJ8JOdPapVa1QBc5xLwqD2aiagWsWBNWvib6pQ/640?wx_fmt=png&from=appmsg)

图1：层贡献度计算公式

  

其中 S\_base 为预训练模型的评测分数，S\_full 为全参数 RL 训练后的评测分数，S\_k 为仅训练第 k 层后的评测分数。C(k) = 1.0 表示单层训练匹配全参数 RL，C(k) > 1.0 表示超越全参数 RL。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGkWLEeP4ZtDnJCfkdALicTAbJeUEwmNqFmELP1VkZibibDx4icSKLyw1Mgic4jYOuBe9qBQr3qw2EsQuPJHEnVGbATek4ZNQUOFlvo/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqF2w9UgS8OCp8o4WRIArAiaoiaOLwbhfnhLZibWeZtYwquMZxYXauRuAl6TZgq77Z7leDFRt3XTshBAzTCPD9NhxWjNqRiboQ9z01Q/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGw3P9UTtdiaKVzbGmC8MYjEcQh7S83mxiblW3JqSYicU32N4JqiaLyFaC0DEYICRia1RMCTOVeDtGI0H5pFkm5ibCiamJJ00nRia83mN8/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGTuCYR9uYtsEU4Asa1BiaaceuBXjo8BU0ygP3KW7HAibY9xyaqzmDRfMxlUxupdKTbibmXaMBVIgWL4gYhKqN1WBSkMpibM2ZJ0NY/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqHvDb1icHOU39fLbkS3ficPqWVibHw0ibQtBgow04baUjo2Am8iaTPnuLVIw7X7US1oBnQJocJeRP6jD9kZ337d174BVR4l2dkEwibT4/640?wx_fmt=png&from=appmsg)
...
**这些结果共同表明层贡献度是预训练模型的一种内在结构属性，由模型权重决定，而非取决于训练数据或任务。**
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqFa8wic512ebMeoOgSGvy8YQweYw7lFacucXQe8ibEUlN7WgqFiaMxeW2Wkquh6sZukx6NNRFt6gmcV1yhBcy2AtgNSc7r5tqTAE8/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqETOia3iaYcjGSsKZ8a4guh0u3zRVSOPuO9m8yJkxxyYOPZJ2Qiam5h0pUs0fSfEj3La9Y7Pakl4ln5eiaaHP8MOOg2wr6PjnxPTBE/640?wx_fmt=png&from=appmsg)  
...
为此，研究团队在 Qwen3-1.7B-Base 上测量了每层的权重变化幅度 ‖Δθ\_k‖₂，得到两个关键观察：
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqEOmWSJKu0XUvN3YmhclFQkqMdnyltlDOicwCM2lduSicHVeTCE1vdkAOWHXbT2fdRYfE0iaF059yP1hdkrE4YGeMAd75wUiawiaPMU/640?wx_fmt=png&from=appmsg)

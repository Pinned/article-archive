---
id: 688
title: "面向 AI Agents 的高性能数据基座：架构和工程实践"
url: "https://mp.weixin.qq.com/s/5bUknFoyTIeqi3iabNfEcw"
...
see_count: 22
comment_count: 2
stats_updated_at: "2026-07-04T08:59:18.141Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"AI智能体\",\"数据底座\",\"工程实践\"]"
entities: "[]"
---
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNj0qsRYM0MEvt6BZwHEsA0KibM0YhEibh7QicQpN2hBnHHQQBc3vdjxZhia85DH21B6EIaftxyalGYhuibwmAXY50SOkU5TWeaJYUkw/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNjhDniacoXSfacibcT8q7d47vibL7SButQiaf4LicPDCun9A0NIQ6z8k7mLTcWhzzBTicvCE2GQ2rQLwSlsEVbcYXWyUYNy6GlOg57Mw/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNhCUL7KkhcltaRy6ey8MwVdEV75bu0pcOq3ChHTwrGOdjjicUyXOJ8e7q29Qpq5Krcazd8quURhqsODQOhbUial4MCMianS1LmW2M/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNg21YGXtUyJETbnfRF43R6IJNGr306ZhOrxkDjfK5yCP4HMApkLHeGT7hrMoTZkEw1besBicj1JOf1LqJDh9qs9jaPEZhzYRpy8/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNgKERhcoIKQLrhudQpIAFeOLdx8UJKeU5gbJ4SmhcDicANibox7QtKZTOPhQvpQq4Ulej9UxiaLuuwbsnk7ghX9ibw8IK8SXiciciby2w/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNia6zRRkJ4f9tbsbOUNv3HRNLoPNLgeibxuj8H5rAoNUqiaB9EQ4RkMjMmByouwBMLdZ2ia7DXzDibsQ44dyicCxGb1NIOc4NxquVx0c/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNje0INrgibf9Egiba27aWTOdAOcrXZTPJukMkxrYpnYt2Xqt6ue2UrYicV3c5jk3L22ibF3e316QhBYicfjw4RZ9QiaPoVsHr3dGzxqY/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNgkNEicticeaUmkN0OVPXibJcnCYckrEf0fqfkkanaGaSFJWheicfoHuicgIficicHQToq6MdsiaQO3WaOm6LUrpqUiajNggG1T7IXcQN8s/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNh7kLgdw45GVgPpyJm2NZryibY0wcB30vibEjFHwQSJ1qiaGo7ZBGnXvicLiaibcYrR5MVSP5V5YrIiaWKZJmicDQwtDiaz67Vc0t2yiayV0/640?wx_fmt=png&from=appmsg)

总的来说我们会有一个逻辑上的分布式哈希表，它不是简单的 string，是一种复杂的数据结构。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNiaicXias0iaxWvRdCoDYUgKcD1iarDqGDaH8VtXUANT6TO8c5trCUx02odXEkuvOzibDWsTzltViaQXQTpgRwzuGScyicZqZBSSKGsTJk/640?wx_fmt=png&from=appmsg)

缓存和存储之间还会有互动，当数据做更改之后，缓存会用异步的方式把它存到存储上，实时操作只会更新到日志里，不会触发持久化存储。

![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNgSUBZBy3coD5XGjWGLIcQ3ChVGoZogSL8eX41QXeMPu3f4iaIRXMrFqmJjicZpzQDQVJL36S4v6yNTApgnBiaDLJ1BexXk1ErOYQ/640?wx_fmt=png&from=appmsg)

最后我们还有一个容错和恢复的协议。

我们这样的融合数据库，希望能通过一个数据基层，在融合缓存上装配各种计算引擎。因为缓存和计算是物理耦合的，所以性能可以做到和原生一样好。同时我的协议也是完全兼容原生的。

![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNg4RjwhiaQ8Yv0chxQOoDHz0xRYdVHYzJPPAmjyOJ77B4goKK09fdLfRmsy2AnqAED1oXu3HtKpy6XLsTbY9YdNGG2tz8rf47kg/640?wx_fmt=png&from=appmsg)

这样我就可以支持多种模态，兼容现有标准，同时满足性能需求，并做到统一的运维管理。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNiaVicqDiaxwPepAPllJA3VwTCfqpiaHy1vSHNJicicFbP3j9m8NLMpZxurHrI7ELicmBq9iaUuGqc2J2ibdlQglhVT4OZh1dhSfMkxkYwo/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNjnl6caYEYJ7z4BgUoZ3zEsy4pn4amIBC2MJciaibicluReRM3hor226O4s1oCdiavyycaIfTTX73ia5ibFlByibU9lYhoqa7oO9THjWc/640?wx_fmt=png&from=appmsg)

针对这个问题我们做了很多事情，比如说我们所有的执行都是协程，比如说我们都是要异步编程，比如说我们每个核心只有一个线程，最后我们希望能采用一些缓存友好的数据结构。这些都是为了降低 CPU 的负载。

![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNgvtKhN7WgQlvKFLf4kj5jRzCKlqDgrHfltdiaMcaZV0C59HyvzzjOs80BudEKicibYdYbmpVuD9J78pZfWcQE6MqicMIW4DkpNXAk/640?wx_fmt=png&from=appmsg)

我们公司还做了一个试验性的存储，它是一个 k-v 存储，是多读单写的。我们每个查询做一个协程，提交后切换协程。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNiaRBUxLOxHA4iaCKa3pIv6PcT3MpXL7quYskOsibkPSfDTMiau6hiaYuUWdyMlsMRZboCE9H51hkOMSnFZpYWibEMxJBGdTp4RibDvDk/640?wx_fmt=png&from=appmsg)

然后我们做了简单的测试，就是我们有个 16 核的机器，故意把缓存设成了 4GB，就是为了看数据不是全部缓存在内存里是什么表现。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNiaiaXUmcYxBIzTNtBIWiacDI80bSBNgoGppk2nwyRxIOV5Eve8ibnibYicpFCiapGFMZSnPibJoaecoKsXON3nAaw2TeNvibML5DfeibkJ0/640?wx_fmt=png&from=appmsg)

结果发现在同样的 CPU 下，我们的设计可以做到接近理论上线，比 RocksDB 高出很多。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNgR82aqD63nYdCkb85a3lDzAeLQMy7DdAHiaqKH5WOmYg7cMbFdKpeyObzRUKIIo60iccsPqMRLRibWJic6ickN7dXtxGEoeoz4sJXA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNjFD5TuXe3pMbbg76osMnRjOE0JbX5afib6AYhReVbaODgCbqtzV93NfWLatwqozU4DAYBupr0IscBHvQNwM7vy3uNYS1POP4BE/640?wx_fmt=png&from=appmsg)

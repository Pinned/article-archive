...
url: "https://mp.weixin.qq.com/s/H26YZeHvAU3kaDKYA6PDcQ"
publish_time: "2026-07-09 15:50:45"
account_name: "InfoQ"
read_count: 19598
like_count: 156
share_count: 696
see_count: 61
comment_count: 63
stats_updated_at: "2026-07-16T06:51:45.145Z"
is_unavailable: 0
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/hLLZnAbUwNhVAhNTCiak8ut10WOdkTDibSFjEtvSiaKArvJrSmB2I6JITHmicJP95RzHgicHSxhzU5So3EciafI79ic7IBRFWgeicCqEmHmJXel4vGg/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/hLLZnAbUwNgFZOBog65zWibGryCsdWpTPPiamQyUEfooJL2h4VmkiakmIJE9f8XlMicGUfkX7GHdkiaU8GV9icJlT0ictRibhNzKIX2fKc4aFicPbU6I/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNjbPwOZJrkRCNGHL7qyQAIiboRU30D1SITdXztZbPf0EKAW80Jwf4hBtAqYbicFKUjkrvCN5MtrPdZ2icWjfYskicmD2aJBHDSS6Qc/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/hLLZnAbUwNia1J8omvqct2mFOqkuZwrJheicaLbs4FZiaOLObCxiaNdXibghgJbEgavh9TuiaNOymgfA3A6ln1hLBSQLxgbOWdXzbW6yLgzSpp35k/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/hLLZnAbUwNjR9EnfzKIyLgD96picbvicPXa4ldricib7Cn0aeYSicCEXfOrN3hINQic5H7c52AVMwP5YRfzGcnAR91ibWSehoQx25rgZKg9nz2icOog/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/hLLZnAbUwNgKDCQ3PhMGYXn8aVzWsOeHugKIOf6KrsHof8ZZqkXpUHAkKvibaOnWYuJHeHDloN6zt6DozBe3pzCIP1piahMVZajNJDrv6MWys/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/hLLZnAbUwNjZOeFk0bnJLiavPQGIYZWhhmWNIJMo6AicLGw7JnfDw3hk29p78UW8cP7CXziaqhJyAIJCb5mfJyJPc49IiaFVxmpjQGEuAicJmnpw/640?wx_fmt=jpeg&from=appmsg)_Bun 团队随后把这个问题中的 PathString::init 改成了 unsafe fn。_

Sumner 自己也承认，这次重写引入了 19 个已知的回归问题，并表示大多数回归问题都源于语法相同但语义不同的代码。

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/hLLZnAbUwNhA1fPFLe4zdKRF4HVYaa6y4aiaXPldQI9sWiaiaMs4n35yJb0KHRc48awwV5ammfKwyMYNdiaOvPml8jgiclaH1dx9hGv9Nibg1SibBI/640?wx_fmt=jpeg&from=appmsg)

比如这两个代码片段看起来很相似，但行为却截然不同。Zig 的代码 assert 是一个函数，因此它的参数在每次构建中都会运行。Rust 的代码 debug\_assert! 是一个宏，因此在发布版本中，整个表达式（包括函数调用）都会被删除 insert\_stale。

虽然已经问题都修了，但这并不表示百万行 AI 代码就没有其他问题。

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/hLLZnAbUwNiatjWTxSmNyqcaiaSJkxMfcdbgDHL5Ck3E2u6NOZoy6mpEldLRfUDIbc7lQsqN0huUnuEEumYhF3LumPZricibF8vt0b7G5usvoaU/640?wx_fmt=jpeg&from=appmsg)

> 正常人谁会在一个运行时被彻底重写之后，立刻把自己的生产应用迁过去？如果以为 1.4 版本没有引入新的 bug，或者没有带来行为变化，那就太天真了。

还有一个不能忽略的事情是代码审查。100 万行的变更实际上没法由人类逐行看——就算一秒钟看一行，也要连续看 11.7 天；按实际的代码审查速度（一小时 200 行），要两年多才能看完。
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/hLLZnAbUwNgokNlVxhvhh61oLnnZTuPo7OEBLonMibWXWq0a7nRfRJrkV0A8ejCt5nzpZETaVniaF1S8AL8FDSNticOmfDympLef7sYX6LD1wM/640?from=appmsg&wxfrom=5&wx_lazy=1&tp=webp#imgIndex=1)16.5 万美元换一年工作量，值吗？
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/hLLZnAbUwNg4Tu7zh8188FTDywryjdpolZnqlEuZFib1REZx9htBBYOwlboACb6FcJtPY6SfXzFGSgM3Fx54TyGsrBMwNvo7TYiahibeYibiarJw/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/hLLZnAbUwNiaxz2fCeUibZxOjgIBUyBLD2oE0R2sB6A4h1iaWRyoMTyMnOGYQ28SKtk0yOeL5TKRqqEd3W9icqJxWfFfP6JBNe5kgqHud6Ecft4/640?wx_fmt=jpeg&from=appmsg)

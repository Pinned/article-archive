...
see_count: 44
comment_count: 0
stats_updated_at: "2026-07-08T10:03:17.767Z"
is_unavailable: 0
...
没有大厂高管站台，一屋子却挤满了**开源圈**的熟面孔。

随便往台下扫一眼，就能对上好几个**GitHub**上的**明星ID**：

*   有目前大模型推理框架顶流**SGLang**的核心开发者**BBuf**（Xiaoyu Zhang）；
    
*   有主导下一代算子编程生态**TileLang**的维护者**唐正举**；
    
*   有操刀KVCache解耦与传输神器**Mooncake**的核心贡献者**马腾**；
    
*   有来自智源人工智能研究院、围绕**Triton/FlagOS**死磕AI编译器的**肖航**；
    
*   还有像**R0CKSTAR**这样在GitHub上异常活跃的硬核开发者。
    

![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGHoxrdfBIJ2xaue56whwvoUUPmbfBdMtpxiaC22fqr5js5oxZ0h3k3ficzsuEQA7zOwnMxRpjPibiaUGWAK6WPucGUsdKibicwxUQhRc/640?wx_fmt=png&from=appmsg)

这场看似是开源圈极客们的面基会，却着实是有点**反差**在身上的——

活动的攒局者，是**国产GPU**玩家，**摩尔线程**。

这事确实有点意思。

因为过去提到国产GPU，外界最容易想到的关键词，往往还是硬件参数、显存容量、算力指标、生态替代、模型能不能跑起来。

但这场**SGLang × MUSA Meetup**真正抛出的问题已经变了：
...
那就是国产GPU的竞争，已经不只是芯片参数之争，转而开始迈向**生态坐标之争**。
...
第一个上台的是SGLang核心开发者**BBuf**。

###### **![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGHNfbWql3AUENVVJUvDrMmH8RxEM3eu2dsQJlLn4HA8neFKlGYiaz5ibmntSviaFenxmJKBudN6pu6IhOMoxYys5XhzMa0cib5X10k/640?wx_fmt=png&from=appmsg)  
**
...
*   jit\_kernel全面替代传统的sgl-kernel，用TVM-FFI把编译速度提升了数倍，再也不用等几个小时的wheel包；
...
###### **![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGF9QHH156xicnmuoQwOyk0rBKVGWQmDUcZn4e3iaeibtlU14O1cm47IX2Zxm1TYUCeicoNw9tiaJtcfDQdEjxOeXKmKJwxV6DgHMqbg/640?wx_fmt=png&from=appmsg)  
**
...
智源的**肖航**则带来了DeepSeek V4在MUSA上的Day0 适配成果。

###### **![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGGzb4GJRpSd0dGice6vwEn5DHibbE0cy6WEib2rZJiaN5iblssK2u5PcDHNlS3k3nhCGsIbUPk0pztDzXvLlJMp8zHIdxfNFc3d4NRs/640?wx_fmt=png&from=appmsg)  
**
...
TileLang维护者**唐正举**的分享，则让所有人看到了下一代算子编程的未来。

###### **![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGGkJL3UdeKDYEVTVoEPC2useickeBIicVaUMLl74Rh04p2zXmAicTrBVaUeZmulX3JKbRGuzrcwSWyJ5YEez3OkiaCYF9SyFrj1r8c/640?wx_fmt=png&from=appmsg)  
**
...
最后上台的阿里云**马腾**，带来了Mooncake项目的最新进展。

###### **![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGEkILS7lFDtHRaU7KKM03MYMaQreQooTRQR6Bk8uvKrXjulLqUzqpnZPEGCbqiaAOS2RCwx8zVHSTW0GWZAHQuq590BicGz7eLfw/640?wx_fmt=png&from=appmsg)  
**
...
摩尔线程CTO**张钰勃**在开场中解释，MUSA是Meta-computing Unified System Architecture。

###### **![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGFXkhOuhU1IFr4qdJ7Mn1V3oZqOZ6XDAqgVS0FE7rfpdzbdhBSp3frrBbicptSWRpBFol0icTZt9uvQKRx86d69wHYFuicdMcZxms/640?wx_fmt=png&from=appmsg)  
**
...
torch\_musa负责把PyTorch和MUSA的基础能力接起来；torchada负责让CUDA-first生态继续工作；mthreads-ml-py负责把设备管理、拓扑、显存、MTLink、P2P等信息暴露给上层框架。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGGiaEGSD8CEZVN70jZ6oLvkqQ0PQKUmezdOg6Gc9bj87icaxA1RQycCic9pmo1SibsDDiaXuOW1VJWbBxHtaLLIvtG85hBsb2HNFwD4/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGFr3Cyhgmvc4ZlI8Vy5ryAoszqZAcIwiaQ2EvO2YPEJXYw0I7ZBWREIoQrVL4l40iaTUn9W2tfrF37Kwego9AUcE9eAIibB19t3EI/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGEibp83E9xPc1FtM9tmBbxV5bSKkXmNUuiaM9XLeuGAwtSHHp46lODRcrTykCQxHEicVANsolBtRrPpn022aPialoKroNe8iaYXlDLs/640?wx_fmt=png&from=appmsg)

**TileLang × MUSA，则是下一代算子生态的提前布局。**

如果未来更多模型和硬件都需要定制kernel，算子编程不能永远停留在少数专家手里。TileLang这类DSL的价值，是把高性能kernel编程变成更多开发者能上手的工程工具。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGHKfZbrGW21A7kZU8oBDfticJOX9gPvictLibicYMGT9f6PchSJRxAW7XrxZRyv2ic6cgJP2okcVpvEJtwkzLQLTSzfELerBU1Vf1vI/640?wx_fmt=png&from=appmsg)

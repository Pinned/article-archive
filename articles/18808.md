...
publish_time: "2026-05-06 11:49:10"
account_name: "机器之心"
read_count: 2592
like_count: 29
share_count: 178
see_count: 13
comment_count: 0
stats_updated_at: "2026-07-09T03:02:19.546Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"文生图\",\"多模态\",\"奖励模型\"]"
entities: "[\"阿里\",\"PromptEcho\"]"
---
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/5L8bhP5dIqEtmlW3JAoRiadBmI51bL9icuVbwcerXxXauJoqjLD1EtAnDOURvg4HNhgQ57HZbh3UvYfHPmDv5LCeict6mkypeunUk1keS4e8oE/640?wx_fmt=jpeg)

  

*   论文：https://arxiv.org/abs/2604.12652
    
*   开源代码 & 模型权重：https://github.com/roooobotx/prompt\_echo
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqHDx1tIJfANX8Jyqj9VwIIqLyDzdJYeEj8lyibcCFTYgpsUlKnRib2XtibMoNu70olHxQzfFToicxAsSkn0ozwhGgYCmycc6A6mqGI/640?wx_fmt=png&from=appmsg)
...
1\. 生成图像![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/5L8bhP5dIqHSvuBrqwON6tic08J4NSIP7oDECogGh4q3gwrNW9vI0AB2lzVOrKj27OWhfo9GYWNmh8SAnumJZ90GFGBbO8vIawRQhibIjQYks/640?wx_fmt=jpeg)：T2I 模型根据 prompt 生成的图片

2\. 引导 query![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGol2j5iafibgzFpwoiaRZQjWzGRh4JFvplEFDYmraD0TpZAVricCdY44K2y78Jq7icS0S9ibqoZ4GrARlaepJv5CkzEpPvU0uyKa11c/640?wx_fmt=png&from=appmsg)：一个固定的指令，如「请详细描述这张图片（Describe this image in detail）」

3\. 原始 prompt![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqG6wIpYk43hfhnwZ6BqQ5E8viaTfGPIvMmqIp5IuMt6h6QpDvHekYFZotHntBnAhA9BliafhAoKDNSVON2Ve2ricsrBCWcD6e32IY/640?wx_fmt=png&from=appmsg)：作为「标准答案」
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqEMsvEicLEWJ7XsicyckwLCqjEKCXGjs8mJeWnjYuNKIydkibvl1gkU9a1D9RgEsfQQ6acHziaIiaPzSRnf5ZdqZnOUhjrody6Gsiaq4/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGfALWeROmlaZd2qe9ZyxBH6eZVHM1Yv2Znp7EQq6LNQlVm9zBcia1XAOcYtNCsic9IsjFpab5kMmWCJfkW4aPGddVcFzTKLW2NI/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqFcjvXGmbqwOfvTIX7IzYpoYbc7XkHO5DsEpBDwBmkUKjhlgafPQiaQlib9Ccn0Wia73lzScSricBVtXwicTplNYWc875CtzH7vfVQc/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqH2YFQrE0Ka3blef8qnJLC8VNk3nosLSfZrYVL4kZN4W0BX1Z3aCjYG3mZ21ln7B5RMunibSy9wibMKib1rRibI8iaOHsDObayzuWDw/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqETqBLgSms7u1h8WiaHJcFTexNs2mTq0muklsa0upuJMBSlkMyQqn8IR15KJuOsns59icWNhoQRh4osEMfnX83EIaHats99pyWVU/640?wx_fmt=png&from=appmsg)
...
经过 PromptEcho 强化学习之后，在 5000 条测试样本上，海报生成模型全图文字正确率从 68% 提升到 75%（+7pp）。这说明 PromptEcho 是一种通用的 reward 构建范式 —— 只需调整引导 query 和标签格式，同一套机制就能适配不同的图像生成模型和优化目标，无需为每个新任务重新训练专用 reward 模型。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqEicpkuuS29afQKIUb5p06j4XH83Hjl86m3bOxRgniaibhqzHdLCzK0XK4YSdMGiazXz2g7QZgXVcjkO2Q06K2y1FBQXGceWsdmib78/640?wx_fmt=png&from=appmsg)
...
为了方便社区的进一步研究，研究团队已开源代码、模型权重和 DenseAlignBench 测试集，详见：https://github.com/roooobotx/prompt\_echo。

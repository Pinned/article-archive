...
url: "https://mp.weixin.qq.com/s/6lcUwQ2zu-9VLlbQGgsx0A"
...
see_count: 5
comment_count: 0
stats_updated_at: "2026-07-09T03:08:38.153Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"智能体安全\",\"流量隔离\",\"沙箱技术\"]"
entities: "[\"AICon\"]"
---
...
阿里云高级技术专家王炳燊、技术专家李博康已确认出席“Agent 系统架构与工程化实践”专题，并发表题为《AIAgent 沙箱的网络安全：从流量隔离到智能治理》的主题分享。本演讲以阿里云 ACK 在生产环境的实践为主线，分三个层次展开：首先分析 Agent 沙箱场景独特的网络安全威胁模型；其次介绍他们自研的 TrafficPolicyCRD，如何通过 FQDN 域名白名单、优先级策略叠加和多链路规模化下发，解决当前生产中的隔离问题；最后介绍的计划上线的 L7 策略层——SandboxSecurityProfile，从流量隔离走向 Token 替换、内容审计、LLM 流量治理的完整安全管道。

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/hLLZnAbUwNjuddoby5WK1ucgloUvswSfmpicmdsa2Tztd9FnYJBEuP2LwqULErXoxAIh67K3BTlxSiccd6OU9zz575xtuQCfKUR20EGPvE2q4/640?wx_fmt=webp&from=appmsg)

![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNj8jgHSaCrlPnvriaaniaHtibGiaXAB9MPBBAyDvKW69hEneGyOsO98fmU6mjElbb9b7J25DibAvLZ4uSq1v47sjKMddvDrpQUHFIOU/640?wx_fmt=png&from=appmsg)
...
*   为什么 Envoysidecar 又太重：数千沙箱并发时资源开销不可接受
    

*   TrafficPolicy：今天在生产中如何做
...
*   FQDN 的挑战：DNSTTL 竞态、IP 动态变化、多租户 DNS 归属难以区分
...
*   三条差异化路径：gRPCserver-streaming 推增量、Shim 在进程启动前预置数据面保证首包前策略就绪、unixsocket 旁路 API 处理 ECI 场景
    

*   SandboxSecurityProfile：L7 治理的下一步
...
*   技术实现路径：TLS 拦截（MITMCA）+Envoyext\_proc 作为可插拔执行引擎
...
*   建立 AIAgent/ 沙箱场景网络安全的完整威胁模型认知
    
*   了解大规模沙箱场景下网络策略的工程挑战与解法
    
*   看到一个面向 AIAgent 的 L7 安全策略的完整实现方案
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/hLLZnAbUwNial427IicWNTKC6dnAqkcibG0paJPdNemLJpTahy5slkNn5bncsvGgSe3Bcic372um83zW3Okym6IR8ibXLJibd3QqwTTRLCVaJD37k/640?wx_fmt=jpeg&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=2)

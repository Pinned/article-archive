...
see_count: 7
comment_count: 0
stats_updated_at: "2026-07-09T02:26:22.715Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"细粒度检索\",\"智能体\",\"幻觉消除\"]"
entities: "[]"
---
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYUMzGBLUlyCpiansAWicAs9zr7XyHO3UUS39JsQeXRYXMqtTAViaF8Zs3pKdokxL6K5WqLSCddkwwkcEB5LkZoia1ymUWzBvicbHOsY/640?wx_fmt=png&from=appmsg)
...
##### **【新智元导读】为解决科研中对单篇文献深度解析的需求，佐治亚大学团队提出IntrAgent，专注单篇内容，避免大模型幻觉。通过段落排序与迭代阅读机制，精准提取实验细节与元数据。**
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYXRUWibcoF9L6p46iatQtPLP2oBvVh8WTL6cSX01YVfIyZ9BaQzY4qbOBWG0LVE2iaictZiaMv4L48ujmLAbb1d9Ak7pEhibyDuYvD2k/640?wx_fmt=png&from=appmsg)
...
在这一新任务的基础上，团队协同构建了专家级基准测试集**IntraBench**。在设计这一基准测试时，团队明确摒弃了传统测试盲目追求文献数量「覆盖度」的倾向。
...
为了攻克这一高难度的IntraView任务，团队开发了核心智能体框架**IntrAgent**。该框架摒弃了传统大模型的发散式外部探索，其核心设计理念在于完全「模仿人类专家的真实文献阅读与研读行为」。IntrAgent 的工作流水线被巧妙地设计为两大核心阶段：

![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYWXn7Kx9OW9KCRzfMlQl4vJWbPFDDtVEgdfftzwOLDWheWLfhu74k3tqgpicxX5LUyZBu4aaypOZ23nMz1OPa24iaiaicTsMEnibT6g/640?wx_fmt=png&from=appmsg)

_图1：IntrAgent 核心架构与工作流水线_
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYWTWcZRiajDYUMPIF9SP0cP1PtccOkqYNZTRmG60qJPr1ic6KbibsZzkWWYJEGYyniazFvuQk0xYmIibPo7eDhNXt9ox3USPWQR1fXE/640?wx_fmt=png&from=appmsg)

_图2：IntrAgent与传统RAG系统在核心参数提取任务上的真实表现对比。_
...
实验数据表明，相较于当前在学术界和工业界领先的RAG（检索增强生成）系统，以及现有的各类通用科研智能体基线，IntrAgent展现出了压倒性的性能优势，其跨领域的平均准确率实现了**13.2%**的显著提升。这一成果不仅在统计学意义上表现显著，在实际应用层面也带来了质的飞跃。

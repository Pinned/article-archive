---
id: 26311
title: "AI交互新基准！蚂蚁提出MiniAppBench并入选ICML 2026 Spotlight"
url: "https://mp.weixin.qq.com/s/mdD0TdyCZ9WTEdU_V-X5cQ"
publish_time: "2026-06-10 20:44:44"
account_name: "机器之心"
read_count: 4341
like_count: 46
share_count: 211
see_count: 31
comment_count: 0
stats_updated_at: "2026-07-09T02:56:10.305Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"交互基准\",\"小程序\",\"AI交互\"]"
entities: "[\"蚂蚁\",\"MiniAppBench\"]"
---
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqFq6GVfOo7t5mSaQekaNXfnYcbazG6QH0wp5lkZ7b4ibrdJBHW8FJ9licssj8V1SnkoVaaln6tcu3b94khkbWtbm8IG70CWnzUa8/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqH5WiagHMBRtpPe5pccVOmUvIc6ps5yw4rXEAGnltpWKFj4kH5pkcS6csuWo9C1VWwSEBiacS3dz7JOwJba8eNC3ZUzf0yQ6KP40/640?wx_fmt=png&from=appmsg)
...
来自蚂蚁集团灵光 App 闪应用团队的研究者做了这件事。他们提出了 MiniAppBench，首个专门评测大模型生成「交互式 HTML 应用」能力的基准，结合配套的自动化评估系统 MiniAppEval，对全球 16 个顶尖模型进行了系统性测试。
...
论文以 ICML 2026 Spotlight 身份被接收：ICML 2026 有效投稿量共 23918 篇，全部接受稿件共 6352 篇（26.6%），Spotlight 仅 536 篇（2.2%）。

  

![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqG7mHO3feZWDgTWKaJb0tZb98cic47n9OPhyzTzo7iatxa1By4hWI2w1aTfXO2t7Fz2eALOjYBLADhLTBPkxenPrzWgYSKCm1wO4/640?wx_fmt=png&from=appmsg)
...
这就是论文定义的 MiniApp：由模型依据单条 Query 即时生成的定制化 HTML 交互应用。

  

![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqH4JibVR6LA9ReG40ldM2l6YIEmo5MrDttBkicLdIe3SHNrVGarS5FCoPt1cnKhlrUqg3eRrWWxcxSiangRgqN5YRM79ITHlIVf3c/640?wx_fmt=png&from=appmsg)
...
*   原则遵循（Principle Adherence）：模型必须捕捉并构建用户 Query 中隐含的现实世界原则。比如「一周饮食记录」隐含了「一周有七天、一天有三餐」；「水蒸发演示」隐含了粒子运动速度随温度升高的物理定律。
    
*   定制化交互（Customized Interaction）：应用结构和行为需要根据用户意图动态合成，而非套用固定模板。
...
它的起点是大规模真实场景中积累的 超过 1000 万条 交互需求。研究者从中筛选出真正需要交互式应用才能满足的需求，经过四阶段流水线层层过滤，最终蒸馏出 500 个高质量任务，覆盖 6 个领域、25 个细分类别、3 个难度级别。

  

![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqFQyUSeW5ibzgbbyH9Du3Bvng6vbr5pYBamziaheJ05q4uDOtdhBF6WibhSOM9IExQibqpM7Pkjn5bOKOKGk9aZwAESWjzgibuqRPI8/640?wx_fmt=png&from=appmsg)
...
三个维度各给一个 0-1 的分数，最终通过条件采用 木桶原则：三个维度都 ≥ 0.8 才算通过。一个应用如果视觉很好但交互全崩，或者功能齐全但违背物理常识，都不能通过。
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqG0R1j80nvmibQJoD6mZDXWiboQ8tia4R4Hzpia3F09IZtT5MEAjD6WA3PKibynGo4ic8iauSvJtL7pDsKX8wicA2TyQ9wUpMSJdfmnQ7M/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqHnicLVXQD40UQTcB61tDJK0qYrgGvKAibMGmzsqxjujA0xkDvQ6ibn42GKlXOT7ES5uAIHia6FOAFdO6yGeWD5ibYW4SpCiaPqibkRN8/640?wx_fmt=png&from=appmsg)

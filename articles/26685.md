---
id: 26685
title: "OpenAI「最开放」一次，Codex不再独宠GPT"
url: "https://mp.weixin.qq.com/s/f9G4Edrp5UHt3cYC-FultQ"
...
see_count: 26
comment_count: 9
stats_updated_at: "2026-07-09T02:23:28.885Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"代码模型\",\"模型开放\",\"AI编程\"]"
entities: "[\"OpenAI\",\"Codex\",\"GPT\"]"
---
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/Rvq8Ow69CYW7n5ib7h8JCcdzFdMUbbTqiaVteI2qBQoibzAlvY4ueUADibdPDxLv2jQgttkiaAQeLr02QjZMpo8ENwCJTf53Y7MsicW9u1h0beatk/640?wx_fmt=jpeg)
...
##### **【新智元导读】**有人欢呼，这是OpenAI「最开放」的一次。给Codex装上能随便换模型的插座，等于亲手填平自己模型的护城河。它图什么？
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYW9Hyolhxfsq9icu6lduvfeAViaEVfr7z4qqEia8wWnEpKonmiaqEaF1Zasic4WFia7hLE1fdwdK6P1ftRWAKbV3wFya3GPcI7J4IibFE/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYWF8BXb32XBdvrHnDoQRLZArp0rKJrBXCjibHSmXkRwD4dicSbjqdkErx430Hhibu0QLG9n29XnJuZkQgToVOicVu4euOxt2fVShtk/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYWmUrHCU3KXuSzBrdbIxribfialyiaHicsaWUIJt9NkhdxeicDfxIuq23SdKUvzFNicYrUdFiaykUNIs2l0icHJET3DFvcmQYnne8bezlE/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYWK4YAvgU3iceS7Q6iaovHm2XVB4WOoz6TTiaeia6rf6OZVkm0MWt0Bd8AEyRoY8xiaiamUMyGu1niaoUoyHD5DMq47Ur7aQia85Rd8t7o/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYWib4NXE3QaIMdKq14T7aYTlHZ2LocPEjPXlicN6KjngbcjbArSE5XjZXLOzMibeAQHSg29Xv7FXvZMCfoz7qqvx8yhFjstpchDQ8/640?from=appmsg)
...
这个能力通过一个叫模型提供方（model\_providers）的配置来完成的。
...
访问地址（base\_url）、通信协议（wire\_api）、鉴权方式（env\_key），以及模型映射关系（model）。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYXju9Fib52m7e9VFQcKhJd3qjZ29A6pB761gNgvkPPj6DEQURLq7aW48icLjlibrdDdH9juSr4lFQmics8asLMblzHZoTrAibvgC9vA/640?wx_fmt=png&from=appmsg)

Codex的model\_providers配置示例。base\_url是模型地址，而协议字段wire\_api只认responses一个值。  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/Rvq8Ow69CYUnPOTZdfbx6WQUnD5IE0Dz3Iia7Ilsvq7jib1n4H4FALYLu3mxeJY1r3icKQNKI5uTGmc168n0YPDfAJttjMOhia8060Gib0HdgtQ0/640?wx_fmt=webp&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYUZHjAdYRxRyZib0O8xVpZ0oTsljFgcMAXk4SSJ655Q9KB9iazIKl9Xicsu6v8Gj7WoVrZdsF63v3yNySM84mBsTjVl4G6coLLHwA/640?from=appmsg)Codex CLI界面：启动信息里model一行标着当前模型（gpt-5.2-codex），后面跟着「/model to change」，一句命令就能切换模型，整套智能体就跑在本机。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYVIkiaibsDhOGySkroGvNwKrJmPj7iaaiak7jU8Nytkiceax3mpPr1AXWQiaAHxsZN6WA9ibL1HmzoibpNgPrOiaIdgBd4LDJsY0YPEYCZU/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYUkKyMlMx1SUeRMfQnqPibBLqaXwzTUOQtuACR477zQAFYMOowdtRR6ZvR1aGvhP9pyarvmgsLtUjOyOVxgGBQgHsNevvjgs9icI/640?from=appmsg)

...
url: "https://mp.weixin.qq.com/s/iCty7MvtQDZzJNhV9nCZIA"
...
see_count: 85
comment_count: 9
stats_updated_at: "2026-07-09T02:55:20.239Z"
is_unavailable: 0
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqFRm0RZsjn2aDhc7mbpSjvgQSS2gffUejiat4uEJdhKLzeq55PicxzLv2JRYN23amU5kOuDECXnIhhn7zRlU9U4QhN7Kx93wwlFE/640?wx_fmt=png&from=appmsg)
...
其二，SWE-bench 只读取 model\_patch 字段，而通用 Agent 原生输出的可能是最终回答、结构化消息或日志。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqEWcqbhiaDz4BbaawDPk6xepBJzia7sYLIbUcCSzY3lUcaibMHKticoR76mxRI8sBNKFLuyPc2HFhiajpSFADhicJiaETEGviayY7OWVe4/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqHnnuf1ibY6t449cwhy742frwTONVo8zFW8o5qjbpptypptDXyYVD4Sy6KyLLr46J3RtudnTTyYWYOia8wx9hgxtzCiaIYmOPzcmM/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqG9cQxuAFTiczpuSw16lE9ibkTLXiajDqpaxdenTGaHb6dmrZ2qiaHhwlHHhPbzIdkGlLC1vJh8H85cumntl8MmIl0ianMXP2S5dTiac/640?wx_fmt=png&from=appmsg)
...
检查 SWE-bench-Multilingual 的容器时发现，部分实例中 base\_commit 之后的 Git 历史仍然可见，Agent 如果通过 git log 或 git show 看到未来的修复提交，分数就会被人为抬高。

  

因此，研究团队在非 Python 多语言任务中移除了 base\_commit 之后仍可达的 Git 历史，并把这一清理逻辑变成了 Claw-SWE-Bench 评测流程的标准步骤，同时把这一问题反馈给了上游 SWE-bench-Multilingual 项目。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqEzL87PCpOZInQWZHtfabKV9WV9ibmdicfJoBzDVWlvoUbrsPDMQqh6XqQb1RHfJzdx3JZJriabicnrfuTWibKl1RrW7hZx83YQVGGY/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGD3jSt09EoEm7RNcIVe6aOROEiaiaal7UWLmHUIOv5zOYtQUE4nnFxAOsNVxjh66BTTo9R3IxymGcshiaqu6iaq3y70FUpfroX0YU/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqFTnb7BW2jpILFLia3qIq1DfegHRILBFGR4LodPYLgUiaWNmxa7cZzXTBssIQiacNbc5eMibQYJUmaetseSibSxAa43YXGT5ibQOmTtg/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqFPGu1hTe2AjW35HTJ8YCNfr5NkpZ1Wa3FRXYh78pgKuF4uUZypYUXzKL2WcMQprCKZ63cHMsQzfUqoZWsqjF5cbBw3wMrD6ME/640?wx_fmt=png&from=appmsg)

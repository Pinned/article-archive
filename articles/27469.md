---
id: 27469
title: "流形约束推理新思路！傅聪团队联合厦大提出ManCAR，自适应测试时计算带来46%排序增益"
url: "https://mp.weixin.qq.com/s/KhgEGnNIh3l6poINq4Nl2A"
...
see_count: 2
comment_count: 0
stats_updated_at: "2026-07-09T03:07:11.442Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"流形约束\",\"测试计算\",\"排序增益\"]"
entities: "[\"ManCAR\",\"厦大\",\"傅聪团队\"]"
---

# 流形约束推理新思路！傅聪团队联合厦大提出ManCAR，自适应测试时计算带来46%排序增益
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/hLLZnAbUwNhGyRPAVq5fVAiboyILB0n5nSu4pv1YFSL9lWsrMlcKz9bddwempLffIWuBzwPtPySGOMggjOaAaGIBDlhte1LE8dh6GGaYBCiaE/640?wx_fmt=jpeg&from=appmsg)

![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNgdQc5jOicCVEnwkFgVqWPfLhx5ezFonoH2CYAlbRZD8TsvryNRSiaK1hIHZt1CicpEV79POZaGwNjN1NOl44fRqlfNwM9ZCNs5kw/640?wx_fmt=png&from=appmsg)

  

2ManCAR：迈向可控、可解释的自适应推理
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNjia7fcb5ZsibDsVaH9GE5ZxJQvFiaj92icznn0AKUibhHSL1CaoS7amMkGPHvFsuibbWagP1IKsicrWictPBfvGnmGpgSPHA8Q0Eicqed0/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNgz7c0StMsQ1ejIrKZzLfQ0DmpJPcGehD8FKokCgbaHz3HzLf7l5MDN4KqOXcTmIbdNAVf2fAoqfOVagXfdoxj4SZiaxJPyaxiaY/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNjyRIlOeNvEa4LbRwBcerbDRndUbYUibw2gTgVtPu7Qxt4r1G0icEq5jcMHADZWDDKv0SpGFsU6B5ftibTqEPdJicUl7dR0gt6DmYw/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/hLLZnAbUwNjYysFMrdqflMqL02DyT5iaEpibygQ3rAE9bKyEWLk9fSJZHpYCdnvFxUDribSGF85CnKsZjILI9kah1eekvTSJPgicMMErDhsaMxM/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNjs0H8zqou9zz3dyYMqibSWCgKficrZPmWiclpJIiaaDtGBia8CEBMDLdDMIGsjkvzVibelmEGx0VAzccL3sXcqibhWzfXAicfc6TmicYmg/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/hLLZnAbUwNhKiaMpwBWNOjp4c6VXzsuf9XxkL4sHIREBG5m485bMvPYuiavKUbnppRFUljsg5iczOEEMR4XibQXlhwZoqNLcmgswH8YTr97nmfc/640?from=appmsg)

其中：

![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNgS0NSgdibwS5hCrwoXJviaylvwjV2ibZdFrb0SEqcdibO0PialphibP9ElFUVPy8NZx4PChGDTaRELlLQibGQt42acGqnLhPDXaz4NMk/640?from=appmsg)

同时把最近的 Trigger 的 neighbor 以类似“LLM Context Engineering”的方式插入到序列中，来实现这个监督函数：

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/hLLZnAbUwNiasZFI1EIvaG4WicDpajAvAheUiatrJJ8yMCURMO5TM3EWBcOwkw6pHFvObuKqlObOBnzu3YLVNzWycykicgPSW6HwvaVn2bCepK4/640?from=appmsg)

而针对第二项，ManCAR 设计了一种特殊的教师分布：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNiaia5icYMOJQiaLItwXJKicXsTlUWuPzIB52DdJcyDKcYqdSmKUjFLI67A4riaHpNfdia951PULmdEM5fQnLEnRAVicroUuibLcXepQvV8/640?from=appmsg)

这里对 Trigger 的 neighbors 定义了一个顺序（rank），Swing 权重大的靠前排，此外，目标 Item i\*也需要被包括进来成为 c 的一部分，为了和主推理方向一致， i\*的方向永远是 0，这就保证了它永远排第一。因此用负 rank 构造的这个 softmax 分布就保证了以 i\*为中心。而逐渐减小的温度系数保证了这个教师分布会越来越在 i\*的位置上变“尖锐”。
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNjM1yib8E7psZU7ickDVdRCqtB5ZyJST1YGJ22FJZJaQGG4icibWDjduI1AlbB7SV7icjONdFlf964UrJiciaia39hCMJ8yWZBSzmoickUU/640?from=appmsg)

可以看到 ManCAR 显著超越了以往方法，最多实现了 40%+的提升。

![](https://mmbiz.qpic.cn/mmbiz_jpg/hLLZnAbUwNjHqeFvPfIDQ6aM0UsR0rgSeO1afgjDJpfBvzrO89Zo6d9ASW38crHdWYAhwvUUxSicHXV3Z4ffWXvX4ph3D0JuEZMgwElso5b8/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/hLLZnAbUwNgmKe8vGAVmuZtgNiaJia4wldPFUe7z5TNJcKgibQJdIp2xbNvtibE5Zy0PVzlBRE0u2kV5LkJKmyLZWMArRicbwZxyN7rnhlzXfb9w/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/hLLZnAbUwNhoaLmyO5Qn00GLx6hW4fRhCYXTAoPJZQKS6nqnUIvrSMVl7bibZ3yPQ4FgQjRmiapV2Gqup3lkgH5AIsO5jhXLM07x889wcWKs0/640?from=appmsg)

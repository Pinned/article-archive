...
url: "https://mp.weixin.qq.com/s/fe0tsOPNYAn9PmTolFlVZA"
...
see_count: 359
comment_count: 12
stats_updated_at: "2026-07-08T10:00:17.690Z"
is_unavailable: 0
...
从今天起，正式面向全球开发者与创作者，**无限期免费**开放旗下核心模型API！

![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGE4lxYap2uOByasoGcWstIq4Q169vY9El7Q4csA4NghnVgIGxGst4SHp9IicTVub5nibWxCMXo0VC4rM1AiamURiaSVibsgSLL9mzpE/640?wx_fmt=png&from=appmsg)
...
先来看下文本模型**Agnes-2.0-Flash**。

我们先让它直接来做一个**应用**，Prompt是这样的：
...
![](https://mmbiz.qpic.cn/mmbiz_gif/A6fTew8FFGEMaCB4FibWIxhIWh0NfBSiaL5kGbzEPhaoSe0PsZjicByFh7HrmTWXQNOIV3ib1XvZxWoZKhOwicibhcIXULiaXoBqxPY9WL1tO6rRicM/640?wx_fmt=gif&from=appmsg)
...
第一个场景，是让它做一个手势控制**电影级3D AI网站**。

Prompt如下：

    Create a cinematic 3D AI website with breathtaking visuals.

![](https://mmbiz.qpic.cn/mmbiz_gif/A6fTew8FFGHcExHHaReSFuvAZ7Mq7x0mRj7q7nQicwT68hBngDDEsnT85tXkVAictz8QmAbWQsG4AqFlaxpiagWrZlsBcibhbom4291FDBgWiazI/640?wx_fmt=gif&from=appmsg)

可以看到，生成的HTML里面的各种3D效果直接夯爆了。

Agnes-2.0-Flash已经把视觉、交互和体验等都塞进一个需求里。

接下来，我们再做一个更复杂的**3D粒子系统**。
...
![](https://mmbiz.qpic.cn/mmbiz_gif/A6fTew8FFGHHzZutRvmzZcVibLjib4QK7LgkWnJ4HYWfa2q4WlpqElFmDwgXqKCTObbqyibRzlCzFJKMWbbsetTzVghEVoeuexxePuMjMCGNxA/640?wx_fmt=gif&from=appmsg)

嗯，效果可以说是相当炸裂了。

这类案例能说明一点，Agnes-2.0-Flash在复杂结构化任务里，目标不是只给答案，而是把一个可运行的项目拆出来。

看完文本模型，我们再来看图片模型**Agnes-Image-2.0-Flash**。
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGF2oKy4I3bC2JUkBGemr7nKJcuTyw0GPK1sVVLeibib0TRI9sQ0Akzhqeu1zdhpzd19ubmflGvWULspmtJxSoiaDj43KBuT7jwPyU/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGGibeM2jHgUQ5qvCAbTzukmXaK4JnGlWyMKqu4CVOyu5vplhVxOic8370670N599ZIEgr6jU828wRXKA2wUdhdXRfjKFQ1jRjiapY/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGH3yib5Il65fQWecr162xukeWpYSofA8Licmjbb1VciaeOOicZmQeWib4p8ibHeYZKGnkAibkymhz4h6icUfWKxharjUYS5GvBZCCrQzaU/640?wx_fmt=png&from=appmsg)

这种任务考的是图文排版和指令遵循。因为信息图不是单纯画一张插画，它要处理标题、层级、留白、图标、说明文字之间的关系。对公众号、短视频封面、课程海报、企业内训材料来说，这类能力非常刚需。

最后，我们再来看视频模型**Agnes-Video-2.0**。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGFxleespW3F72qjia90mUpQ1NOzS7WvBkOenhJKagFLdOXT8FWhRo7Akrjlon32ggZ2icAPfKoyavHvHOuicEbb6XxWxZqqibictnjI/640?wx_fmt=png&from=appmsg)

如果使用**Workbuddy**，可以把Agnes的图片或视频模型打包成一个Skill。比如配置Agnes Image 2.0或Agnes Video V2.0后，在对话里就能像调用工具一样调用生图、生视频能力。

![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGGxFv1SHXujWicT9F1zwv6BZASEQHF5jXOP2hgCw1ja4WtwxM2Rf9aGgKGZLAHpjXSxb1Fua90epLt8gyiarb8CguKSdSjmPGdiag/640?wx_fmt=png&from=appmsg)

如果使用**Hermes**这类本地Agent，也可以把Agnes-2.0-Flash配置成默认模型。关键配置主要是API Key、自定义模型提供商、接口地址https://apihub.agnes-ai.com/v1，以及模型名称agnes-2.0-flash。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGGOicUULoDjr9v96vIRDXic0rVhYgDUTttZLuZI7qBX3wZoPSBA3OBU10YTltsicFJSzUXFsYvPGI7aZdePKYyInldib92H1uJcwSw/640?wx_fmt=png&from=appmsg)

---
id: 20603
title: "从 Computer Use到 Datacenter Use：如何让 AI Agent 像调用函数一样驱动数据中心？"
url: "https://mp.weixin.qq.com/s/0Qce15eCqoTpXUk26pQsQQ"
publish_time: "2026-05-14 16:37:49"
account_name: "InfoQ"
read_count: 3588
like_count: 34
share_count: 231
see_count: 14
comment_count: 0
stats_updated_at: "2026-07-09T03:12:06.298Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"AI Agent\",\"数据中心\",\"云原生\"]"
entities: "[]"
---
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNiaoM6S1iaM9OibEDiaHG1I3COTAUnnECYWbKFztbXiaMNAl5H1oSxpspiaUYcWV8icK3E8dnKrdj2SRbjVMWCzIpRrLW3BHzkhibaTJPQ/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNhvJKAEAO5xREW6ypicb7aN3xfDIoYDtqicEHOdTqm13lQiazw4iaFpLOVKTiaW9KosIYqPpqWFPYu5s0Y2704TOpvjKicEucaB1Bg1I/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNjEBMMxp1tEDjEN5jo6JRsDJtUpDS2bGkaV5Zzup3QQVPI7fICsqnvutvv6ib22XksFmYE6RQgic7fcGjDJiaBBLTcZbJUYCOvCuw/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNgRR2FpS1lYypOJffq1FQIb05D3HeXXyzojPF9Tn43ltpQbLaW8vKFbsxfeHM5ichTzqvbhc0zYPtySic64XCUwP9wtQz8VtJAz4/640?wx_fmt=png&from=appmsg)

**我们从端到端来讲述一下这套架构到底是怎么玩的？** 以创建一个 Agent Sandbox 为例：

*   用户通过 SDK 或 CLI 发起资源请求，流量经由公网 IP 进入 Traefik 流量网关，网关根据资源类型进行路由分发。
    
*   请求被路由至 openYuanrong 函数系统的 Gateway\_（统一入口）\_，转发至中心调度器，调度器选定空闲节点后完成任务调度。
...
*   指定镜像来源：Docker 镜像 URL\_（OCI/Nydus）\_，S3、华为 OBS、阿里云 OSS (EROFS image) 均可天然接入
...
整套 AKernel 集群在拉起的时候就自带了一套完整的监控链路。\_ 图 1\_ 是针对每一个节点的资源监控，可全景洞察每个节点的 CPU、Memory 及磁盘 I/O 状态。\_ 图 2\_ 是创建一个 Sandbox 的全链路 Trace，精准记录沙箱创建的端到端耗时分布。以这个具体的例子来看，端到端耗时约 50ms，其中调度阶段耗时约 20+ms，而节点侧沙箱拉起被压缩至 10ms 以内。

![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNhjeDYQRzPsswfjd7hxvt1wvtNGQibmJBkI9r0bvnhaeEouk7IMydjbPCafrVRPY1cJLv3YI9mEvwwjbL67BicJlHLc4R5LwQ7VY/640?wx_fmt=png&from=appmsg)

![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNgibualDFO0ozbEHRe2nbYZicVMS8IY8f6ribmHV4RmspCiclzI2WFvTjYB6SYHu0nUFEXoTZxTCsVia3YoJOhqtXIibrsw02Rdp3MoA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNgUAB5MTLcQr8lvJaiarK1TvuJosX4t0XedSgrAtfIfuO566gVTp5TGzr4ibbzVfXTYc3856nM8ssx8Fk1p3M3Q3NLW1JNwJoZoA/640?wx_fmt=png&from=appmsg)
...
我们对 openYuanRong 的函数与数据系统进行了深度改造，以支撑全链路的 C/R\_（Checkpoint/Restore）\_ 能力。

![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNgJ2VNqCP5THmgZPmnbDvZYiaNwq5rqg28no38wSOz9WQ0TFMHHnCjNKRBDyW2ibrRD3ndBulxAFvTyMEGolsM6icHg4ibq7ZPfCl4/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNjZWMPRriak0259mpFnATm6iaqFO1Lx9TVYnpBOLtSbYDBKZbn4iaR4xpFqQrjQmyVbot2nhYnh7nRqXdicib5COEYNkwSm0uiarpGeQ/640?wx_fmt=png&from=appmsg)
...
**谈鉴锋**，蚂蚁集团操作系统研发经理，长期从事操作系统与系统基础设施的研发，在蚂蚁主导打造了 DeepSYS 和 DeepXPU 技术体系，特别是基于 gVisor 架构的 NanoVisor 系统。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNhibNa1Cbf0Rs1JtwpDnDia9tWrZFwhty5Kvia3bs8llMeo3eqO1z31NOgBHNicyZAUAoMIhyq12XPLY64YgkE9uv9FFrIxXSAKibE0/640?wx_fmt=png&from=appmsg)

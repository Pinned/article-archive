...
url: "https://mp.weixin.qq.com/s/lhwnPCK7LMqe7Lct6sF-HQ"
...
see_count: 3
comment_count: 0
stats_updated_at: "2026-07-17T11:16:59.877Z"
is_unavailable: 0
snapshot_reason: "success"
topics: "[\"生成模型\",\"物理证据\",\"运动合理\"]"
entities: "[]"
---
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYW542kodEVaksGvnUvFdoMu8a0A2yUaz3WFA7voawK6iac3Q8jM20k3d1b3QdMYrULYcWZD0x4CZicsQd4viahaeHGfRUfHU4bljs/640?wx_fmt=png&from=appmsg)
...
##### **【新智元导读】PhyMAGIC通过让物体动起来，从视频中提取物理证据，帮助准确推断材料属性。它结合图生视频与视觉语言模型，生成针对性运动探针，并不断修正物理参数，最终构建出可微分的3D动态模型，实现更符合现实的视频生成。**
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYW5723p13PwBibJBt7hTl34c5dqoWoNMuYFZYokYNIaDW4t6nYwbP0porqodP0ZiblVzEkoukxDNbobzsxOb9Akj8VcTPbXicnNicA/640?wx_fmt=png&from=appmsg)

_图1 用于物理属性识别的主动运动探测_
...
针对这一问题，美国内华达大学里诺分校计算机科学与工程系和浙江大学软件学院的研究人员提出了一个无需额外训练的物理动态生成框架**PhyMAGIC，**不再要求视觉语言模型仅凭一张图片「猜」出全部物理参数，而是先生成一组有针对性的运动视频，将这些视频作为物理证据，再逐步修正对物体属性的判断。

![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYU6j9vRYPToPCxPiaNAyLKTicRD7NhjL1wFvWEWreczFf6e3zLPA4T9W8QK7H6ubonfWO8UMViasH6Bp79ev1l8pfASYWE4LsE6W0/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYX6QPWNR91FQL80DcyLwy9LcvjhpDyTMvacUQicBvCKhcVWgrNxh4eXLpzUdYdkR9SDeINdUgcNkWsBsSa7GkrN4aoicwgdnvXKM/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYVaAzW6QId2FZyXlShuwg7GlkRgDuP3D3vAic7t6rya8lQELssymbtyZ1KOzRWpufr48fKjD6mXHvrRZpXbO4QJmQrzTO3jWtmA/640?wx_fmt=png&from=appmsg)

![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYVUp4H5Wo1KMuIZM6nsjvfialIDNNPjLyeGNjp7rVLib8ibOrWphW698CXpibVB8Q5rGRfhHvMQfAy5n94vFiaSReabu8t9uxolIpI8/640?wx_fmt=png&from=appmsg)

![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYWX4SeicNPm9Z4IScuiaE5RibicRcwq2Q7xoEyZRONgic1jznRc5iaCgGDhxNyP93nFIpm5255EjmX4eRMFQ2DwDnpq6fP9pU7E1d16o/640?wx_fmt=png&from=appmsg)

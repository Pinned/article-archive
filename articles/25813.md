...
publish_time: "2026-06-14 12:12:32"
account_name: "量子位"
read_count: 4535
like_count: 50
share_count: 373
see_count: 26
comment_count: 0
stats_updated_at: "2026-07-08T09:57:58.819Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"端侧部署\",\"AI修图\",\"视觉模型\"]"
entities: "[\"vivo\",\"VLM\"]"
---
...
为此，**vivo BlueImage Lab团队、浙江大学计算机科学与技术学院AiXM实验室、之江实验室与中国科学院大学**联合发布了一项新的研究工作**VeraRetouch**——

面向多任务推理式的照片影调和色彩“修图”，提出了一个轻量、全可微分、可移动端部署的修图框架。

![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGGueLcfWVjf9eksmuCia1WXzIM5H8hPCGq03kbQUdqs0glXF27oWaDKOwZMiaR4pIKScpaeOoFwbcS8gdQBuzHB2BdbwEv3VpDyg/640?wx_fmt=png&from=appmsg)
...
VeraRetouch的关键创新在于，它不再把专业修图工具当作外部黑盒，而是**用一个全可微分的 Retouch Renderer替代传统软件中的调色与调光操作**。
...
###### **![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGFicQelg3nJzmiaoyMmIJNTM5GIvTeJTXn5z0W35OcIKbKujqxH9vYuOt2VX78aydkK1k06mT3RCmElcwiaibC4rlZNOhmMV0PibNXc/640?wx_fmt=png&from=appmsg)△**Retouch Encoder从参考图像对中提取光照、全局色彩和特定色彩控制latent，Retouch Renderer再将这些控制信号映射到像素级修图结果
...
Auto-Retouch![](https://mmbiz.qpic.cn/sz_mmbiz_gif/A6fTew8FFGG0JZfO38mZsrzTUWHWGqPuyiaKX2jp2g0rXjMlshDN8ic5YiazQcmZa8pRxtianPt2d3CE0QokiaZD0QQwiakVdP1uzkM32x2HdxgZc/640?wx_fmt=gif&from=appmsg)

Style-Retouch![](https://mmbiz.qpic.cn/mmbiz_gif/A6fTew8FFGHGqrFzJCFG3QNQs0o9ECECgLGTMnK5dLWmAXoKToEZPNvr1n7VDuAcBLdKmVic0GZCoznboe41zlMj4yGHgzTCr64O7cLTKrMk/640?wx_fmt=gif&from=appmsg)

Param-Retouch![](https://mmbiz.qpic.cn/sz_mmbiz_gif/A6fTew8FFGGsUmmpB4gvSCicNlJGV5y8ib58d5hJibE4nribogSR2fQKls89BqTsYpUepIcBNHtEjsibthlMN4TLmGem0G4IGcEUZQXNXYWvtkCY/640?wx_fmt=gif&from=appmsg)
...
为此，研究团队构建了**AetherRetouch-1M+**，这是一个百万级多任务专业修图数据集，覆盖Auto-Retouch、Style-Retouch与Param-Retouch三类场景。

###### **![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/A6fTew8FFGGnh8DtHe7CqWbrQ2R3cy9nwBER3SbjNJgAqZ0VJDx6XSsibvIsZqrG7FbJscL9zkBDBYJNnuVibeySm8T2uibaUS6iasXJnibEMdXE/640?wx_fmt=jpeg&from=appmsg)△**AetherRetouch-1M+ 覆盖自动修图、风格修图与参数修图三类任务，为多任务推理式修图提供大规模训练数据
...
###### **![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/A6fTew8FFGG4CNz1XAPHUXZlJyXGiaJvfiaVrXX6Bib3sC2B66aiahdbiaicp50uuuCDNEq6cmOsiaqXjkz3ibFwZQpMnlWbJNPVLC42KbQmK7uJms4/640?wx_fmt=jpeg&from=appmsg)△**AetherRetouch-1M+的数据构建流程，包括自动修图的反向退化、风格预设匹配与参数采样三条数据生成路径
...
###### **![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/A6fTew8FFGHSset6tnbk7t7VDsmg3JvvwGtDs23Ln4hj2CDOKtmsBporRIkWszlNtFicvzYvF4bKGkMKmOzjVhibBpHOhG55ATeqm2JbeUicgs/640?wx_fmt=jpeg&from=appmsg)△**VeraRetouch整体框架。输入图像与用户指令经过轻量VLM生成结构化推理与控制latent，再由Retouch Renderer输出最终修图结果
...
首先，它**避免了模型推理时对外部修图软件的依赖**。整个修图过程可以在模型内部完成，并支持端到端像素级训练。

其次，它**比大型生成式图像编辑模型更轻量**。
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGFxYGzlSuibfV9KTnmcYbtp8oaoqA25sALfDH4rA29jumlm8uicAblbnxhI8xdCibkZzdNBZ5Zb8pCxX1OIzchic6hZ8pu3nkM8Hrw/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGFASGLxKD4DgNOia15jzHmdFgz5Kb7EHcS1SGRrgPC1AMcfoTAOX3SFFq3S2RTwibBrRD1hPza9OZWDTfm65CwoiafCGicxAaw0NBQ/640?wx_fmt=png&from=appmsg)
...
_论文链接：https://arxiv.org/pdf/2604.27375_  
_项目主页：https://apollo-yi.github.io/VeraRetouch/_  
_代码链接：https://github.com/OpenVeraTeam/VeraRetouch_

...
see_count: 314
comment_count: 11
stats_updated_at: "2026-07-04T11:52:29.598Z"
is_unavailable: 0
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGEibsFkZeJYfW81pbricrJLwepOqXsx0SUI8lJv1p8U7qVD6NibzV0cyUqWno8hibr3nmtbOic1CWSSXwFrlfHLrIwXXXu51wRrDSnc/640?wx_fmt=png&from=appmsg)

这就很矛盾了，Anthropic在官方文档和技术博客里，一直明确提到支持RAG检索。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGETW6aesMsYLVfeXKG9tr4981yGtLL7GMWmib9gmYib8YeJGPWRobkoL7FabnMjVDqFibH1XibZsrv2BdUoicBlHQC0w3fsuUiajIuqI/640?wx_fmt=png&from=appmsg)
...
能够自主联想、推理、跨结构建立关联的**认知模型**。

![](https://mmbiz.qpic.cn/sz_mmbiz_gif/A6fTew8FFGEFW8OX3YVABe27n1MXdbtnP3cwrFtfGxlvDO9ia4Y9dFEXyHwQ0qQTlNP7RyicTfKHu82ibe6ehdpRPC6uJnCvXXCbaoPKMe9eC8/640?wx_fmt=gif&from=appmsg)

中国团队自研架构领跑Benchmark
-------------------

让AI能够实现推理与联想，大家都知道**跨粒度记忆的有效组织**是关键。

简单点说就是让AI能同时处理细颗粒的事实和粗颗粒的上下文，还能在它们之间自由跳转（切换关联）。

但这个问题正是2023到2026年间，整个记忆引擎行业难以突破的核心瓶颈。

不过最近，我们观察到一个**平均年龄19岁的中国年轻团队，心流元素，**给出了可行解法——
...
###### **![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGHVbZ7icCOe3XctuSB0eb3xcYH4jnQVBrU12NqfA52ypdla7t5Dy70uhy4BCZOecMdVIibxiaZL8ibYmbbBb73XFbViaiae6TZw5H4N8/640?wx_fmt=png&from=appmsg)△**测试未做任何筛选，采用行业通用Benchmark

深度测评之后，可以更清晰地看到在覆盖写入、检索、预处理、知识组织等环节等29项能力维度中，M-FLOW在绝大多数关键维度上都实现了完整支持。（下图可上下滑动完整查看）

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/A6fTew8FFGEl4x4znd20q3M5LptlqI0icp6yybKpyTxXJbvepDP0LqE9w8ergylDhU0Q4P8libNYBRq9wYTZSKWYTh8JEc1dfcNW327VWFnag/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_gif/A6fTew8FFGHrwK4PNCQDkC6PbeNcb7RYvRETE3KNu10AibPmrh6FvyPGwcrzdU0HVoJkW6f6xKHdtppf7hOOSJ7aNRvs4EZTk5NY0CHfW6mU/640?wx_fmt=gif&from=appmsg)

而且基本没什么使用门槛，部署流程非常简单，在具备Docker环境时只需要一行代码就能完成接入。

![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGH3ZicJGvCGFuic0GIbIcf1Abwwju0ic5M1j7kGTREtbcIxpZ0hYIicSg7Du28cvkABaY5nOOnn4bZWZY3FLHI0nH5EIyz4Mpfscfw/640?wx_fmt=png&from=appmsg)
...
M-FLOW将所有摄入的知识组织为一个四层有向图，形成一个**倒锥**（inverted cone）：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGH1icBjvIymZVASicZO0iaR1ibvseaws9yLsiantFc5z9MdNMeC3s7TDCEiaXIQpOe2faSIiaAHbCr9waNibQicgdYP70TwogNXmibcS1jQ0/640?wx_fmt=png&from=appmsg)
...
用户不是在层级中逐层缩小范围，而是系统在最尖锐的点上捕获信号，然后**沿图结构向下传播**到它所归属的完整语义单元。

![](https://mmbiz.qpic.cn/mmbiz_gif/A6fTew8FFGEVL0DQfKMia22eFibQ0n3wzqBeHpWVhT02KemJlTAxuZiatzAPZfrW6mIn3ibVNMzZCOsphM0Wu8I8nVibicEibesc9BNd7OWc54VEwc/640?wx_fmt=gif&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGHhyaPkFia1up7wFtP3hTVYFH5QmBkH8UFodhIicUd1eibibVACV812ibjI0OMuYeU6ORVSxV4Inr7tvJgAKgxcOlUmFiczib5qCeTzyo/640?wx_fmt=png&from=appmsg)
...
传统知识图谱中，边（图谱中节点之间的连线）只是作为类型标签，比如’works\_at’、’located\_in’，不参与语义检索。
...
![](https://mmbiz.qpic.cn/mmbiz_gif/A6fTew8FFGG5OdAwBkoOuOn1qWjRUctzyUxuoia80prDFp6EiaNT046MKhCiaVBfSibV26VfT7KoiclcQqBWiacaUaN9DZsf3W8FqpBaYMgics9d8I/640?wx_fmt=gif&from=appmsg)
...
要说这套机制为什么有效，根本优势还是在于**图拓扑编码了向量本身无法捕获的知识组织结构**。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_gif/A6fTew8FFGHCPh6F8BJXaVfcgxgXHLhof1FOw359DhKjb6llkPOFQGCSHDWic4BNHRjmqsB6bXRFmn6J4XKnSsciaLLjNZOwibYTdo5WibX7yEo/640?wx_fmt=gif&from=appmsg)
...
_项目地址：https://github.com/FlowElement-ai/m\_flow_  
_产品网站地址：https://m-flow.ai_  
_公司地址：https://flowelement.ai_

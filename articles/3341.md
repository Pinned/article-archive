...
see_count: 8
comment_count: 0
stats_updated_at: "2026-07-04T10:51:11.166Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"代码Agent\",\"上下文检索\",\"自动化瓶颈\"]"
entities: "[]"
---
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYXvicTvVbuWn1ibsIfDpZ6J2aZqfvjJzwaa11n1uoSnyrU4eU8UPkqUBw8QeickXJHenOc7FsibF5ReglClRBSice3wwnIlTvNRPD4k/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/Rvq8Ow69CYWzMCgWxPmbdb3XCiceRbxicPuHwDtjanUr0zDkmx6IRia5rHicEeFzZ6m3LbyIDatokDK4SxzVxkW8XYaeUk0PSXML22zEKuPo2gc/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/Rvq8Ow69CYVvbmRuWbmBWia0UOOZfKpvyiaIRNuccdxXaBzdMicMycosaqwjSjMxz3ZEMIAnMaTIveOVw4gAiaQXVEARr2D7mZ07iarhfAC77J1M/640?wx_fmt=jpeg&from=appmsg)

_ContextBench并非直接构造新的编程任务，而是从真实开源仓库的 Issue 与补丁出发，逆向追踪问题修复过程中实际依赖的代码片段，并将其组织为评测用的「黄金上下文」。评测的核心由「是否修复成功」转变为「是否定位到正确代码」_
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/Rvq8Ow69CYUiakdFNh7rVbyOy5QSPWKcKACbk9jt5u9klDGmE2nKj6qw0uSU94DuqfJ8cicsXN99Cb076wtvBzeKpJ0Fs3DWFDlK2pUpKWAFs/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYUqqCk8QWaUicPIgkOtB30fzfJDD6PKIwibFXD6l6qhJIDcZNDoEWk5n1y4sRzW97Vsic16Sq7mp4u9IDgK5K2sZLR2z1KzZhdmV4/640?wx_fmt=png&from=appmsg)

_各个LLM的表现情况如图所示，该排行榜将在主页上持续更新_
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/Rvq8Ow69CYWCXVzDrKd1EQ4GiadyFhajwzUByMp1cZE0dghfTicsictngAVMTP7jkIWzR2vpRGzPNANko5AqgvaeFWQmQMLkTJqUibskMZ4R88U/640?wx_fmt=jpeg&from=appmsg)

_不同Agent框架在检索F1分数上的差异远小于预期，复杂检索结构并未带来显著收益_

![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYW1hL2Mia3ofBpRMib0bBLwnpibdtOfT3SkwlQKanobqnOPUz4YWV4aMf0FquyHvMG3sn4icJJYBQy7c714HeSarvHpEu8NGJSXJUw/640?wx_fmt=png&from=appmsg)

_对比不同Agent架构在不同层级检索上的成功率，数据表明复杂架构并未拉开显著差距_
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/Rvq8Ow69CYVKW2q6doWpZlvTVCtK2lIwphLxd9eHKMDalZibooicmibLa3NRwEuibR9wibiagNw41ibjFwBhDibo8hS4tJPE4ibmhF4SlO6IeiaZvoIYg/640?wx_fmt=jpeg&from=appmsg)

_从精确率与召回率的对比可以看到，多数模型倾向于扩大检索范围以避免遗漏，但代价是大量无关上下文被引入，从而干扰后续推理_

![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYXT7gqO6RD0icUbCLGTFM8eiclf5QAvSSKksUaYOOSeSLtTaIuJKchqTCGTy3zHLhnCyzjlxIuzyIKHvXdDVpQZK12OsbFARyEU4/640?wx_fmt=png&from=appmsg)

_数据展示了各模型Recall极高、Precision极低的「偏科」现状，精确率普遍偏低_
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYWlL9o77JASuKlgZboibM1csg86YiazMme9MA18841YqfBu4Xh3c3LLNxYX1cOqxvX4xqKpwen0fczxxcn5uh2EOFPjqdIWcALkY/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/Rvq8Ow69CYUCtLG3lRAyQ0eTxKB80WfVjC6CswEeYnzfTsFeR1f0VSKhia9BMzFibV07Gs2SsPsqiao76xghhMvJuYH681zNKHkDmaibSqqlGM8/640?wx_fmt=jpeg)

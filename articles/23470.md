...
see_count: 8
comment_count: 0
stats_updated_at: "2026-07-09T02:59:12.602Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"视觉语言模型\",\"并行思考\",\"机制解析\"]"
entities: "[\"ICML\"]"
---
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqEDUpicdhOuh5icFribslxjoE8mgMic4WPKp7zQmyq06EoLxap1MkmKkOQlunicEiaM7Epuq9F4mHU3tuSuowOeQxr1MfmZrBEfMB9Vw/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqES1jYwb9GY3xZoUCjVlmpeTa311YT74J3IyKKebXslkjOp4xrJrFHib7APWlhbgAHNBybq6185arzrBvUZI6ZxwUaQpWOupY84/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGUicmGrkQpQyhibGVsg1ZPz2BXSaMXG5PuSHyX4YiaSB7BffbYohiaRk4ibbN2edctibJlPqYwreuIfzvNYiaK1t9hTFgpDH6GMPSFFc/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqEIj3PyUSOBibacia6xdry2MWtVaNYsbibjgWgCv3RGdicjpHYPicnZ7A2rg1NnTO0QEpTwcB7fqq79EpV7sVbja7mKvWWVicuzdHK4o/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqEjBckbCsec8ad97hywAwxOtx7EBHHb58jqGqiaqVH57EfhO3VianTKuc7nHmVQk5DINjKnUoUXscs7R3Fib88kzPmQ5eViaoFsBicE/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqEicsCYdDgMl4r3bjYqEfFBUccPE9m1jNAM0UYjRZWCmVM9Br5xzJe0ZTFZG22tqyr3JkU2tNgvAibFQJzBT7tRwSkT94Z7O5pUg/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqEvTF5LNpO07q5QaUWZcGuVuyn1tU1zAciaksocqS7v2iaGV4AwkqZHlyMsvicaf6PXHoeRuxUWsibvibDguOStAywN3zeVBQKTOWic0/640?wx_fmt=png&from=appmsg)
...
然而，上述将不同路径的位置编码映射为同一区间的做法仅仅保证了其无偏性，但损伤了不同路径的可区分性。如果直接使用这种位置编码，会导致 Visual Para-Thinker 混淆不同的推理路径，导致最后的结果错误。因而我们提出了 Learnable Parallel Rotary Position Embedding (LPRoPE)，具体来说，我们在不同 token 进行旋转位置编码之前，加入该 token 属于的推理路径的可学习位置编码，将旋转位置编码和可学习的绝对位置编码相结合，最终实现路径的可区分性。

  

![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqE5Jiaj9lFZ8DEZ7XLvqGnv72WGNPrDNyV9BAHbuXjemksErorEQ15UTRz3OJUM5T9x7eY0SQGFBYk6KWktOhrMSNdBJPaqnN4g/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqEHgEgexStkbBp3VIGwlBGDP5N4icj6czBicFhEAuwrn0c9ibccPJ7H7zD7EsFnw1gp1QKFIYibm9xIPuwrsHKaShV6hxIdnreeG4Q/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqHicywemC7emgNQnOB0Z5NG8YbDicWSwqVI4snx5x4iaJYI6Qh95Vnttmwib8KicBZhiburaRA0KejQnsvbSz3VgOLnqL37U18IJwOvo/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqF2LhCdicKicVMb3qmfxBLyVppVrKusyhKdC3k8e7ThBZla7PgzC8wemDtkk2aIBGDmYT5Mo1BkFSQwicyuoe24HdmoTHY2aSzVUM/640?wx_fmt=png&from=appmsg)

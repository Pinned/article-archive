...
publish_time: "2026-05-03 11:12:55"
account_name: "量子位"
read_count: 17066
like_count: 201
share_count: 987
see_count: 102
comment_count: 2
stats_updated_at: "2026-07-08T10:04:57.377Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"基准测试\",\"模型训练\"]"
entities: "[\"OpenAI\",\"ImageNet\",\"FID\"]"
---
...
我说的是**FID**（Frechet Inception Distance）。
...
*   一个已有的单步生成器，后训练后直接刷出FID 0.72_（ImageNet 256×256）_，而且推理成本零增加。
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGHllfvibj1GmtZkRSlvhHym4uWicXYp9dcCHnrm9dOdXnC5D8nmxSAYYwUoiakAzxapxQvfGChQNrIUAl8ZA6CpJwxLIbStacgJQw/640?wx_fmt=png&from=appmsg)
...
简单来说，研究团队用数万张图组成的大窗口_（队列或 EMA）_稳定估算真实与生成分布的均值、协方差，保证FD计算准确；梯度只回传当前小批量数据，不增加训练算力负担。
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGFOd6kXOk5xUAufRXzd75OiczKlMYRFLehic4j5LDmhAzKvJXX4F5lzAC33L1tkdSOozicm6GVLARkc2Qec0RXpY7yWepaOLZazbE/640?wx_fmt=png&from=appmsg)

为了验证这套解耦机制是否真的有效，研究者在最小的pMF-B/16（118M）上做了两组消融实验。

_（注：论文在实验中使用了明确的模型规模分级，其中B代表Base小模型，参数规模约89M到131M。）_
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGGPvBkNVdVFqfoc1yqO8GjHmrz9RuicmicSJ2lVcKMfibtxcqm8dGNj8ldy9zHJf9KDoA0OBrYYiamdLAHCI4hnq58vPYEgF6X2k1o/640?wx_fmt=png&from=appmsg)
...
结果在ImageNet 256×256上，FID从2.29干到了0.77，同时依然保持 1-NFE_（单步生成）_。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGHeMmEhr9D4k3XJ8GxDZYYNgDwOrEMuXXWQ2P4x2poicm84vbQzTZWzdskRPJZje91CjK8cCibM7YwOj9qdDJ4oQmx2PMpbaibLjg/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGGw8gU5gPLwbJ1FDKJQyG10txUwYqszN0rhOgNvPYIwq83FJAcwlmRW7OVFAGnGyDx4tZXVFJAr7gvp0w4LPyiaLRnuicZVZ9Da8/640?wx_fmt=png&from=appmsg)

**发现三，FID最低的，未必是最好的。**

这也是该试验最具行业反思价值的一点。

当研究者把FD-loss放到不同的表征空间里优化时，事情变得诡异起来_（惊恐.jpg）_。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGH0JY7IzHZveQgw7YjZjfqWt9WOQFPVvCeFicqDU9gfiaXAiavK3ZtEv4w4d5GUA77Ql53Gn4ibZQzvKiaz4ry8ia0IticeqAnia4HQ5wo/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGHME6oYC7U9bgKnH0NvCyKnbTLCY4goJOiamoKPM9XbfavKgYicicjYRr5BZ2zKVtLw3rgnZ5aSJiaMKp2BHvOsrG5I1J4jxHT6Hns/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGEDnPMouibfdFM9MibTH4ibZTIVloD5NgeMmKEqpkkDsOkoQDbIuPVWua30f3vVXO5LMIe1HF4njw8HdzKnGTrVu1AyS8XKHgT3UI/640?wx_fmt=png&from=appmsg)

Xuan Ju是香港中文大学博士生，师从徐强教授，主攻图像与视频生成、高效多模态模型。

她在ICCV、SIGGRAP 等顶会发表多篇成果。

![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGEiboKA1OXSKT8cNQoBGOMdoUF39nT1sWGtb0gVf6BslHHVbFENIlAvJpeGyVQibia8bBhLJNGDcO8kCkZmib03Q8YJWhwA2Qic0TDs/640?wx_fmt=png&from=appmsg)

Yonglong Tian博士毕业于MIT计算机科学专业，现为OpenAI研究员。

他是监督对比学习SupContrast等表征学习标志性工作的作者，曾任职于Google DeepMind。

![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGG6r758PwFeoykvqYkzl74hsu4yLONl4wibic6pibTyKYULjIso0PKSgbIqY2iaZfXEY5Tpf49R48qIW2OwWuSbeTs1VB64ogd4N40/640?wx_fmt=png&from=appmsg)

通讯作者Yue Wang，USC助理教授，同时兼任英伟达研究科学家。

他本科毕业于浙江大学，硕士毕业于UCSD，博士毕业于MIT，研究横跨3D视觉、生成模型与机器人。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGHoBYUQX116EicpibpgLR1r0uuAcgwqU1jLnDib7eukjQDEoKF8Th37DjPFiaUaRnoe4w5qLj28eyzKaE1IY1OCz85gXEqfiaPfN5Qo/640?wx_fmt=png&from=appmsg)

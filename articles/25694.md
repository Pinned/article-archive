...
url: "https://mp.weixin.qq.com/s/-XPfn3TCwAKnLPj4Hfh1pA"
...
see_count: 14
comment_count: 0
stats_updated_at: "2026-07-08T09:55:50.028Z"
is_unavailable: 0
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGFj6sw0Unbu4zjoicPJfvicA8icHRFl9tfOYEgDWUVRiaF0noa8Tia3Dh4iajk7RDmLpB09fsJ23RQgtfkYN4MGQiaIPZqzovwLKAoacg/640?wx_fmt=png&from=appmsg)

实验显示，相比Hugging Face原版Transformers v5，英伟达NeMo AutoModel能在MoE微调中实现**3.4-3.7倍训练吞吐提升，并减少29%-32% GPU显存占用**。

在单节点8xH100 80GB GPU上，以Qwen3-30B-A3B为例，NeMo AutoModel直接把TPS/GPU_（每GPU每秒吞吐量）_从3075拉到11340，提升达到3.69倍。
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGEMPlrZ041lX5L3blIKicWT2DIZTjklx9Htze6QaYlYdECgMicL2QKFgNyIfBaM5FYUS6BnvXiawBEibInsGXicv1nMM39hmdUnuKpE/640?wx_fmt=png&from=appmsg)
...
举个例子，8张GPU上ep\_size=8，专家权重被分布至8块GPU，**每张GPU的MoE内存占用能降到原来的1/8**。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGGFJxqnyWUvjek65LOePSjKJoUJpbCROcibHD6Oko2Qt8BjLfEjOXBXn29nLCe5KKZpJrMiamicZh9ticU88Gwtic9nTmzHoC5AsOtk/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGFZSy4mVcB42Lf6TqgmOhlfPI4EgsahRLOvO28Rk5eWk9rpPxz9Z99ERjPpVibr84dKrHXEtxGq94a1icRibibzVM6ZnCkWKt64aEE/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGHlicdrJZt5XUtqaiaoldT50u0icJic6grmbzWAFXIClzghbmSqOS0z7niaCMzTbG193bNic5ibFqGdrHaY8OU7aB2zeC6wIicfIQiby8Hs/640?wx_fmt=png&from=appmsg)
...
https://github.com/NVIDIA-NeMo/Automodel/tree/blog/transformers-v5-automodel/blog\_experiments

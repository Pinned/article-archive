...
url: "https://mp.weixin.qq.com/s/pF4sRiO6dbjKVvaJ2_RKBg"
...
see_count: 8
comment_count: 1
stats_updated_at: "2026-07-09T03:14:32.228Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"AI编程\",\"护城河\",\"竞争壁垒\"]"
entities: "[\"Claude\"]"
---
...
1Anthropic 被爆正开发与 Lovable 相似的功能

近日，x 上 ID 名为 @marmaduke091 的网友爆料，继 Claude Code 源代码泄漏后，Anthropic 又发生了一次泄露——他们创建了一个类似 Lovable 的功能，让用户可以轻松构建全栈应用。他们正在追赶一切。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/lYDricib2fsm5hAvVnty9ich6cveyBIgpWbPya00j5E8dz8Zlj38nuKGLNBahqibMU6YdRp1wpm09Ihwru4Q55gmWnkzJexQ7QoxB9aY6bzGU8k/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/lYDricib2fsm5yfCVbdPqm3ZkWlRLQCjQ4icgwFkJNUJKbT2oE238uE2kcazk81GMiaO5mLOKMvarvu1TUjqLEdWNWnVZBib2K1TblbQqpu7Pgm8/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=2)

有网友猜测，Anthropic 即将推出新功能。

![](https://mmbiz.qpic.cn/mmbiz_png/lYDricib2fsm50Rna9EzThP7fuhsCd5SxEY8CJ9xOpPW4PicMB1umktHx9tQ5xNbkVDJbkwYDVS15IibtcI4uiaqGzEutSmDxdYw6sVDd5a6Ec5U/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=3)

目前尚无法确认 x 上这些网友爆料的关于 Anthropic 新功能的信息是否准确，但 Anthropic 过去一年也的确一直在把 Claude 从“聊天模型”往“可创建、托管、分享应用的平台”方向推进。

2 Anthropic 加紧补齐整个 AI 开发栈
...
![](https://mmbiz.qpic.cn/mmbiz_png/lYDricib2fsm6D79vI2oL06MFSNR9LPHE53hBES3kedQVMU2WYqGA5oibwyicQ4pGIB03tLu4a1H2KP4UW2B7q130hMWRb1a0mEoTLuJnU80XrA/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=4)
...
![](https://mmbiz.qpic.cn/mmbiz_png/lYDricib2fsm6puzMEey274q2jE4D6o2sqVLladNAWbBKXuFF3AtgicuM3IMOoDxRltJ2oNHy4gKF7CvpauRuCb5dFpp5wrcQTNtDHaicNxmT2E/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=5)
...
3AI 编程进入“大收割时代”：Vibe Coding 的护城河是啥？
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/lYDricib2fsm4QJEF5XvxPHV9LdVgI3NZmicwiaIvIHvya4fXLz9VSW1zqb5TOM6GUXAIZYysGibnBuZ7tS6PxUjlLjrtBUdOThrqoEzznxCpKfo/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=6)

也有网友表示自己之前用过 Lovable，后来换成了 Claude Code，结果发现实际上用 Claude Code 开发比用 Lovable 更便宜。

![](https://mmbiz.qpic.cn/mmbiz_png/lYDricib2fsm4bFlgJGYBEAQavmeD35dJA0HpqvCtRCwu3icIB6GwAHRmB48dkzzdkyFicPzzkpx0nkRfIpiaD3qqNeCD7XEEdjxUTjIAK4C7ia6s/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=7)

有用户表示，Lovable 这类应用做原型很棒，但未来 Claude Code 和 Codex 也终将会提供类似的功能，一切只是时间问题。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/lYDricib2fsm5DDxAyuhUDqfxED6Uy5ROO6R6FQXykH6ib5iaLIN17Ohh6letXasGTk5n96jNEWVqjnwPHyZVzUu9iccjt8PeJbqPKfVSN3yhWC4/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=8)

还有用户感慨，Lovable 这类应用技术本身就没什么壁垒。他写道：

> “几个月前我从 Lovable 切换到了 Claude Code，现在根本没有理由再选择 Lovable。”

![](https://mmbiz.qpic.cn/sz_mmbiz_png/lYDricib2fsm62f24xthXiaaID9JzSbeicyI3JeTRldiaZDwPI1WUQQbdQyiahic7QjZ6NK9X7G79VvbHhrLV00p0ia5Ft07ZZknxD59HO2KRGexmxw/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=9)

还有用户认为，不止是 Anthropic，其他模型巨头们也在向全栈构建工具转型，这意味着这个领域正在融合，大家都在追求大一统的终极目标。

![](https://mmbiz.qpic.cn/mmbiz_png/lYDricib2fsm6iaicfY1aJoWicUAghTeVgdf3oeSgNPVyWmbyXeghx8VLfKHEWpfFxXBVBwmibtD7B86YoNdzzmaFG7Iv9jq4B70IBTmUkaRCtDRo/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=10)

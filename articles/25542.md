...
url: "https://mp.weixin.qq.com/s/QuOSgDH6fDL2utmeN2_xHw"
publish_time: "2026-06-12 17:47:39"
account_name: "AI前线"
read_count: 4581
like_count: 61
share_count: 289
see_count: 27
comment_count: 3
stats_updated_at: "2026-07-09T05:37:57.948Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"芯片\",\"大模型\"]"
entities: "[\"华为\",\"昇腾 950DT\",\"DeepSeek\",\"字节\"]"
---

# 全网首份指令级拆解：看华为昇腾 950DT 芯片如何撬动 DeepSeek 75%降价与字节锁单

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/lYDricib2fsm6GTMpReGI8oxydh9Fa8ZxSlic6jTxZ6FShpiaVZSqaqW5yLUcp2ibfVSiajrln2CWPA40FNMOuOjmtaRESHmhNnlywR8amGiaAajv8/640?from=appmsg)

作者 | 四月

距离正式上线华为云还有两个月，华为的最新 AI 芯片昇腾 950DT，已经被提前放到了显微镜下。

![](https://mmbiz.qpic.cn/mmbiz_jpg/lYDricib2fsm4O6Br3cI8p4WDn4zCib9Jgej0iaLXXdicGDwib4hw012H3viaGs3HdnIWksdNGhcXnhc44dCnlOOTg5F3WRNdJQc8pBN3xevhLx4c0/640?from=appmsg)

近日，华尔街知名半导体研究机构 SemiAnalysis 已经率先拿到样机，围绕 950 系列运行 DeepSeek V4 的**推理链路进行了 Trace 级拆解。**
...
也就是说，昇腾 950DT **并非在模型发布之后被动接入 DeepSeek V4**，而是**更早参与到了模型推理路径、硬件执行方式和软件栈优化的共同打磨中**。

这也是 950 系列真正值得关注的地方。它有望成为推动 DeepSeek 从英伟达底座 转向 国产昇腾底座的关键节点，而**这种迁移与转向往往是不可逆的**。
...
推理端，V4 把百万上下文的价格打到 2 毛钱，较 Anthropic 便宜 50 倍左右，这背后同样**少不了双方在底层芯片、推理框架、低精度计算和通信优化的共同作用。**
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/lYDricib2fsm6ViazaXSBfKqR4nOiaxgfC9ic0uUicqJhbUOtMzEqvN2T8mvicH49eZa55owy6329UGypnICUCjFOGlkAIP6ObIpWld8Nkb40jrlvY/640?from=appmsg)

流量爆发的背后，价格是最直接的驱动力。

DeepSeek 早些时候在官网明确指出：“预计下半年昇腾 950 超节点批量上市后，Pro 的价格会大幅下调。”

![](https://mmbiz.qpic.cn/mmbiz_jpg/lYDricib2fsm6hnrJgEyd2WzSE4Ky06wSc9eT6zL3yaPTK86PPnPoIPHSHAnPrWago3LsLy9TLxyiaVic5HyXrXB2TZVODpMBo4MwOAV1o2oic5s/640?from=appmsg)

随后，便宣布 DeepSeek-V4-Pro API 永久降价至原价格的四分之一。**这也直接印证了 V4 的 API 正深度依赖 950 部署，且成本结构仍有极大的优化空间。**

![](https://mmbiz.qpic.cn/mmbiz_jpg/lYDricib2fsm7iacBfkfMmVm6h2a8RGXgHN650actVFeXxibiaYB0QMEicjUIB4tMWtXJEZmqc4wtrDubDnDeurvVWFQ5MhYsBSlFOu7BbPUz9AVU/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/lYDricib2fsm4uaic33YQvQOCicCniaAT4PXoMicGguvljFFzP65ra8sOzmapjW6DK9tiaqDXbyOP2c5a3z0Hsw3OAYuTqmoflWvpXCz1xAAoVVxdY/640?from=appmsg)

由于采用了不同的封装内存方案，950 系列分两个版本：950PR 和 950DT。

• **950PR**（Prefill and Recommendation）：今年 3 月已量产，面向推理预填充阶段和推荐系统，侧重成本优化

• **950DT**（Decode and Training）：搭载华为自研 HiZQ 2.0 内存，144GB 容量，带宽 4TB/s，专为 Decode 阶段和大模型训练设计，8 月上线华为云
...
![](https://mmbiz.qpic.cn/mmbiz_png/lYDricib2fsm77B6ia0G0ibDImH7ADE9WeH9bkKAz4ickfyaBYILQcD4hFOE4L0NR1tvlIGpXJD49LbB3V8xEFOVNDFickJiaiaYCcEsC4zqqkXtElo/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/lYDricib2fsm70NMx2OBxf4DuJSX0gRrehchIRszwb99ia6mEGt7Yb49YCFFeyvenFuSj3RYvfuJCsMujSEmYUP8NzWJnN3DylrW0O4IdcibD8M/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/lYDricib2fsm4HFyTom8icMnGDFXXPdpIFBepmFdu1mCJfatfebmQtefnW39krQ3DicWyVtibic8G7NzGSUiah5QTGcrDbEAKmt9sIwBRJATicBZFLQ/640?from=appmsg)

CANN 的策略非常清晰：每当中国头部大模型发布，全套打包交付，包括针对模型的 kernel、量化方案、分布式推理配方、serving 集成。

这和过去很多“国产芯片完成适配”的口径不是一回事。适配解决的是能跑，但完整推理路径解决的是**能不能部署、复现、优化地跑**。
...
![](https://mmbiz.qpic.cn/mmbiz_png/lYDricib2fsm4WQ43ialjoJozTcUjYVGcQZyXesOly87hpPyDu9ckcG29YkRjDnOZ3CCP13KDAoqjpia7MpnalmgiaNU17h7tJRNoQcwEEd2OsK0/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/lYDricib2fsm67gfYDQ3MicYhNmdKh18Uuq1vY8Kg76kauUriaWhicbT71jwyY2q3HUnSibRRB34uYt1960OBNTPpRxZMP4jGJAAv6rruicyLG6icV4/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/lYDricib2fsm5NwBsJ8wsX4qfYnhWWasK6Ws4icia3y7Is12wAUa7OtRsTTgE4mNHeLHoOCfR1DqSbtc7CmXVYUgYGU4ncQibMOI9bzfqeMETia2I/640?wx_fmt=png&from=appmsg)

分析的核心是把一个 decode step 拆开来看。一个 decode step 不是一条串行的计算链，它在内部被拆分成多个 stream 流，在不同计算资源上尽量并发运行。

从 trace 看，CANN 至少做了三层重叠。

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/lYDricib2fsm7JPibadia76w3PpbJ1GMK1DSkKZF0NRES5N8iaCpnwdib6VXDClPch7BaPVnoicPRwkLuA6ZjNxW53zib5Qfl4jrqJzAsRkMicTkD6wI/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/lYDricib2fsm48IKpcKjdPt5dg5nStYPwSRZSSvxENAGiaYXkrOhWSt2SPDMVz7lJeBoTqMDdBAufcB1GibeX5clMicQy3dqBc2WMMmw2L1loUHk/640?from=appmsg)
...
从 trace 里看，Streams 145-148 对应这些元数据计算流——它们在 decode pass 开始时触发一次，预计算出可被后续内核复用的调度分区信息，耗时极短，且完全与 AI Core 的计算重叠。`SparseAttnSharedkv` 和 `QuantLightningIndexer` 消费这些元数据，决定各计算核心的工作分配。
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/lYDricib2fsm6cEZdzIYjgngbRhOjyNqrfjuvgSPs6ZaINcFOMNwUtcxuiaTmJkJjE0XFzUTmqjUvNwdRuYgQUf04ibqxawIfqIdpffWffEmuTs/640?from=appmsg)

这不是普通 kernel，也不是 HCCL 集合通信，而是把通信原语和计算操作**合并进同一个算子**里。

在 DeepSeek V4 的 decode 路径中，SemiAnalysis 观察到了两个 MC² 专家并行算子：
...
**![](https://mmbiz.qpic.cn/mmbiz_png/lYDricib2fsm69I8KAQbPQfZQ3e9mY7Ss8aAJZbx8nIicKZ9tRoTwhQicM648a4B2UYBX300wibv6FKHPcBiaPBGeTlwNWBR7n8icSe6CooHiby2icibE/640?wx_fmt=png&from=appmsg)**
...
而值得一提的是，其他主流国产 AI 芯片所谓的 Day0 支持主要是**基于“类 CUDA”生态的软件栈。** 某种程度而言，**还是缺乏自主的软件生态。**
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/lYDricib2fsm6KFTemmVJrIQLxicpq3R9ZU1QPwB8iaj6M6fJ9dxRY1XkZr6HCOR6ic9CJX1Y9FZvbG8cSufNmqCJmKoNNvy8IQU7UH62TlibaBDw/640?from=appmsg)

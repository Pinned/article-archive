...
see_count: 52
comment_count: 8
stats_updated_at: "2026-07-09T03:00:45.455Z"
is_unavailable: 0
...
4 月 22 日，OpenAI 开源了一个名为 privacy-ﬁlter 的轻量级隐私过滤模型，试图解决大模型系统中的 PII 检测与脱敏问题。

  

![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqFfCHXK8Ep2oT3sPDDdSiaO10J3RGicZODpC5oul45iaGyXZYvPfoIysQoAJ1pg4KFHGmQXba5mNeibn28znceJESynwibtic0gon7RE/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGT15eKRC0GzPLmSNglGCOLgEKvaEkt1UZonatHkwibukrVhwXMtc6zNJ4oQfE39PRRmiczcohL2klsJBicHbDoNFc3ibTVMHAcehs/640?wx_fmt=png&from=appmsg)

![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqHsRQ6mBZv6SJKXxGznwXVewzmR6GF2QVKV3FCEhyQy9ictRRjVZlva7Y8nmsiciaSRQN1okSrZh2FswpHzbWw2oxNfyPicJJo2dew/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqElg9weLTL5bxv66WMhDy8YgAOwiahj1sysBlG6hKy5LZuBib2zQkFSg7x5rI6qvpYicibMpGfOFrvicjxXVloGwTPYObnniaCUkD38c/640?wx_fmt=png&from=appmsg)
...
比如，把用户输入中的人名「Maya」替换成 \[PRIVATE\_PERSON\]。
...
银行卡号、社保编号、项目档案号，可能都会被塞进同一个 \[ACCOUNT\_NUMBER\]。登录密码、数据库凭证、API Key、内部密钥，也可能统统变成 \[SECRET\]。
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqHIx1tpgFiaPWIKqP9tCVpj3YxbXQiafbyHoNu6a7LNT6GRicNQuLNUOKalWZib0yiaSvvk46EzWWVJ2EEy05vfsDuSsug69VxIzQJw/640?wx_fmt=png&from=appmsg)
...
如果文本里出现「我的血压今天是 160/110」，MemPrivacy 不会直接把它变成 \*\*\*，而是替换为类似 <Health\_Info\_1> 这样的细粒度类型化占位符。
...
云端大模型看到的是：「我的血压今天是 <Health\_Info\_1>。」
...
当云端回复「您的血压 <Health\_Info\_1> 偏高」时，本地系统再把占位符恢复成真实数值，最终呈现给用户。
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqHEeIob79j5AzhIfGGm2cDkNJW4H3nIg4sThQ3IiaT8KNJxUqfklhYibT4YYe7ViaBYbWAPRQDDNKys9zNFibSylggFkcsnna0Xgiak/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqEgBOQXiakX94nNsMibYEvsqWsNOsP6VR3ChGUIibln0LJdLBmZyBPkKyL54jd9hQ6Ka0A00yiaYGmmjg2Nnia4PtK4nF9SZUibJKWPs/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqH1CoqhKLVSpSYZcH3Yovia0AnL431Hn1OEdgESMC2WvUibYlHmObcldZlrUQx9yCjZG60LzrzUUSFVhBeCRMhxE6FcNEITQPr8k/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGRRAlzfib2umXUCN0oBhzdnPosicYR6aW8jlsp5QF2NjqQ9wibycAOaySWqGMWEeuzuJ3lgXrbXB0ia4FpenwWIZmyuSZdliaCBqz8/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/5L8bhP5dIqFEhlc0jiatDTggTibfbQuUT9sWdeicAYyVqCKxOPrjgLGibZ6d7TwL1kOCBgw2tTw2W8Ey4nFibXRiaKvdwSdUhuq5Slkr6wpV4bvuo/640?wx_fmt=jpeg&from=appmsg)

...
see_count: 101
comment_count: 2
stats_updated_at: "2026-07-09T02:57:16.697Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"论文革新\",\"AI执行\",\"研究包\"]"
entities: "[\"Stanford\",\"Michigan\",\"CMU\"]"
---
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGic1IW8pyvGezUFicj8Nw1KxBquMzX73MHjrA5ulian18wY7ySfpibnTemeJIWN2libGlU5QXRQ9dSX0jWAW7FibJa4XpQicqFwnT4aA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqHhL824dZQvSzKnn9nllyX6A6p8VVnV4DE5YKFc8zOuER9oLFlggwvsEaibBmLZpJh8SJ9CReWOaWkmkJrwLCWBDEmiaKkhDauR4/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqHGV2jiaJIdbe8L0KyiaCHJ2Gaw2AOQjpmH4WHPOoFU8Mjtg2DHebtttaxxh87HM824MoNicccpRdOo615OeGmbFetdcQkiaU9eg00/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGP5Z4LajKiaBTygqZaKjhhvHI2Wgia3GkMy0GRL4ptnia7GMa2gvibuIhtJibmTf4icGZXOvTQl5WNHuFPj81ejyGODibAcAhRmmZGPE/640?wx_fmt=png&from=appmsg)
...
Live Research Manager。 这是整个体系的关键一环。研究者不必事后回忆、手工打包；这个组件在 AI 与人协同做研究的过程中静默捕获轨迹：哪一步是 decision、哪一步是 dead\_end、哪一步是 heuristic、哪次实验产生了多少 loss。整个 artifact 在后台自己长出来。
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqHfict0hm3QJkDuNAdeibkiatn19evsKYky2icBoIWWk4w9qtwINnNRicRdqCGAOECIYjQRZfOdbA26ib2uvATR9pOS2JepkqvXgY8Vg/640?wx_fmt=png&from=appmsg)
...
不过扩展维度上还有一个反向发现值得单独拎出来：当 agent 本身已经足够强时，被保留下来的 dead\_end 反而会把它框死在原作者走过的路径里，让它不容易跳出 prior-run 的框架去做真正大胆的探索。这是 ARA 设计上的一个深层张力：保留多少是 "站在巨人肩膀上", 保留多少是 "替巨人套上枷锁"。目前的答案是：对中等能力的 agent, 保留是巨大助力；对最强的 agent, 则需要一套更精细的 "忘记机制"。

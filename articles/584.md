---
id: 584
title: "作业帮StarRocks替换Presto落地实践"
url: "https://mp.weixin.qq.com/s/WmNGWQ_prWX6P3r6tURXHQ"
...
see_count: 4
comment_count: 0
stats_updated_at: "2026-07-04T08:57:13.732Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"查询引擎\",\"数据平台\",\"替换实践\"]"
entities: "[\"作业帮\",\"StarRocks\",\"Presto\"]"
---
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNhTVmo8H4A9JiboZPbvsnW6stECs3TKicFQdsVibgqzhAvlGibDibSUq968QBh4Y6vFZYiaWFkYWcf69GZoH78UabSnUalnlI0oKsBe8/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNiaR6GoXI3rjiavrkuISBQITOIF2IECV691GJjCncJgwccwib7F14peHqH8zhXibDArvu0IzZboRzfbmP6AuINb6El5A5ae7hlOdLU/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/hLLZnAbUwNjMNoiazXibr1An2Rz5pLCf9y7FxTOdMJtpiad8s4vz1J0jZlnzHBBcibDz3YgOMiadld6YmV1HLeNtUTyWdCQVErKMSmZaFzwiaic0FU/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNgpiaOrbdGh0EnTJXP7sRKl0aKkjBkpaYyCRhia1Pv0kORH4QYc9vBjETL6S4YrFj7t3Ykws2zibHAHA5gibABabubIqjjhuvCLtM0/640?wx_fmt=png&from=appmsg)
...
*   解决方案：调整 SQL 为 explain select \* from( {user\_original\_sql} ) where 1!=1
...
iceberg 表 plan\_mode = distributed 报错

![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNjhfNYVjV7G9cCBQMuPbmibxMakz23mRM5cNhibjAUlF8v25yaafxibtv1PVHzoIuicf2iclNIfO8MWxsQ3oEEvicb4c80leg5rNk2Gk/640?wx_fmt=png&from=appmsg)
...
multi\_distinct\_count 执行慢问题

问题背景：当 sql 含有多个 count\_distinct 表达式，单 CN 节点内存使用极高、cpu 空闲、执行速度慢，无法多并发执行；

原因分析：当查询包含 count\_distinct 时，StarRocks 会有些内部判断逻辑

*   如果数据量很大的情况下，分出多个数据流分别进行 streaming aggregate 最后 nestloop join 成单条
    

![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNiasLP7JI2oWugxVkz6nzPFIkek43W6g7qPrXuWs01qvhKoibDT6T2Ouyro7O3xm3Q8LR1UczFJbWbxoHB89q8F1RGdpkUTnRUGQ/640?wx_fmt=png&from=appmsg)

*   如果数据量小且列基数都低，重写成 multi\_disticnt\_count 函数单点执行
    

![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNhJiaOyliaJ7NwPPPThB1QWg2aZ076mmjicGwCP6l0XhuiciaJ3M9Y5kribheud7gic6XXXDpV1zm6LykNHpfgs8T9LNia98K5w6ibCxlno/640?wx_fmt=png&from=appmsg)

*   当统计信息缺失则可能误判，也就是在数据量很大时误用 2，导致问题。
    

解决方案：由于不是所有表都具有完整统计信息，所以禁止 multi\_disticnt\_count 优化 set global  prefer\_cte\_rewrite=true，放弃小查询性能收益，保障整体查询速度稳定
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNgYEk1Lj6ZIMQzvMPJTOJIymJkvSiboibICveqFiaics0G3XuzZMhFqdT8NPTOT205YhqsAiaJgiaL29xPgWDiahNUFftCicfBmicsOyMt8/640?wx_fmt=png&from=appmsg)

解决方案：增大 async\_refresh\_max\_thread\_num 到 128，以 128 线程并发获取分区的文件列表。默认超时时间在存算分离查询数据湖场景偏低，加大 set global new\_planner\_optimize\_timeout=60000 缓解
...
解决方案：设置 global sql\_select\_limit = n，在原有执行计划树添加一个 TOP-N Node 解决。

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/hLLZnAbUwNiag3fUAtTb6xwicEicK5tPdNcYWusc9jLA3lxtWQG73lWw4YNMK1GqR5my2gFJDVjPjfIc27K4icO7qkmVek4YbR3FibdI4mANFwEw/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hLLZnAbUwNjbZG8OR76yxBb5Kw1riaowklmHiaKgNYW1LRiaZs129VG9FXrCfRwuZ4NSVc83aHicufj09icayYGVLT7sVRwhOU2icmqpG50jAc678/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNjrsh5YwFPfnjFK5hoa86W69rr4PPicfTC6S2lBYdQotsYiciacm5Fyv5uIy5ItESAic701n2BvC4U9YslXMKo10xlHocfyc1R7mUU/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/hLLZnAbUwNjRUOpSYgibpEazGo6JlNoqnO3GD8TxG5TRYW3hX301AHGveI5j7dWrgg0PuXS3kPpc3ictHI3icxNBXicW06VC24f2mLlu7vq1vc8/640?wx_fmt=png&from=appmsg)

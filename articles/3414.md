...
see_count: 33
comment_count: 1
stats_updated_at: "2026-07-04T10:52:33.881Z"
is_unavailable: 0
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYX4yJ5L4uo1THEVchQcbVCbXetf25cMkhwdxDo5IbibzDMtg7OlwX222f76yic2sWx950OHmp0TvOJqGibuJcFlQoVic2aCkRFn9J8/640?wx_fmt=png&from=appmsg)
...
受认知科学中双重加工理论的启发，北京大学研究团队提出了一种双系统架构**ProAct，**核心思路在于**快慢分离**， 即将即时的反应与慢速的推理分离，使得ProAct兼具响应速度与主动的深度社交能力。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYXPTEqWoYFoEHQM2JB6RFVe1KKf02qgHJBvX90XhtPP5dyq4cJl55NloXicewjJSGE2y2oFPK8IAo7IpDXlVicVmHPzgVOgEEuuE/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/Rvq8Ow69CYXCcqf2TWS6meLTlL8QLaVC1AvvUDJowQmtxT9VWVFuuJzAeJh3TNQ2IBHV0TwhuicP5icjp1ic0eV7nTWd9Eyx0kdicicqzweziaAKg/640?wx_fmt=other&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_gif/Rvq8Ow69CYUW1qNPXMemicgZAHK81bUyH887KxSj72JJN2XibfoR09Lwmu3rR7M9KZrDRhsIEdibsd09LBx74MMD5Kiawzj1QCNrAxt8JHGvqeA/640?wx_fmt=gif&from=appmsg)

视频1. 在生活管家场景中，ProAct 发现用户有急事后停止说话，并主动提醒用户离开时忘记拿书包。

![](https://mmbiz.qpic.cn/sz_mmbiz_gif/Rvq8Ow69CYUmOsXaJicrbYG6OvZ4wBQxeGg4vQOVfial3IiaMnxryWREL29bvyKx4LZWXD654s9ibAklpaMDTHtibK0kIdpoYBTI8HJM9tzAc5Ig/640?wx_fmt=gif&from=appmsg)

视频2. 在情感支持场景中，ProAct 检测到用户剧烈的情绪波动，主动询问缘由并安慰用户。

![](https://mmbiz.qpic.cn/sz_mmbiz_gif/Rvq8Ow69CYW7jibicJ3OIibiaC1m6pHW2icAUsnqjPI1xNjTIhOia0jGmllnNmiaicoAgN5v5rgK5RWDJEicm3DicFE9u4xBA85LcWZ153xFYFDFOOZjg/640?wx_fmt=gif&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/Rvq8Ow69CYX82JxHwNqRe70IAp0LIvoUP1TReeMmNs1HbTA8uOskU5EfqIzpFxHUqmpSfn1TDmUMAAXjcYXTzKMbOHVdUtU1ib3ocFQZyjtg/640?wx_fmt=other&from=appmsg)
...
首先是**上下文编码器 （Context Encoder）**。为了防止随着对话进行导致推理延迟增加，该模块负责将累积的对话历史、视觉帧与过往行为压缩进一个「记忆库」。记忆库结构化地存储了用户分析（如心智理论）、情境追踪（如物体位置变化）以及机器人的历史行为。

其次是**行为规划器 （Behavior Planner）**。该模块依据当前的记忆与感知，进行动机评估。系统会从视觉场景变化、用户意图信号、对话状态、社会规范要求、情感响应需求这五个维度对当前状况进行打分。当任一维度的动机分数超过设定阈值时，系统将触发主动干预。
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/Rvq8Ow69CYUQRhNic4l2QNcvZFQOk0ludeuXX185zJWpx3Bn1YRJYbEsT9n1FS4aphwlIicx9KrGBNXprOiaOeOaicTjRmlBCibCJKqppicFaC89w/640?wx_fmt=other&from=appmsg)

图3. 在海报讲解场景中，ProAct 主动发现用户并打招呼，随后纠正用户的误解。

![](https://mmbiz.qpic.cn/mmbiz_gif/Rvq8Ow69CYWCXaFBqqcgGzDtSv1C2xwNart4duuSWepJbNDHJ81SKWicrdIFpJdobUIlnDBdfI0MeTCzUhvTvUDZraqQJa5yNUbUw973hDLY/640?wx_fmt=gif&from=appmsg)

视频4. 在海报讲解场景中，ProAct 主动发现用户并打招呼，随后纠正用户的误解。

![](https://mmbiz.qpic.cn/mmbiz_jpg/Rvq8Ow69CYWG5CQiahU1Ywo9zgMAlK84s4icGiaepvCydibTIxhb6v4JoYcC91pjAmkdHS1SPabBqVmk0POBWfYnalRffDTas5wNPEOqYkd61rs/640?wx_fmt=other&from=appmsg)

图4. 在讲故事场景中，ProAct 检测到用户玩手机分心，主动中断故事并提醒用户。

![](https://mmbiz.qpic.cn/sz_mmbiz_gif/Rvq8Ow69CYVODysqaO3DE802biazxicXxwWVmp59plrIp6l80AL4p3hedRqJiaVupHUYicXP3AEATbQ1kCdDvd3YNp1663DeYNYbIvo6Cxk8xJY/640?wx_fmt=gif&from=appmsg)

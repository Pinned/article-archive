...
see_count: 109
comment_count: 6
stats_updated_at: "2026-07-09T02:58:54.893Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"自动化\",\"端侧模型\",\"训练框架\"]"
entities: "[]"
---
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqEtFvpnibic1gGicPiaXSFNFejC5e2gNNrFrpZD1wEOt2WgfXPp9mPQHiaMsQTVVLKWp0b6OAiaibsQ2HISGJ5YQBibGGibc3bfv2kKnI7E/640?wx_fmt=png&from=appmsg)

  

![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGp4bx6lBxPSztpBpicYBkwU7q8jZOUznG7ALs89lWj3TfvKmiayc7lhI2PZ6SHslr5xhoqtcCkiaw0glZD4kQI0UdgdKsW0E53WQ/640?wx_fmt=png&from=appmsg)

  

在权威模型评测榜单 Artificial Analysis Intelligence Index（AA-Index）上，MiniCPM5-1B 再次刷新模型的智能密度上限：仅以 1B 参数规模取得 17.9 分，位列「小尺寸模型」榜单第一，超越了所有 2B 参数以下模型，相比 3 个月前发布的 Qwen3.5-2B（16.3 分），MiniCPM5-1B 不仅效果更优，参数量还减少了一半。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqEicHxmquf4UICjEa3nGVj3fvM4PGXkiaXCAPgmNicibIPowrekaYotd1fseH0G65L37skcZ5Q90biciaGW4Qb4HrJvhiblalTFzichS0Y/640?wx_fmt=png&from=appmsg)

  

![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqE5sxlGdrXicJfoLP2Ns5OBrVwQJk2TnSv2bEW7QLPFqv5jSt9CDTBCldcBeuKPQoVo1YV6qDxXOx7Gtw68yhc6DltnKU2jZOibY/640?wx_fmt=png&from=appmsg)
...
在推理侧，支持 SGLang、vLLM、llama.cpp、Ollama、Hugging Face、ArcLight 等工具和框架，如此一来开发者不需要从零搭建一整套模型使用链路，而可以在已有生态中快速上手。
...
这次，面壁同步开放了数据治理相关成果，包括开源高质量预训练数据集 UltraData（含最新版本 Ultra‑FineWeb‑L3）。
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGib8qNQrBicat83aurOGL45aMruPF1wlbTfwqkwRtw4UDd6Yia0D4x4O2dUKr1icw7sMGdj2c6T0v4xHHNiaMDo1OwjNymWoPTPBsQ/640?wx_fmt=png&from=appmsg)

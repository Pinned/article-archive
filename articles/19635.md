---
id: 19635
title: "上海AI Lab新研究：SFT能泛化，只要满足这三个条件"
url: "https://mp.weixin.qq.com/s/xX1lkvmyLyEvLWTwCjSDgg"
...
see_count: 29
comment_count: 0
stats_updated_at: "2026-07-08T10:03:45.116Z"
is_unavailable: 0
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGFdVxRMmBxwuEEMCm6DQltVkZVPyKGTKnL40BiaBZUrYiadhwKL0iabprCSXde2lp3qUa876IHMhwHxEaduB7RnI3x0EXfZMSPjYw/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGEXd3ic9GQGIvu3x5iakXibDWvBVCrrpA9cwdDe95F8GhULEt9MXkCicoV3UHJBicBj3BaoLh4nMa6Tw48GgiccKUrvgjmibr8ib3UtpJc/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGFYA4pwic2uH5c5NV139Yd9zpeTEdKbPkMaJHxOvAicJ3X030ric8M5ZjicIl0fFhdySoUWhicKhNGFKNMoE0e2G5RNDeBXwEEM7ic1s/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGH6Ouw84x01v2YJc3aG297AxNAVUHPiahys2RtxxXticP9ibTJpz9QWJH5T9J14kibRU7VadAKiaeBicpicT69d864gMWEz9eah52tmKM/640?wx_fmt=png&from=appmsg)

此外，研究还表明，在同等训练步数预算下，对少量长思维链数据进行**多轮次重复曝光（repeated exposure）**比单轮次遍历海量数据效果更好（如下面的表格所示）。

这侧面印证了长思维链数据的拟合难度：在此类训练中，欠拟合（under-fitting）可能是比过拟合（over-fitting）更需关注的风险。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGGr9xCrbXL2mtiaFnLFCEXIYuqU6BbxEk76pjjzLAwWk1wZ7ic1IjpX9BOn1NLb6SaXn6wnPphYCHcs5vvIfEZCdrvIbE9mU0nVE/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGGL7w7aBMRJiaPkPxbFJS9eVJ8yibJ3SuiaDVjZmld8MaB7VDuJm9XRMtV7TvI0fJv0U9KLkc2MK8tNXuQiamNJ2WeejD6xzAQCRYk/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGEp4BHzUHPwv99L0gzibIzHtV0dLhDO8kzZtk0QZnE0M1o9v0fic1zBuySvricIN1mlaZfov8UicfFgcXsg3I6VgPK29FnIUJF9NAc/640?wx_fmt=png&from=appmsg)

通过分析模型生成的Token对数概率（Log-probability）分布，研究揭示了两者学习机制的差异。

面对复杂问题时，1.7B模型倾向于陷入重复的验证循环（如不断输出“Let me check…”），其实质停留在对长思维链格式的表面模仿。

相比之下，词云图分析显示，14B模型在SFT过程中，比1.7B模型有概率优势的Token集中在**推理转折词**（如therefore, alternatively, wait, however, check）。

这表明较高能力的模型通过SFT真正内化了高层逻辑控制流，学会了何时回溯、何时切换策略以及何时进行自我验证。

![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGEsCDEiagEZo0fZ2sKCneKOeEvUQwicGJEYT4oicWnoZkUdcRjg9sb8tVQb5UOn7187u2aUERqfOH4gyTU8ibXkmfh6NOhbeXL43kU/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGGzNzRzUjqBHY6hnUFcnrrLxpDKzVHRnWiaAl4jkyJCn6YeTFCeQUkKOfzN0u3gYR4GD1ztMukrUmBu9D3hVOGmibsAIV1KTYgbs/640?wx_fmt=png&from=appmsg)
...
泛化并非SFT目标的固定属性，而是**优化充分度、数据质量与结构、以及基模型能力共同作用的产物。**
...
_作者：QihanRen, PengWang, RuikunCai, ShuaiShao, DadiGuo, YuejinXie, YafuLi, QuanshiZhang, XiaHu, JingShao, DongruiLiu._

_机构：上海人工智能实验室、上海交通大学、中国科学技术大学_

_arxiv链接：https://arxiv.org/abs/2604.06628_

_github链接：https://github.com/Nebularaid2000/rethink\_sft\_generalization_

_huggingface链接：https://huggingface.co/collections/jasonrqh/rethink-sft-generalization_

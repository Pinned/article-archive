...
url: "https://mp.weixin.qq.com/s/MZvT2wWKZkQjaoK_vgkg5A"
...
see_count: 2
comment_count: 0
stats_updated_at: "2026-07-16T06:44:50.804Z"
is_unavailable: 0
snapshot_reason: "success"
topics: "[\"语义冗余\",\"过度思考\",\"推理优化\"]"
entities: "[\"LRM\"]"
---
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGbWWuXrhBdL0ksgJHicQIJe9DC8MroZugOp7KQOI9xlZic73nx5UvgzhzbhHe65Riczfq8FhGzJbuamBO6BIpBibet0ibeibasQZicms/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqFkHxEs2fGicjtxzXlQb9o3y250pQLs9xbmRQyMAGOWpXQAIiaRT2CShdyAicSp7bXZSSlTGF746xGKRfQSK8YX0oubRaOlBgqqjQ/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqECI5JPnmoMbjExNraV7MSEnTcl6GHADb9nKTCDyC4TeZ7QvNibjaem9UFrs7QJbnjYKU4PtA2EnyyKXb7ZUt1D8RaenVOF78QE/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqF7BBCs6iasMvH4icyX7eicW3ItLbJRVfY1YemGhttgml1Gs4EcsB3UdVZe2gcCPBzM2yMRvZ7ia1TVmI7Ko3ty2k9ibhMClMNGXK4E/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqHt5BW6ICO3RjsarYqKSsVoOcnftUEOwj35W4szCUKq7lz396X5vomoS4MjYmyKkPDn6cFR9xPqKBK6m6xPnN54fUhVomsWjH8/640?wx_fmt=png&from=appmsg)

论文 Table 1：三个代表性模型 × 五个基准的准确率（Acc）—token 缩减率（TR）对比（完整五模型结果见附录 Table 14）。

  

![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGL3D0aete4XI5icxSic0ETNseL1YViaB4OlXey4X5savpkeZWbEDeO6zrl0ttHYqCKOzvz2StZSmcfepj4TkibSSTB4R4PmdrzSsU/640?wx_fmt=png&from=appmsg)

论文 Figure 3：token 缩减能否转化为真实提速 ——PUMA 的冗余探测器仅占 0.4–1.1% 耗时，答案复核开销也很小。

  

![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGNtQ96MXdJGuAYttqwYYnD8ppvhia56oo45wLfAYias8vfzhBJfOl4bxP0K467lUYrzbaBt1VfTLPDetEdE5S3uvjX1YYMfyRYQ/640?wx_fmt=png&from=appmsg)
...
这个信号还能零样本迁移到文本数学之外：代码生成（LiveCodeBench，仅调整冗余阈值 τ\_sim=0.50）减少 18–19% token、pass@1 变化不超过 1.5 个点；多模态推理（MathVista / MathVision）不重训、不调参，token 减少 23.8–33.6%。
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqHhGvTfWicT7wia6rYwJJDRXoGcOBFBOxBFMKhOG9ZLEkuD4n4hN7t5eukib9DErgPsknpBHMM5uK5y08HS0dmXGWfuHULtSrP8hs/640?wx_fmt=png&from=appmsg)

论文 Table 3：迁移到代码（LiveCodeBench）与多模态（MathVista / MathVision）推理的结果。

  

![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqF2K0x0wJOsDGSlohfVwAWd6XEC9yJOlCT941Xaw36mRjQfwqMrlCeRxDAv6bZjUpJPyrJbvRWPDR7qW0vngKbpy02WDOl8Zq0/640?wx_fmt=png&from=appmsg)

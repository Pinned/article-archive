...
url: "https://mp.weixin.qq.com/s/PEisnE_CzFbexPZMSgmgJA"
publish_time: "2026-03-18 04:08:54"
account_name: "宝玉AI"
read_count: 9987
like_count: 285
share_count: 1555
see_count: 118
comment_count: 7
stats_updated_at: "2026-07-16T06:19:58.378Z"
is_unavailable: 0
snapshot_reason: "success"
topics: "[\"代码助手\",\"Skills\",\"工程实践\"]"
...
如果你还不了解 Skills，建议先看看我们的文档\[1\]或最新的 Skilljar 上关于 Agent Skills 的课程\[2\]，本文假设你已经对 Skills 有了基本的了解。

我们经常听到一个误解，认为 Skills“只不过是 markdown 文件”。但 Skills 最有意思的地方恰恰在于它们不只是文本文件——它们是文件夹，可以包含脚本、资源文件、数据等等，智能体可以发现、探索和使用这些内容。

在 Claude Code 中，Skills 还拥有丰富的配置选项\[3\]，包括注册动态钩子（hooks）。
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/ZlwY8rlDcFOshwnmtYoxsZFhcLXyGwt0o7SrgnHRCOh4ibG7qzahIrsqU1sz4qwhs0bCCxzfsCJq62xTcOCP4QXsbbFR1vYUgWkj0RGssc2c/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/ZlwY8rlDcFOiaNS3F3EW1G3D5kHsqmcnuia9sRibcJgELMZJe3uibibMrS2rB1woOfNOCfdfsMMRz64r8uhzia3Gib8NT7jDCT1vEIpsUZadBWdTC0/640?wx_fmt=jpeg)

确定了要做什么 Skill 之后，怎么写呢？以下是我们总结的一些最佳实践和技巧。

我们最近还发布了 Skill Creator\[4\]，让在 Claude Code 中创建 Skills 变得更加简单。
...
frontend design 这个 Skill\[5\] 就是一个很好的例子——它是 Anthropic 的一位工程师通过与用户反复迭代、改进 Claude 的设计品味而构建的，专门避免那些典型的套路，比如 Inter 字体和紫色渐变。

建一个踩坑点章节
--------

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/ZlwY8rlDcFOPevQ5aWWGzoY4iajqo2vE93NgzAGmFeXol8gic4WiaE4fDibruWnYOxORsq0aUBSOjLvNrj3vhcyfVnpmlaM2LOCZ4fLDSvyPHFE/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/ZlwY8rlDcFNF8W0Xyfic5ib7gDgZtIticCGq5jIacm9Upe7iafQL1CbqJobYGMOtKTEIJDEC8muoiahE3bATUO0hlTve5aTNvUagfLhbg40Phjqg/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/ZlwY8rlDcFP3zevFCMMybr82slwEwFzjGs0y4Zica3zl6WNTFG2dEbMswcTzZPEHBx15IM205t7C1SWOZAD0nFGUUJxRRIlIOsibicCfKKVxfc/640?wx_fmt=jpeg)

考虑好初始设置
-------

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/ZlwY8rlDcFPQnia01qhUzQIwurEiazPQibOrlibd5c1KCalVJCiaaONf7sqw6ibwxmicjpVjOPPb0ZekGQ3x1WwoHI8jCLsylZR3rHhlnICic1nTTf4/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/ZlwY8rlDcFPo5SJPwDZiawiawpXowalBnRFamBG9WfHcGjXSWpAovZXmLJ3bm4goJOia5iaD7YSYOnOApKXxw43FmtSo1f0hXFOropltXRkibO84/640?wx_fmt=jpeg)

记忆与数据存储
-------

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/ZlwY8rlDcFMGibVoCwV06yLsOLbMYuVRKML9CRicFR8ia9CjhFdZTkgV7eAae2BeghZJRJS6R6xuqhCVoTLWDK4XSJkKJMAeZpDYzCLAvIsaF0/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/ZlwY8rlDcFMwTPtytiaHLyZUDwyRqRb2xm41aQ8u5qlkVzyumkoLT1Qicvur8DDg1RS44qtIhj2TC5DdVXrpnIldlyBCBO0WQKicRAmyN0BzO8/640?wx_fmt=jpeg)

Claude 就可以即时生成脚本来组合这些功能，完成更高级的分析——比如回答“周二发生了什么？”这样的问题。

![](https://mmbiz.qpic.cn/mmbiz_jpg/ZlwY8rlDcFOshwnmtYoxsZFhcLXyGwt0o7SrgnHRCOh4ibG7qzahIrsqU1sz4qwhs0bCCxzfsCJq62xTcOCP4QXsbbFR1vYUgWkj0RGssc2c/640?wx_fmt=jpeg)0
...
*   • 做成插件，搭建一个 Claude Code 插件市场（Plugin Marketplace），让用户可以上传和安装插件（详见文档\[6\]）
...
为了了解一个 Skill 的表现，我们使用了一个 PreToolUse 钩子来在公司内部记录 Skill 的使用情况（示例代码在这里\[7\]）。这样我们就能发现哪些 Skills 很受欢迎，或者哪些触发频率低于预期。
...
`[1]` 我们的文档: _https://code.claude.com/docs/en/skills_  
`[2]` Skilljar 上关于 Agent Skills 的课程: _https://anthropic.skilljar.com/introduction-to-agent-skills_  
`[3]` 丰富的配置选项: _https://code.claude.com/docs/en/skills#frontmatter-reference_  
`[4]` Skill Creator: _https://claude.com/blog/improving-skill-creator-test-measure-and-refine-agent-skills_  
`[5]` frontend design 这个 Skill: _https://github.com/anthropics/skills/blob/main/skills/frontend-design/SKILL.md_  
`[6]` 文档: _https://code.claude.com/docs/en/plugin-marketplaces_  
`[7]` 示例代码在这里: _https://gist.github.com/ThariqS/24defad423d701746e23dc19aace4de5_

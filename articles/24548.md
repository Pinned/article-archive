...
url: "https://mp.weixin.qq.com/s/O0bWHbMPltHueQNTT_c0mQ"
publish_time: "2026-05-26 12:27:29"
account_name: "赛博禅心"
read_count: 11234
like_count: 101
share_count: 295
see_count: 31
comment_count: 24
stats_updated_at: "2026-07-09T03:42:00.115Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"Agent\",\"任务验证\",\"完成检测\"]"
entities: "[]"
---
...
还得说一下，在这个 Bench 里「操作对不对」这件事儿是通过「查数据库」来检测的，背后有一个验证器：每个任务都有一个 verify.py 文件，在跑任务的时候会自己调 SQL 查数据库、调 API 拉状态。每当任务有结果了，verifier 就会直接去查数据库里的字段对不对，避免出现下面这种情况![](https://res.wx.qq.com/t/wx_fed/we-emoji/res/assets/newemoji/Yellowdog.png)![](https://res.wx.qq.com/t/wx_fed/we-emoji/res/assets/newemoji/Yellowdog.png)![](https://res.wx.qq.com/t/wx_fed/we-emoji/res/assets/newemoji/Yellowdog.png)

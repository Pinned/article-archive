...
url: "https://mp.weixin.qq.com/s/NE1NEsj8_2BBMOjd7A6aKw"
publish_time: "2025-11-09 15:50:28"
...
see_count: 6
comment_count: 0
stats_updated_at: "2026-07-04T05:00:50.528Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"稀疏注意\",\"注意机制\",\"开源\"]"
entities: "[\"Monte Carlo Attention\"]"
---
...
_![](https://mmbiz.qpic.cn/mmbiz_png/VeJKXItpwPU0kNDTVcr5ovk58NWAUxtIEibA1tIoibv5r8vKGNDk09icFoq0ibefu1y1Um8VMAJbD5yLoVjlhqYSZA/640?wx_fmt=png&from=appmsg)_
...
![](https://mmbiz.qpic.cn/mmbiz_png/VeJKXItpwPU0kNDTVcr5ovk58NWAUxtIKVicFUWDtvKPibxJ2Uk08GmteOQfrvEqY9G1fK1go349VEUoL7yLhoKQ/640?wx_fmt=png&from=appmsg)

_图：嵌入向量在块之间被重组。每个块向其他块发送代表，并从其他块接收代表，通过注意力计算进行信息交换。_
...
![](https://mmbiz.qpic.cn/mmbiz_png/VeJKXItpwPU0kNDTVcr5ovk58NWAUxtIwIhPryPr0JculMwOa1ETwbCXNicGbhNcTCBsKjnxbheibZHLOxapkPuQ/640?wx_fmt=png&from=appmsg)
...
**![](https://mmbiz.qpic.cn/mmbiz_png/VeJKXItpwPU0kNDTVcr5ovk58NWAUxtIKtuZl6QfZrCbw9YEviawciachLsGib67eibHZmcuTQmSz4CRlOZzy4wF4g/640?wx_fmt=png&from=appmsg)**
...
`![](https://mmbiz.qpic.cn/mmbiz_png/VeJKXItpwPU0kNDTVcr5ovk58NWAUxtIU2Meseibeib8HSdM2UAdcqibXcY0M0bibP0jxP35x7u7y2DjSJKmZXRpGg/640?wx_fmt=png&from=appmsg)`
...
其次，稀疏注意力遇到计算瓶颈，需要在选定的 token 之间进行  复杂度的计算，而 Monte Carlo Attention 通过局部 2P 注意力实现了高效的全局交换，具有更优的 上下文长度 复杂度。第三，由于选择约束，稀疏注意力的上下文建模能力有限，而 Monte Carlo Attention 能够实现指数级的上下文长度扩展。

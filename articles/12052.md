---
id: 12052
title: "ACL 2026｜清华新作ControlAudio：声音何时响、说啥话？都能按剧本可控生成！"
url: "https://mp.weixin.qq.com/s/n8sjvwE5TOAVIa8d9A1-sQ"
...
see_count: 20
comment_count: 0
stats_updated_at: "2026-07-09T03:04:21.945Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"音频生成\",\"可控生成\"]"
entities: "[\"ACL 2026\",\"清华\",\"ControlAudio\"]"
---
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqG4j7SwLNiadQbafgFXfhk2Jkp7XliaBrC1LyhuicbzkiarwjWK3CosH9KsEqiaWTgJ48zMNAaymknj1bhe6UDJSuZgOK6yYcpSmGw0/640?wx_fmt=png&from=appmsg)
...
*   精确的时间控制：如「鸟儿在 2 至 5 秒间鸣叫」；
    
*   可理解语音生成：如「鸟儿在鸣叫，同时一名男子在说：『今天天气真好』」。
...
1.  数据构造与表征：通过人工标注与仿真生成相结合的方式构建多层级数据，并设计结构化提示词（Structured Prompt），使预训练文本编码器能够统一编码文本、时间与音素信息；
    
2.  模型训练：采用渐进式训练策略。首先在大规模文本 - 音频数据上预训练扩散模型，随后逐步引入时间与语音内容信息进行建模，使模型逐步具备更细粒度的控制能力；
    
3.  引导采样：针对扩散模型「由粗到细」的生成特性，设计渐进式引导采样策略，在推理过程中先生成整体时间结构，再逐步细化语音内容。
    
      
    

![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqEXrNanPkrzAmsXrbT1fpibkSn8y3iaIVibqhSbia5WTNnkxA50fI8GialibXfqLSNBicruoOH6Hq6tlb93NZW8yZ0p0iaibMgmEYIt5gHI/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqHpPv7jfpe9iczErMh9kibPka57G3pCuk1KbxvqUkkicianbqiaxrAxRBO7AiajJUoiajfKLTVTgAicBicCjyXick0akrpHwT1OmvFSPfI3Y/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGasiaHYSYgywaFCvqVdtyXiaVR352AavVice2p9SRr9RCKORcDb6L7kmzNO92K6HgvIoKWgx2IUtwCmsia3j58FVm0McuEE6EO0K0/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqEKvlNPhYp5zafJYFZhopxxvQcCNyceUK2DzByldfgLZPsIiaDmhAjsyTHutwMicCQ4j7trfcqfKIECbezzd1Libg2knVgwicEZS7c/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqH6C0P8kxQWQtgIkcq1Gzic0CNPic2B9qPUck4lPdOkm3EYNy3hPGSAwFlABeweweRZBHZ6816js5GBpI4blEx1SDWkEzfYtOwdE/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGkibvIPkymUiaV0vWEHy97OribZYsRN901tGqRRLwdlPxQicyGOBsqJQKENZlo4PiaiaUhicgWN1IZQRddcH3A4XiaJTEibR0Cxr288NoQ/640?wx_fmt=png&from=appmsg)

---
id: 12099
title: "当AI迈入Harness时代：以MiniMax为样本看智能体云端新基建"
url: "https://mp.weixin.qq.com/s/8iMI1UJB9FM5soVWU_be3Q"
...
see_count: 90
comment_count: 4
stats_updated_at: "2026-07-09T03:05:18.340Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"智能体\",\"云端基建\",\"Harness时代\"]"
entities: "[\"MiniMax\"]"
---
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqHoFKlJTMmcSQQkcb7nriab5OzWOWsJ86yNiaiaBibGbxBJoAMSZOZDr81zpupd8UKrgAo0TVYlAHRJQIq0pXVKWxOUX7ScZnqJ350/640?wx_fmt=png&from=appmsg)

  

![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqHmHYDKIaVbVrnYibX0h7x0ZTktwFXuLeZ2hq0LXh1ZM8fnnKWzvsQuZicajndL2Lmv4MOaSiaI6ebYKJocicTY9qVdA9wmTUccERc/640?wx_fmt=png&from=appmsg)
...
近期，[阿里云与 MiniMax 披露了一些底层技术合作](https://mp.weixin.qq.com/s?__biz=MzA4NjI4MzM4MQ==&mid=2660260045&idx=1&sn=90f20a17bbd6890b44c057e89a26f6b2&scene=21#wechat_redirect)，为我们解开了这道超级智能体背后的基础设施谜题。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/5L8bhP5dIqEjJ7NKJMICHNXndaS4PR3OKmKibwgRJ5ORibaEMQIY6Mu4jkpkcGYibPkeYLLI7VRl4svmCW1iaMoeAKAvZQ1iaPgttcQ5UATue9bY/640?wx_fmt=jpeg&from=appmsg)
...
在 MaxClaw 与 MaxHermes 的整体架构中，他们抛弃了控制与执行高度耦合的单体设计，转而采用控制平面与执行平面分离的模式。在这套架构中，阿里云容器服务 Kubernetes 版 ACK 承载了统一的控制面，负责海量消息分发、任务编排、策略下发以及统一的运行观测。而最繁重且充满未知风险的工具执行工作，则全权交由 ACS Agent Sandbox 进行动态调度与承载。

  

![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqEiaCOZ4PPFKlaF2G0rjV5suvZSSFC9ZnlNsclbIliahm4ZoeKCb0XJ6m75DiciaKppnFcXkA9ktWjvDEK3hTRiauKZ7ic6b7TWA9gUo/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/5L8bhP5dIqHRjnicFIbGuhvUKxAd8WXBUE4l9qxcJ35wX36JV89sHTURQCIGt30RE5ABktLxIQ1RjibpFBtsiceFMMP6pJNfK6kiaoTFXdeC4j8/640?wx_fmt=jpeg&from=appmsg)
...
1.  基于沙箱内置 ESSD 云盘的高 IOPS 特性，系统将其作为私有工作空间，承载配置类信息、API 密钥以及短期记忆等核心数据。
    
2.  对于需要跨实例协同的 Skills 资产与工作流定义，系统通过 CSI 动态挂载 NAS 共享空间来实现统一分发。
    
3.  结构化的业务结果数据与高频缓存状态则依托 PolarDB 与 Tair 进行存储与读取加速。

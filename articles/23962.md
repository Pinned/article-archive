...
see_count: 90
comment_count: 12
stats_updated_at: "2026-07-09T02:28:01.200Z"
is_unavailable: 0
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/Rvq8Ow69CYWicViaHAppP2Mj3l63OGCrYBzEBwC0lAjynicItaY7Vic9qdE52KeWOGqrIDupgH2ZjB3OeND9j5UkVYRVeYnm4WKKFdt5ibuQq7Tk/640?wx_fmt=jpeg&from=appmsg)
...
##### **【新智元导读】没有信息泄漏的专业术数题库面前，Claude、GPT等主流模型集体「翻车」。但一个叫Tianfu Agent的系统，却一举将准确率提升至50%，逼近本届术数大赛人类Top20选手的53.5%平均水平。**

把当前最先进的通用大模型，放在中国传统术数专业选择题（四选一）面前，会发生什么？

![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYX57UtGIoXH4DBia0W10p3n3ptYk4NiblsNEkmLqAFzXBV76XIohyhQkvMkXdh2rAyaFuJwOEFBic8hFOXCn7vWTicu7S1zOdsibJqY/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYW6xj8GhoqYxFz1cFSIcl612fRgQzEIyrFrpNtTqwj9lWTd8SrtvRB1eCXoTovrETWfLmoIgb3VYenKyeTLibo73CGNbdnMSUDU/640?wx_fmt=png&from=appmsg)
...
200多个原子工具、3大流派规则函数库、多Sub-Agent协作，以及一套贯穿全链路的置信度量化机制，一举达到了**50%的截尾准确率**，逼近本届赛事人类Top 20选手的平均水平53.5%。

![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYVBEpPcvspxnzibg0DERNRna9MQrBmDbZxRqaveU8lyv039zXqQGovnwer8JYg4YUiaQS5XbMM4sZiamX5tzyWkvj7sLb0r8u13Ys/640?wx_fmt=png&from=appmsg)
...
Tianfu Agent把同样的逻辑搬进了中国传统术数领域，在推理链路上，采用**多Sub-Agent协作的渐进式发现策略**：多个Sub-Agent各自维护独立的工具集和上下文，并根据环境反馈逐步展开推理。
...
通用Agent用十几个工具就够了，200+工具带来的第一个工程问题不是「能不能写出来」，而是**模型选不对**。
...
Tianfu Agent的方案是引入**不确定性量化**，在三个层面给出置信度评估：
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYWWV7o3yibRiaZ98GqHC5Kfib3amB4icZ2cIibUWEibxPrywb8Nsr6XQjGZ3XX385lMoHLdibkibickra3EqugYltxGdvtweFsvqhoq8zT4/640?wx_fmt=png&from=appmsg)

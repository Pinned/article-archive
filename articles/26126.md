...
url: "https://mp.weixin.qq.com/s/PpAh5nZugKIe6rh1_MQSJQ"
publish_time: "2026-06-30 12:00:12"
account_name: "机器之心"
read_count: 3652
like_count: 59
share_count: 224
see_count: 28
comment_count: 0
stats_updated_at: "2026-07-09T02:52:53.394Z"
is_unavailable: 0
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGfiaF7UMnXoe3TDf2QW1N17O1JDe14xt0MVosRmibLRP1Iy6KAm5XMBF2lhdnPKqvoKZ3n1zZh4fZhnUc6sL9ksWq3cqxbDbk28/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/5L8bhP5dIqGDcvco6b0CIyElmSqYYIxmuqYCC32ib6nP30iawiaPE2VGFkbIbBR7NNfKBNib8GTrm1UxGMCg7lZBUc5FrFUlrIU8EBIOwhCs4P8/640?wx_fmt=jpeg&from=appmsg)
...
OASR 在此之上，只加了一项重叠惩罚：每发现一个 sheaf，就把已经被保留的那些边「记下来」，并在后续的发现过程中惩罚它们再次被保留：在原有的任务性能 + 连接稀疏 + 功能完备目标之外，额外加上一项重叠损失![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqEnP8O29UpiaB1JMnHibUrTHpFjpcnWKq6JJAJBLsDrI87V1geoibsEFK34vgEuaNicIS8zAmptAUOjhAUiaMibaZYhFNo7GbSuibtUVY/640?wx_fmt=png&from=appmsg)，对「已被先前 sheaf 选中的边的并集 R」的激活施加惩罚。这一项会在历次 sheaf 发现之间制造一种排斥力，逼着优化器去寻找那些有同样任务能力、稀疏、完备，却与之前结构尽可能不同的替代方案。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGibhvPh8OqOjvXEoRYPY2tdON8bSicft0qvV8ZeG4MtfSWtYkun3WqWzM4rulNC9yELfC3b58jlhnrJiaxg4775cicjVV9vbAL2icg/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/5L8bhP5dIqGudmhfUGkbUViadxdvgPy5GHiajuxwdFBvbd9bVRf5VNwo1Dtzfyj40XeF8USlZslaibCTgSib92EeYQuRyVEZY5PQs75a2k0VrkE/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/5L8bhP5dIqGP2y5Jo8RGD2YT21Xib0lHzIK3kiazhtLJ9ndiaaGsOgariaYDEiaico4Ye0YDlOcmEwQibTh7gMwrBngQGYKCBfxhXvD3ZOZV4dtnoQ/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/5L8bhP5dIqFYDRd8QmO6icF99rIak66hpXicxuOtmfcgO4M39pWlNNpdtLJMw9etec6IEGkZXNP8jHykZw3MwuLIWaab7y978OBicJZHL6FIII/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGGjP8p1KRogrmJX0CTyiad64GwwmGLH0OWVxXMN97nOpVAj3dpsAgsTnbbyaBiboHPRmPDtnMicia3sr4ic9cglBqtW2baYtD8vRKE/640?wx_fmt=png&from=appmsg)
...
1.  线性化：在温和的局部线性假设下，任务相关的读取（readout）可以分解成各条边贡献之和，即每条边有自己的一个「签名」向量 s\_e。
    
2.  求和：一个电路的读取效果，近似等于它所含边的签名之和，外加一个可控的余项；
    
3.  碰撞：s 条边的电路有 C (|E|, s) 种组合可能性，数量随模型深度与宽度组合爆炸式增长；而![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqFLzCIEE7ZhEgwebkDbUf8RIFWB6rOc3aRb3FoQum4zfJdA6lHXO6PE6UMLRuGyrYw1IpQROXIPxlMIf4fpFKu2vNoJ9urRosE/640?wx_fmt=png&from=appmsg)量化后的读取空间只有有限个「桶」。当电路数量远超桶数，鸽笼原理保证必然存在两个不同的边子集，落进同一个桶，即读取效果几乎一致；
    
4.  拉开距离：再用一个填充（packing）论证，可以从碰撞对中挑出一对边集重叠极低（而非近乎重复）的电路；
...
把这五步串起来，就得到了存在性结论：对同一个任务，存在多条![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqFibRkic2gAGV8Vk9vjqMl0VU8fRcqZYene2AGcY2OaRMHdiaCVnp30LmnIcT8sKpAwTMjW6TpjH6LwRvclgzKl5W6UlJyT7gFelg/640?wx_fmt=png&from=appmsg)、却同时![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqFxiaA8mL3ohYjniaLTKXhtwFvXnRv4OgPRQCOPpW8zDEBhniboBAkFA4UMPLFsfrAvz29wAaQn4BKBEhShEnClvOB5MyGTrv4HAY/640?wx_fmt=png&from=appmsg)任务性能容错的低重叠电路。 非唯一性，是稠密、高维、叠加式计算的自然产物。

...
url: "https://mp.weixin.qq.com/s/BCdzR3d0_q06GWWoFWjxVw"
...
see_count: 37
comment_count: 2
stats_updated_at: "2026-07-09T02:53:23.523Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"生成模型\",\"物理计算\",\"能效优化\"]"
entities: "[\"Un-0\"]"
---
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqHzraMViaFaGDChOtk07cVuSVs6nYxoQ3P11uiaETvdxRHoHDndiafdyj3534yxicowpmwibEUtR0RC4LXj3QIztD9AzZPtJTKdDWZc/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqETA46uv5NAOLWv0VfZLxowGTX1dNs8PLJbejmcGg1oT4PI8jtqdIzE5z9EfibDB5uj6ejtINU2Z4br8QfpgfbbVVGZDnHXMbq8/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGbIwgXqfaaiaZBTkTbAuXUVvI2psJc1rFOnqvicQozPZAHKibMtH7ew79iacCt62DZyvupeYhhWX9EcAySicJVkoBoxWCYpRUAo7RM/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/5L8bhP5dIqEkNGPl47107WbblJhPqFVS2cicPly6icELvGcfFyCKjVKlhNTHCVX6ib7chKyocsRPHWdWSN6CicPCT5Oewk3621FsFianBxCib8vPw/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqEGG1ic7d9UIVdd07Zla4ibdgnMe24G54QGPia55BTrAUAPO9f5YxeaOCwof9Vkjm8J6PJia7VgdHgjObRRuiax1VOIYfjk49uCvveQ/640?wx_fmt=png&from=appmsg)

  

每个振子 i 都带有一个相位![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqFr6t2xvJZn2nA9RpDEfWG9zbTT8Iyzefnr6NicBjcTlDAI6AdaTZelEYhrXSpgsPGfjeKaic5NdYko94q6VwgLeCH3Uia7OG49ek/640?wx_fmt=png&from=appmsg)∈\[0,2π)，其中![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGw6nJ8JQrAykCVLLUd4LZffAjp6O7mY9IWla8J09E75cibEa0Kp9yQBYr3RnsZnqJtXyOTWCDFDibywC1MPgVjwTdocjnbBY2xc/640?wx_fmt=png&from=appmsg)表示它的自然频率。矩阵![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqEdPic1DlUsnuYpUSXbRn0UtOSR0jhRaTgHL9e7L4MxeF0r45aE4sKgxvFR4bYZt3WFCyhyFRN3aMp332zyAibXr15wyw66rNYgs/640?wx_fmt=png&from=appmsg)则指定了耦合强度，用来决定振子 j 会以多大力度将振子 i 拉向同步状态，或推离同步状态。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGv1hKv0d61LATsgqcHOKoiakf725He0WZ2lAtJemvH9xFW36rA6kFDtwoGgRqksQFibZQnkt9TTUTibvMBMJVZtIA9ePib50ofdrI/640?wx_fmt=png&from=appmsg)

耦合振子在训练得到的耦合关系作用下随时间演化。其中，条件振子到主振子池之间存在一个单向的低秩类别条件矩阵，用于注入类别信息。在时间点 T，系统通过一个解码器读取振子状态，并生成图像。通过多次采样不同的初始条件，就可以生成对应的图像分布。

  

训练过程中，模型主要学习三类参数：振子之间如何耦合，也就是矩阵 K；每个振子的自然频率![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGw6nJ8JQrAykCVLLUd4LZffAjp6O7mY9IWla8J09E75cibEa0Kp9yQBYr3RnsZnqJtXyOTWCDFDibywC1MPgVjwTdocjnbBY2xc/640?wx_fmt=png&from=appmsg)；以及解码器的权重。整体上，振子系统承担了原本可能由传统神经网络层完成的计算。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqFVAL9oZoq9h8iaCoo0Te46qTH1SBUVevEjaeOaugW7ibVFfOuNQTuOeCxYkcJgLV2wh6Nbq6WF49BvCZaeFGFrSe4dXKgs32ClQ/640?wx_fmt=png&from=appmsg)

在 CIFAR-10 上的训练结果

  

![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqHfgiapDQ531XYcpeib8BJ1ubJMHu3x1mGH8EovNlmBPKFWrccdRxgjDiaHroAluaiaTehL2Z8ZGRGtgqJTCbQKmJDlA50jjiaNB9M0/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqG2lRDtRpWvg5KoNC4THGLIvZQxJ3poUEfdkTDW6icMROlrYZSibJHUZ3oiciaJCYtlCpqvq5ibcicwiclyjHPKnRElaTHcSSuR4kVQMM/640?wx_fmt=png&from=appmsg)

CIFAR-10 数据集中的参数数量与 FID 值的对应关系

  

![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqENyxeTPibqwTE8Qia4iaC6icicAeZjSW3FkzqE6JX4q43hzCnzro4eXic3zLb5zL5ibgtcuGS9cZseBL0FiajdDV8ZyicicXAwm5OMWklFY/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGgneB9Cn1ibiayiaHRVrV0csGuUqsrnAmnBCz9iaC33qpgIfvF5vk4CXguIr5BCicPsT26D72K2X4jib018f53w4IbKzadqGzyHn87c/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqEbG0l3tLjs8fHTEs9TYoZ3S5Nv82BzAcmMuIKWzjibpFdEpVAaATfKicN0QRmmG0nJgTb4wPnoHAm6r6jtA2jJn13DPbnB7AKibM/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqFGSib0bYjianbz9n8pBxJsZx8mibmic1ia8iaPydENmPz2st8MXRo2H1GjZ1ia881k1jUajDewGia3oJ348lyra7hic8Brhvpa4SicXjjPE/640?wx_fmt=png&from=appmsg)

...
see_count: 53
comment_count: 0
stats_updated_at: "2026-07-09T03:02:29.796Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"手语翻译\",\"开源模型\",\"无障碍\"]"
entities: "[\"港理工\",\"ACL 2026\"]"
---
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/5L8bhP5dIqEAeib9D8ibbia63iajrMSticAibe16SrMuxFU68RIYmjYFp1Nh8X3n0l4VAeDruWetG6tFs9k0Ef6En9511embmH5esBxo1U7vGF5ic4/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGDLuOSGrDAicTXP4wposqGG6f9KxBLagHl7ceQecibfFoZCRro9cuGWxuVqVuhh0NRev0INk9Oq27vDrGwwQGY5BGMGRnecichhc/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqEZ3PGtGm0NJjwV19K7RHt1W6uI0ib7gxUmvzIHk8RcX8lia7QcP5AjBbvJIVUK0chMpGr50T2MU0EgkT56AI2lYEJM2tFprcgTI/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGXllzpZeSpgJ7enWFoadBaicbBNJALJI6VjFjqGkulWstG92Gxx93pUUQFKqcPc4xBQhle74yiaLcc92bfXfsZ82vSXAF8j7JzA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqEIibWWUiafoK0ZgfJjWC5vic73mZibf8jIkF6DLceKCPKkhZH1X7VZ3viaYYuMZHoBZThVfR18c70dzZD7CK3AL180vSfn2rBWPYhQ/640?wx_fmt=png&from=appmsg)

  

从规模上看，LC-HKSLT 总计包含 1311 小时的手语视频、432K clips，覆盖 14 位 signer，SLT vocabulary 达到 125,833。论文还特别说明，完整数据集是在大规模真实场景中收集而来，而本文实验主要使用其中一个精心整理的 30 小时子集，以便和现有中文手语翻译 benchmark 保持更可比的评测设置。

  

![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGujvznOmmmkROtRj2Z9tCqeF9K6GTtHjmNljABedKicAMhLsctt1PL7IXUicDLppgTmQtlMp6y9Qu6nmUtL1Gtaes2cmiaZxneN0/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqEEUpk7020haEQLaJZyY5cRmOdaXmBKJT7u2q3OLkUcnxkkOz18nUrS1Cjnb5NyPGRLVClImYuI0kLluDSSOrGFnNpjDTz6F9o/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqFZX0T1usRFZJkJLe6OoicCFznw0kyONl39ibzuxw7ibqeD7DkCUjEFIZQPCEl0ibUvJN3UibBxs7EHGssq0CQ0xibMJeglKgdpUUMl4/640?wx_fmt=png&from=appmsg)
...
在自建数据集 LC-HKSLT 上，SignThought 同样取得了很强结果。论文报告，公开设置下模型达到 21.15 BLEU-4 / 47.87 ROUGE；进一步在其余 LC-HKSLT 数据上进行预训练后，再在 30 小时子集上微调，性能提升到 30.22 BLEU-4 / 60.01 ROUGE。这也说明，对于手语翻译而言，大规模、领域内一致的 sign-text 数据仍然具有非常高的价值。

  

![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqHA18c6pLAab8FBHdcjwl8H14S5LUsXRJyQxoeyYkEHFwB0MVYULMVu40icJ052rPo9oDfibOY2z8tsjpIyS2jny0HianiaQxk6c1w/640?wx_fmt=png&from=appmsg)

  

论文中的消融实验也支持了这套设计的有效性。结果表明，一旦去掉 latent thinking module，性能下降最明显；而去掉 causal thought 更新、结构化 routing、dual-stream decoder 或 thought-guided prior injection，也都会带来不同程度的退化。这说明 SignThought 的提升并不来自某个单独技巧，而是来自「中间推理链 + 路由 + grounding」这一整套机制的协同作用。

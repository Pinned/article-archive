...
url: "https://mp.weixin.qq.com/s/xydOLCs9iZfkf03Sb1_Ajw"
publish_time: "2025-12-27 06:10:37"
account_name: "宝玉AI"
read_count: 1411
like_count: 47
share_count: 129
see_count: 10
comment_count: 1
stats_updated_at: "2026-07-16T06:26:08.385Z"
is_unavailable: 0
snapshot_reason: "success"
topics: "[\"年度报告\",\"程序员\",\"职业转型\"]"
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkc45jjTT93lbMnZwxz7vfRoA65L80gw3g5ibnr9XTFwia02haovniaHdU7w/640?wx_fmt=png&from=appmsg)

  

Stack Overflow 在 7 月份发布的 2025 年度开发者调查（https://survey.stackoverflow.co/2025 ），这是他们连续第 15 年做这件事。来自 177 个国家的程序员填写了问卷，覆盖 314 种技术栈，今年还专门加了 AI Agent 和大模型相关的问题。如果说有什么能代表全球程序员的集体判断，大概就是这份报告了。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkcPdcW2I5GeWM9iaoawmdCnOWO2P5xpicF0nZO3wD4V2Rx8KkJITE5mTPg/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkcWD2JVbhHQyTQPqDemibOLXv8nuYUlfhJyZZjXwjY2W4w5KMM0jVZQlQ/640?wx_fmt=png&from=appmsg)

  

调查里还有个数据很说明问题：46% 的开发者主动表示不信任 AI 的准确性，只有 33% 表示信任。换句话说，真正“高度信任”AI 输出的人只有 3%。绝大多数人的态度是：用 AI，但是要验证。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkcYsfYbyuH686NnRvtTlLnnWCZBSzpDfleAjf9zGJSNbHIkqDUe5rVeA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkcS80fv1N0XPkQxSThzgEugo8gF4xOzUa92ANlme7ead0UXXPdErGaug/640?wx_fmt=png&from=appmsg)

  

调查显示，52% 的开发者根本不用 AI Agent，其中 38% 明确表示没有使用计划。每天用 Agent 的人只有 14%。这和铺天盖地的“Agent 元年”宣传形成了鲜明对比。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkcnQLIDymevMNB1o6urDoORCD4gHChWnhYPyRVLog0eyfXJUBeSIFbOQ/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkcibAjyYElK8Qjto4wGdaCZ62MWdCZ6ZibKTo4ESA3iaLD1gL2WdjMq690g/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkccjKZrXN4E6RrUsjXLictcUr9GpHu8u7cd6WoBTib8aNDRWleUHUjzQWw/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkc1EzLr0GOdqq8fRvLccOsz3TBTeWR44iaBAUNNegk1ib7zWpjIQaPrazw/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkckAbnO0nKRP9ZG3Ousne2TeSRJKAnfQzNlSmUfyic0dqibueSbV7JPLzQ/640?wx_fmt=png&from=appmsg)

  

Rust 生态整体势头很猛。Cargo（Rust 的构建工具）成为最受好评的云开发和基础设施工具。Rust 本身虽然使用率不算高，但“想学的人”比例一直靠前。这是一个被尊敬但门槛高的语言。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkcc55cJbgOERggXEzwHytFYrTUWAL6dxxSEBZJoda2xEkPysfp8ia2Cvg/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkc0VHvTCtTk3RicGk8ctG0nDNalYPg95zIuh4Fx7ibo4379zKZyGNs8rwQ/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkcFbSgkTNr1iaiafXibCNialRzrIcwRYibEDwib7dicQLoN9xtdSVKibKVy459EQ/640?wx_fmt=png&from=appmsg)

  

开发者最愿意让 AI 做的事：搜索答案（54% 已在用）、生成测试数据（36%）、学习新技术（33%）、写文档（31%）。这些都是“错了也没事”的任务，最多浪费点时间。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkc5lIg31xC3LaicN1w0yd0j93neth9oMpWveibI48FsmbBVfee5s8BnIWA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkcbuQZMkPlujFcPGc9ObqO8DjL7ViczyIsibmY5FPUrExUO8XjLs0Fb44w/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkczZRPuQaJAEGmz6BDRhjmZtPwXIr32DQ3MErQk1IykWaelDVgKeVwnQ/640?wx_fmt=png&from=appmsg)

  

数据存储：Redis（43%）排第一。这是个二十年历史的内存数据库，现在被拿来当 Agent 的记忆层。新兴的向量数据库 ChromaDB（20%）和 pgvector（18%）也在快速增长，但还没超过传统选手。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkcNpaVwZfOerIoUY7wPB13oaZmC0ohH6xQwYRlyiaicpVHYjBo7h6ibyplA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkcfpyPQ64rQpibnp6ES7gonpjSlficCaIvMvtIyJ7FUy1NKWD0q31e9PCA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkcVmfkTQU4qeBveGSADfHt0tPQmjhksfSMwAZp54NuibicdC9yU1Byibppg/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkcLp5CP7DQmAyn0e150cISSbAswoBwRDeGWavua7NMSibZ94nYHLyJboQ/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkcKWvQlKA5PN9IMCoFu1y9ibNO0vRc1OkrNbKJ6WeZ6gU2ic305P1szQwQ/640?wx_fmt=png&from=appmsg)

  

工作满意度方面，24.5% 的人说自己“工作中感到快乐”，比去年的 20% 有所回升。但 47% 的人选了“还行吧”（Complacent），28% 明确表示不开心。这是一个中等偏上但谈不上兴奋的状态。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkcHjzrFV8drAWm76NL383gMNJonP38GP14LMX6EqDuuLK2XclHoOaYhw/640?wx_fmt=png&from=appmsg)

  

工作模式上，32% 完全远程，20% 混合办公偏远程，18% 线下为主。疫情后的远程工作红利还在，但没有继续扩大。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkcLD53gHCPrBzqy09tdKH9zyruc0y3d1LSwOFOzuJOib6hNrqRySrcfBQ/640?wx_fmt=png&from=appmsg)

  

一个值得注意的数据：65% 的受访者编程超过 10 年。这是一个成熟行业，老兵居多。这也解释了为什么对 AI 的态度整体偏务实——见过太多技术起落，不容易被新概念忽悠。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkc0wSZPa8LjfA1GmUE2ypMXXqGM3FE8MMkbfxGcbhgQ9cqtRrChSagEQ/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Sib7IezOlBcuCicoYwhdJk07tVjGTGDMkcuffdJkMzNl0qiazOy9Ym12rEEXo4WnMXn5tNlicPeFnoggibSxVhR7ObQ/640?wx_fmt=png&from=appmsg)

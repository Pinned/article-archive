...
url: "https://mp.weixin.qq.com/s/bFXCXt8n8dUYJjVc0GDlAA"
...
see_count: 41
comment_count: 3
stats_updated_at: "2026-07-09T03:24:07.831Z"
is_unavailable: 0
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/8Eyv4o4Acuo1eClzrib4xYFO1Lciax7caLZicnttTRTSLXcBia0lLavVibZ9tHzNhOlibzKLk5LbO2H773ptCtYXlkiakBNXeib3eibLTgYRDdAMibkWM/640?from=appmsg&wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/8Eyv4o4AcupObmyjh0aLJ46tVYRvQSrFxupicQW2KBJM8mFt4McV6xia2picMKtmlDZfPZ6tHegBUI6M00FO5HMNNmNEIfRJ4eX8qevJNiaejwk/640?wx_fmt=jpeg)

这套基准源自百亿条真实运维数据，不再只关注“会不会回答问题”，而是聚焦智能体“能不能解决问题”，为运维智能体能力评估提供了一套贴近真实生产环境的参考标准。

**开源地址：**

**https://gitee.com/aishperf-caict/aishperf\_openness**
...
为了构建高质量评测集，研究团队从无问芯穹成立以来积累的**百亿条真实运维数据**中进行筛选，收集了2024年至2026年初全部用户工单、即时通信记录、运维文档以及线上集群监控告警数据，并通过多轮数据清洗剔除低质量内容。整个过程不仅包含去重和严格脱敏，还排除了与特定业务强绑定、无法泛化的问题案例，确保最终保留下来的样本既真实可信，又具备普适评测价值。

经过严格筛选后，**团队从10万条有效数据中进一步抽象整理，最终形成103个高保真评测用例。**每一个案例都对应真实发生过的生产故障，包含完整的问题现象、排查路径以及最终根因，确保评测结果能够真实反映智能体在生产环境中的实际表现。

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/8Eyv4o4AcuqvJVXZ21mibQwxOunTibm8k4C6yqKTND09XxNSrtDKt6gTbUw2VYTGg5ZJzibwfoGrI6jY3QbMnBsSQ2MnLInUiaUej53aS7UASAs/640?from=appmsg&wx_fmt=jpeg)
...
当前大多数模型Benchmark本质上仍属于“笔试”模式。模型面对一道题目，通过知识记忆和推理给出答案即可获得分数。然而运维工作并非如此。现实中的故障往往**没有明确线索**，工程师需要不断收集信息、验证假设并逐步缩小排查范围，最终找到真正原因。因此，对一个真正优秀的运维智能体而言，**考察重点不应该是知道多少知识，而是能否把问题解决掉。**
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/8Eyv4o4AcurZg5lgEIlgB4gVKia9MDKibib52IrSh54iaRfuubcUwQdibYBCbxA5bocia8ZUczyjYgYclCIcHIhrdHlaJH3XPVzChTR4pEj2DHypo/640?from=appmsg&wx_fmt=jpeg)
...
通过软件层面对GPU和RDMA等智算集群环境进行精准模拟，该系统能够构造掉卡、显存异常、NVLink故障以及网络分区等多种典型问题，同时结合真实业务负载形成高保真测试环境。相比物理故障注入方式，这种方案**既避免了设备损坏风险，又能够实现快速重复测试，大幅降低验证成本。**
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/8Eyv4o4AcuqeFib5FEsiaDBhegDyIE31MHHhgnicWRd7M1kicSL8ox5g0IrQ6Hr88tmHlQZDib7savWYZaHRica84vBGPeoSdtA7AXWIGBj25RMVA/640?from=appmsg&wx_fmt=jpeg)
...
其中最核心指标是综合得分。系统根据简单、中等和困难三种难度的问题分别统计成功率，并按照不同权重计算总成绩。这样的设计**避免了模型通过大量完成简单任务获得虚高分数，而是鼓励其真正解决复杂问题。**此外，评测还同时记录平均耗时、Token消耗以及工具调用次数，从准确率、效率和成本多个维度进行综合评价。
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/8Eyv4o4AcuqC4QBWbTUgRLq5XloAFR1E78Hib5uVTLzdkhdoVtNEN71gxS7mSIUrWe5BNzgwVWevYUH4E3Qd6aqPRggebfI0hZ36ChShteyw/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/8Eyv4o4AcuopWQEZzzBHgJK7yrs0MtBesk87sN6pfUZTjTHLzgwd97XAUibjTuNqPek2PLt4UTC90s0RuHaicicYIK1M9NGkjNVHnVyHJvB3HI/640?from=appmsg&wx_fmt=jpeg)

面对硬件问题时，模型往往消耗更多Token进行分析，却依然难以准确定位根因，反映出其技能与人类运维工程师存在差异。

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/8Eyv4o4AcupQCSX6eASeSEL6k7tvEb1r2p0P7t2lFsmo1RSuehXAccof69F0ibYkIRQp9hG2rtTE139iavCibrVlPe9kgmUTbnZNADKhLQ2YtA/640?from=appmsg&wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/8Eyv4o4AcuqZuDu2Z1Oe1CEyjNsfeWcc9aHicLohgXqVfonABykzVeaeNpvGq5TwQ8Qjia8xjYalBWfglds3EHeK3oG6IWq0PXbs7Nd6AicQe0/640?from=appmsg&wx_fmt=png)

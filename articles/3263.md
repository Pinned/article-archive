...
see_count: 51
comment_count: 5
stats_updated_at: "2026-07-04T10:49:45.064Z"
is_unavailable: 0
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/Rvq8Ow69CYUkPZ41ibFCem0qicX32MicVkweXibVZjQic9vA7TXrndovy8fXRSG2tcz6tjma4KCrpiap10RvpyV5FAZy26d3LwLM4NTu5CCqdxt0s/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYWSMhYngyIoc4xT1y2E6fqeHDpqy9B1GCibDVxjw116hgEficSMo6pJs3saGBbfBxykZEBNIFOQibTsnGaVTFhhaERSXyAuhQc5ls/640?wx_fmt=png&from=appmsg)
...
*   execute\_code：让模型在一个可持续保留状态的Jupyter环境里执行Python
...
*   如果模型发起execute\_code，就把代码送到notebook内核执行；
...
repo里默认`tool_choice="auto"`，并支持reasoning模式；在开启时会把推理effort设为高档，并允许最多100轮迭代。
...
内核是持久化的，变量、导入、图像对象和中间结果都能跨多次execute\_code保留；同时代码运行在隔离的Docker环境里，宿主与容器通过挂载目录交换文件。
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYUnF7Uag9ALneiafaUNgVgSevBeQZVPGsBVNOeWictHM8q1geVPdrwrQCV004fFmUOeSEXlzmXibLLVj2T2BmnmS4LZvUP7ZUaIico/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYURbgAU2hgYybMdZ5V4IxA9Y3mPU6JJMMib89UyjibgWS0wo0LWC2VsDGZTlNrYxyRCqdY9RM2J22pOxibiaXiaBKB1voMwv0f7VkSA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYUHTNOjXJVffQARhBgg7jBVib74PnfYypIEic8IH5q4KVrW25ZicmsHRYTlmdicMf2U0mJOCSz3ORCB79dXK1nO80bPXEfCKF6ibvpE/640?wx_fmt=png&from=appmsg)

![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYXU6hzmUAOJ82lPrXRczTeJDV5T370J8aFozsKKPkD3ytet9X0tn7icB3IScAEgZt0FW4KsicMysQIsA9ib73UolQmRVnCXPZibtw0/640?wx_fmt=png&from=appmsg)

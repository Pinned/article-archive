...
url: "https://mp.weixin.qq.com/s/eWlyaIa1cZY9HhxsQtNd0w"
publish_time: "2026-03-21 07:45:12"
account_name: "宝玉AI"
read_count: 4541
like_count: 116
share_count: 458
see_count: 40
comment_count: 8
stats_updated_at: "2026-07-16T06:19:45.288Z"
is_unavailable: 0
...
_注：Sarah Guo 是 AI 投资基金 Conviction 创始人，前 Greylock 合伙人。No Priors 是她与 Elad Gil 共同主持的 AI 播客，本期由 Sarah 独立采访。_

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/ZlwY8rlDcFOTkTffZh6tpHhJYuVicdUNW6rQbVpViauNE8tbz8ApStLffRu7ficIW0rxiaicyJrw4SzYq2TPKExiciaXv3QCyoqMzKMUet2D1UFIu0/640?from=appmsg)  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/ZlwY8rlDcFOPKYRYon0gIlTXbfQIBcO1ZINgvapxtt7gf9SBE827VCpekZpmzu34ribUELktF6cP5MSonjt45o5yKDGVspb16fDjiakMNcJb8/640?from=appmsg)
...
_注：Peter Steinberger 是奥地利开发者，OpenClaw 开源 Agent 项目的创始人。OpenClaw 是一个可以通过 WhatsApp、Telegram 等消息平台操控的自主 AI 智能体，2026 年初在 GitHub 上获得超过 24 万颗星，后 Steinberger 于 2026 年 2 月加入 OpenAI。Codex 是 OpenAI 的编程 Agent 产品。_
...
他说了一个有意思的观察：过去至少十年，很多工程任务中人们并不觉得受算力约束。但现在有了这次能力跳跃，你突然发现**约束不再是计算资源，而是你自己**。Sarah 说这其实很令人振奋——因为你可以变得更好，所以这件事会上瘾。
...
Karpathy 认为**很多工具低估了个性设计的重要性**。

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/ZlwY8rlDcFM68RiasoWeiaugJHxwjbIzWgdYnTmH2D9oPfHs9Cuqjd31nZ3RqRsUUxv13LG24cUyyrEMyzzHnUYNbnMeogAVYnCfGhJUDu7wY/640?from=appmsg)
...
_注：Qwen 是阿里云开发的多模态 AI 模型系列，支持图像理解和文本生成。_
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/ZlwY8rlDcFPyYh6733bbcY1EorQjqK7thQaibn89joKvuaPNrddpZUleGjicdzQFm7NTKojlaBVKyibA8iaKxGDkYJjiaNdkCzRTF8LKicvmU4VgA/640?from=appmsg)
...
_注：nanochat 是 Karpathy 维护的一个精简 LLM 训练框架。AutoResearch 于 2026 年 3 月 7 日开源，核心是一个约 630 行的 Python 脚本，让 AI Agent 在单 GPU 上自主循环运行实验。_
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/ZlwY8rlDcFMPwVsOhhSIpbd6sba8kIJeLzW4Sicfic5uDhjrezSEdkicKmfdIY6a5Um9Y4lwq8KEaRCOFvfdSAuicJd901YbbA5WdKB6XGmaO3w/640?from=appmsg)
...
人类的能力更加“耦合”——各方面水平差不多。但 Agent 有**远超人类的参差性（jaggedness）**。有时候你让它实现一个功能，它回来的东西完全离谱，然后你们陷入一个错误的循环，让人抓狂。

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/ZlwY8rlDcFM7AROryJyVdBc49BkVTzHBTHu1IwZNBKUiceAYxia4iaBNeGeU0Jdvsicaj5C9w3QsSoBHUuJVwDhe3v2IwZj3e208YwE0vFndovM/640?from=appmsg)
...
_注：SETI@Home 和 Folding@Home 是两个著名的分布式计算项目，前者搜索外星文明信号，后者模拟蛋白质折叠。都利用全球志愿者的闲置电脑算力。_
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/ZlwY8rlDcFOZrnQhMBCQ8xh3iaHUnRW3rDLnZsBzicqlFrJFvFdtImbJWrKxTn4ibibC9E9WCiazLpLkcIA9GfZUy9FPHQZCvyc11YTlicF61oWxA/640?from=appmsg)
...
用的是经济学中的**杰文斯悖论（Jevons Paradox）**，经典案例就是 ATM 和银行柜员。当年很多人担心 ATM 会取代柜员，但 ATM 降低了银行网点的运营成本，于是开了更多网点，反而雇了更多柜员。

_注：杰文斯悖论最初由 19 世纪经济学家提出，指当技术进步提高资源使用效率时，资源消耗反而可能增加而非减少。ATM 的案例虽被广泛引用，但值得注意的是，美国银行柜员数量在 2010 年代确实开始下降。_

Karpathy 认为类似的事情正在软件领域发生：软件变便宜了，意味着海量被压抑的需求会释放。**代码现在是“临时性的”、可修改的**——整个数字基础设施有巨大的重写需求。

![](https://mmbiz.qpic.cn/mmbiz_jpg/ZlwY8rlDcFPB9UMOJWMaCOZsIlicR8hf39W5K6sTbY3bt9nYhSyv3jZAhFLZ8yy7qricRWYOVsibZr2lt3KmXajG0ibJDKj6oqSiczNIo4Zgv5Os/640?from=appmsg)
...
_注：Noam Brown 是博弈论 AI 领域的核心人物，他开发的 Libratus 和 Pluribus 在德州扑克中击败了人类职业选手。Sarah 在访谈中转达了这个问题。_
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/ZlwY8rlDcFMFXZX8LlkaiciaU5C3kkcrUyBs2LJj6KIbMvx2q66ro8niaibkYjgGpwbvR1WVxHua8nDLic4iauKyaSRfkCOVwvU8yPnXGDFv8bvv0/640?from=appmsg)
...
Karpathy 从 Tesla 的经历出发：十年前有大量自动驾驶创业公司，大多数最终没活下来。原因是**资本密集、时间漫长、需要巨大的信念感**。原子实在太难了。

他提出了一个**三阶段路线图**：

1.  1. **数字空间大规模解除束缚**——之前没有足够的人类思考周期来处理的数字信息，现在被 AI 大量重写
    
2.  2. **数字与物理的接口**——传感器（看见世界）和执行器（对世界做点什么）。他认为很多有意思的公司会出现在这个接口上。他刚去拜访了 Periodic Labs——他的朋友 Liam Fedus 在那里做 CEO，做的是材料科学的自动研究。传感器不只是摄像头，还有昂贵的实验室设备
    
3.  3. **物理世界的全面渗透**——市场规模可能远大于数字空间，但难度也大一百万倍
    

_注：Periodic Labs 由前 OpenAI 研究 VP Liam Fedus 和前 DeepMind 材料科学主管 Ekin Dogus Cubuk 联合创办，2025 年获得 3 亿美元种子轮融资，投资者包括 Andreessen Horowitz、英伟达、Jeff Bezos 和 Eric Schmidt。公司目标是构建能自主运行物理实验的“AI 科学家”。_
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/ZlwY8rlDcFOYEhgajkAVxICOQCQ0RN09RGyoccVhcicPjsSNYSRzFNK7rW2ibxjyR6uexmxn4Koga6jMMF15XM7B7scQ9mMjiacg3YnibJmnXbw/640?from=appmsg)
...
_注：MicroGPT 于 2026 年 2 月发布，约 200 行代码（含注释）。Karpathy 将其称为“艺术项目”，强调训练神经网络所需的全部算法内容其实极其简洁，其余数百万行代码都是为了效率。_

他说了一个对教育有深远影响的观察。过去他会为 MicroGPT 录一个视频逐行讲解。他确实试了——录了一部分，也写了一些引导材料。但他意识到**这已经不太需要了**。代码就 200 行，任何人都可以让 Agent 用各种方式解释它。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/ZlwY8rlDcFO4txNh2qWOxgbhAj79caM2BlUHcKUicB6hylzV6vUteq34W4ia1bP258DBC5tMcIRO2huqibohicpa3bmWqoodtiawtIymibrE9WvSc/640?from=appmsg)

* * *

整场访谈中 Karpathy 反复回到“AI 精神错乱”这个词。这不是一个负面的描述——更像是一个发现了无限可能但时间有限的人对自己状态的精准诊断。当你觉得一切都是“技能问题”的时候，每一分钟没在探索就是一分钟的浪费。

三个值得持续关注的信号：**AutoResearch 的分布式版本（Open Ground）能否真正运转**，这将直接影响前沿研究的格局。**模型的参差性**（在轨道上是超级智能，脱轨是 10 岁小孩）是暂时的还是结构性的，这决定了自主 Agent 能走多远。以及 Karpathy 暗示的**前沿实验室进一步中心化的趋势**——当决策权集中在越来越少的人手里，他所说的“不能说的话”会变成什么？

完整访谈视频：https://www.youtube.com/watch?v=kwSVtQ7dziU

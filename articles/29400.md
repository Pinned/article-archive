...
url: "https://mp.weixin.qq.com/s/yTo8BE3tZmuIjdhE6HmK1w"
...
see_count: 20
comment_count: 1
stats_updated_at: "2026-07-09T02:20:36.738Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"开源数据\",\"真机数据\",\"具身智能\"]"
entities: "[]"
---
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/Rvq8Ow69CYWsgbLYYXiaXLlRnkR1PiaU0AklXTm6tTcQsA3wWTV3X4mRGJ8rMjIzdfic5cWibdgRLMeusU9MibmwTpVmU7a3tgv1ygyttmc30dyg/640?wx_fmt=jpeg&from=appmsg)
...
从诞生之初，LingBot-VLA系列大模型就将自己定位为**具身智能领域的「行业通用大脑」，旨在用同一颗「通用脑」去解决「一脑多机」的泛化难题。**
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYW5aBZRUhZ18U41qYt4SD6MTtt388JD0lLAsZg2VUrEDia0tAGnC3pccUZf4zDicJr8DdBn3IxKq20pHdH6d1oCVdvbmX8rgicWfM/640?from=appmsg)技术报告：From Foundation to Application: Improving VLA Models in Practice 

报告地址：https://github.com/robbyant/lingbot-vla-v2/blob/main/assets/LingBot\_VLA\_2\_0.pdf 
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYWK1y0icnPAeibZ89vkkRFS5iaDF1pw0e5uMgWjlpW87UQFfL43QHPYeqO9p4TMFR9NMPjSdRiaL6wMqPvxZNsaibeZicZic5TYqxJndA/640?from=appmsg)
...
2026年初，蚂蚁灵波正式发布并开源了具身操作基座模型**LingBot-VLA 1.0**。
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYVVOwX5IayguEqLtoBkTuywpDu0DCf1ERlDQVEfmf0JoURFTJUcNHrKyow6eN0qSbEKwI1OI20WC6C7lQ9Jt8esxwmGd7LfYKw/640?from=appmsg)

  

LingBot-VLA 1.0率先放弃了单纯依赖仿真合成数据的幻想，坚持走**大规模物理数据Scale Up**的路线。它在预训练阶段汇聚了**2万小时**的高质量双臂机器人操作轨迹真机数据。这些数据并非单一构型，而是跨越了**9种当时主流的双臂机器人构型**。

  

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/Rvq8Ow69CYVkWyymHnq146CicCd2wAIniaxsdkiaAhQfSP4RauyLfHRxHN20UPOZibywyZhGnkV9wgdQnMAS1Pyib1wBUibquibRKOra0goviaiaLLBI/640?wx_fmt=jpeg)

  

在算力上，1.0团队构建了一套极其高效的底层训练体系。在8卡GPU的FSDP/混合并行训练设置下，其单卡预训练吞吐率达到了惊人的**261 samples/秒**。相比当时主流的VLA训练代码库，实现了**1.5倍至2.8倍的计算加速**。
...
而到了2.0时代，预训练阶段覆盖了**20种以上的机器人构型**，横跨国内外17个主流品牌，包括：
...
预训练数据从**2万小时双臂机器人数据扩充5万小时高质量真机数据。**

  

这份名单本身就极具分量：它不是在实验室里挑选三五种形态相似的机械臂做demo，而是将市面上主流物理构型、运动学约束差异最大的一批人形、半人形、单臂及多复合型机器人拉到一起，实现了**同一套大模型权重的跨本体泛化**。

  

![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYUbTRarUIPXFqnKnaUyiaUg9g0jT82xYgHFG1Ma8GqcbSDV9jM9T1dpiagamdnSZzp0CfkFvfhGORZ1Qg9xADibS5qeWmZ3fJ0xia8/640?from=appmsg)
...
LingBot-VLA 2.0首次将**头部、腰部、末端执行器（手）、移动底盘等全身多维自由度**统一纳入了同一种标准的动作表示框架中。大模型不再只是个「提线木偶的手臂控制器」，而是学会了「动全身」。

  

这意味着，它不仅能指挥双臂在桌面上灵巧操作，更能调动腰部下蹲、配合底盘在三维空间中大范围移动、转身、开门，完成极具挑战性的精细化**长序列移动操作任务（Long-Horizon Mobile Manipulation）**。
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYXVnhW6fNSibKmvwj0MTcRw6PfMHTUvp5tdICib0Woe3AZ7SJodVcfd0NXWZKWMYNQhTKDplMpr8qfdmva95uI9SGjJ8eaZ7LmDk/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYU4kxqpYH7m3pSY0LFKb4mRvbQWibaricZyRl1jXzcSeN4sbR6RbuYpxh48ag0lgwibwCcjohlCicpLib2dVONLAyia2pybWlRLHhr78/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYXEx2AiajKhBiadTWD9CgibTZVaZcfcXhK8quV1pm8V7mkSn1Bpuh1IEGI9IkKJvgonaFSwichmoQ9gIVcItCXptKPDW7YBibMR0RUY/640?from=appmsg)
...
为了打破这种物理限制，LingBot-VLA 2.0重新设计并规范了**统一动作表示（Unified Action Representation）**，用**55维canonical向量**表示多种构型机器人的运动。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYUMpNwZZYhgu08EUOlWCoYwmn1TibKz94HmbS69AQ9UZyuHLwLnGrkdaXze1r95Skia0442ibbn18iacJH5091aicvMazEFMjao1Quk/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYV9BThLPdnKZ9wEoS94afCCn2q4QUyfOGDBGYCNIHx87CeGN4XWWyYsmQCqgOqFLSleMjic4ewGo4QwrJv6IKta9bgzLzpe9icBU/640?from=appmsg)

  

为了在不增加实时推理延迟的前提下，将精确的空间几何直觉注入大模型，LingBot-VLA 2.0引入了**LingBot-Depth**进行跨模态特征蒸馏，让机器人操作时更好地理解三维空间。
...
依托**60,000小时**的物理真实预训练数据，LingBot-VLA 2.0在底座上完成了真正的**跨构型迁移。**不管机器人的手臂是七轴、六轴，还是底盘是轮式、双足，同一套动作指令在经过空间感知对齐后，都可以无缝映射到完全不同的硬件构型上。
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYXaWgEHKjECCws1np3I0yUj2ITVdMwuwfbUk4SMRKkBibMOFGfnAOGmADGib7exicCIjns2VUHPhWV3avOFJBWFDuLXzQ6wQ6Hepc/640?from=appmsg)

  

这意味着，LingBot-VLA 2.0在生成动作前，必须先在脑海中**精确预测接下来物体的运动、手部交互的力学后果、以及场景的语义演变。**
...
他们从约10万小时原始数据中清洗出**5万小时高质量真机数据**，覆盖**20种不同机器人构型和丰富任务分布。**
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYXiaETb3CA4MLiaZQ37BR9ZE5Spic81RbGbiakuwjbWGh35DibzOhgj8F4QicAxvYdW0rjj5cqVulGeq1F2NicrZNhrUfd6wRQkOLf7FE/640?from=appmsg)

  

同时加入**10,000小时高质量Ego数据**，让模型学到更自然的交互模式和手部运动先验。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/Rvq8Ow69CYXvs457QUppn3zuDXoNicBOLrDtuftvhQe9o0kRBXg72tcCdZGgCtQN7mq7oibs6WaXXOsAaVO8fqzBdLWTq9TbhhQyfpsFC1FHY/640?wx_fmt=jpeg)
...
这些设计让**后训练成本显著下降**——在v1已实现1.5–2.8倍吞吐提升（单GPU261samples/s）的基础上，v2通过更高质量数据+更合理架构，进一步降低了达到目标性能所需的样本量和计算量。LingBot-VLA 2.0同步开源更高效后训练版本，推理耗时在RTX 4090上控制在130毫秒以内。

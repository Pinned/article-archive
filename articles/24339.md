...
publish_time: "2026-05-26 19:48:01"
account_name: "机器之心"
read_count: 3111
like_count: 41
share_count: 217
see_count: 20
comment_count: 0
stats_updated_at: "2026-07-09T02:58:51.300Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"AI手机\",\"Agent\",\"趋势分析\"]"
entities: "[\"OpenAI\",\"Gemini\",\"Android\"]"
---
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqHJQJwzzia5BcsmzsPt0fSQqgkicYIcDFwKlLLOgdCiaIlSic9RiaoUkZXCSOG7WktUk1K87c8CyblW5L4SdeIXiborDNMIu9L29Ur9A/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqFPicAc5ZlPD4M6hPSjc1GkbRVt6rCNR6YUDJX7FUbpGLC65FNjao21LKGS2DQ9MWPO11QQNcKdFxbHhd1RH5hVjqcSR1PrZofo/640?wx_fmt=png&from=appmsg)

为什么 mixed-action 比纯 GUI 更稳

  

![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqE3nA9MwYPWib6Rmarwb6ficqUM9RZKXDn9DINXrkVplibd7jicDdEyic7Td0CrXFURZLictVjqkic8ibMFlRIMKqv2WADVbzJjr6aFqFc/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqFrZsBecDqKWnibBdUW8483cO9BQUic07pIpfDVrpwich2WXiaSawMgn8zJI5psmE8PGfewOJS0VTM11icNM4JoLGSULRmIIvF50IEI/640?wx_fmt=png&from=appmsg)

图解：PhoneHarness 的三类行动面

  

![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqHTjp4TTzZIsiar9ia8CoMZDBaEyr26E6zqt2lBa6TgxCCg6eyHWXvKFU8Qf3vdtB930iaYt38bo7EbQoMHib7kYLJufiaLNnSsgTLY/640?wx_fmt=png&from=appmsg)
...
有了 mixed-action harness，还需要一个能真正检验执行结果的 benchmark。原因很简单：对手机 Agent 来说，能行动不等于真的完成了任务。
...
Bench 的关键：PhoneHarness Bench 不问「模型有没有说自己做完」，而是看「任务证据链是否支持它真的做完」。这也是它区别于纯问答式评测和纯 GUI 状态评测的关键。

  

![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGy02XYoUQZ8q1YryXAtG3byFvycdVtsqR2Tw3AlFOGMfeFjhDmesv0KvGl4oovYGaq4g1MFYP687gqicaUutUbHsWdNDlibh7GE/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqEbQ0bPxCNUB23DjTd1RWwUcReDuGkY0iaRLJPtDp8Rfvh1XyVsnNCCugJTBeKhwapg7cibva9XBpZ3MficmIQHxuZmqAmRnnHIvY/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqG38MNL4oDwCXJPCBT8s6luCBIkpGLzQBCklZszbb3Tvdp4TUcw6rotOpBOVxVlbrQsYfTPia6EWcVmU2SNZhghuj9csWfWTmiaA/640?wx_fmt=png&from=appmsg)
...
实验解读：这个结论反而更重要：手机智能体的未来不是「把 GUI 点击模型做得更大」，而是要让 agent 学会选择合适的行动面，并让每一步执行都能被验证。

  

![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqEibcqrYlvDpfziamxj3qzW2RYLwwCqk6MfSiaUu9KNIUt18LA8Vibf5IKzxxiahEQgCwKtxYuEqB0aNA2TtHLg5tjmvjqdAE6dPtoc/640?wx_fmt=png&from=appmsg)

mixed-action affordance 任务上的行动空间拆解。

  

![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGn6DQGkytcy25KhMLWa7cIG6DRiarENgOibVuiaNH1N07UE7AXeCgxsTxBgL5xnoGhzPjsIpRfjlib5BguMMU6mHnwUsibcs9DNEvs/640?wx_fmt=png&from=appmsg)
...
OpenAI AI Phone 和 Gemini on Android 之所以值得关注，不只是因为「大厂要做 AI 手机」。更重要的是，它们共同指向了一个产品范式变化：手机正在从 App-centric device 走向 Agent-centric device。
...
在 Agent-centric 时代，用户表达目标，agent 负责调度行动。

  

![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqHgniap2bibFEWsKnicF89IlakTYQtbHg06NaLvibtQe0icqCbzU28z6lhyY84hvgKCYpcfcmnFFGN9RmsicUBqqWQsxVicfJvf8sNiblM/640?wx_fmt=png&from=appmsg)

AI 手机时代的新瓶颈

  

PhoneHarness 的切入点正是在这里：AI 手机时代需要的不只是更强的模型，还需要能承载真实执行的 harness，以及能验证执行结果的 benchmark。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqEbmIcE5OicuXa2ev7knJhRFib8ZxJ2D2WpRqIvOJatBPhibTIGcjrAMYAOyec55sYWBn6C8x0eytChGicsficss2X1ibmLeZnWpIS7s/640?wx_fmt=png&from=appmsg)
...
如果说过去手机 Agent 的竞争更像「谁更会看屏幕点按钮」，那么 AI 手机时代真正重要的问题会变成：谁能把真实手机 workflow 做完，谁能留下可信证据，谁能在安全边界内稳定执行。
...
PhoneHarness 和 PhoneHarness Bench 想推进的，正是这一层基础设施：让手机 Agent 的行动空间更接近真实世界，也让评测更接近真实完成。

  

一句话总结：AI 手机时代，关键问题不只是模型能不能理解屏幕，而是它能否在真实手机环境里选择正确行动面、完成可验证任务，并留下可审计的执行轨迹。

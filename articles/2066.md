---
id: 2066
title: "不平衡数据下对比学习的理论分析：从训练动态到剪枝解决方案"
url: "https://mp.weixin.qq.com/s/iUVT42ZYKX8ySYSogA63NQ"
...
see_count: 3
comment_count: 0
stats_updated_at: "2026-07-04T12:59:20.233Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"对比学习\",\"不平衡数\",\"模型剪枝\"]"
entities: "[]"
---
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqEX3tW1ic9nHOTzUT662piaDMicaq5aGD76oEDvHfsTzCiaBw2wJf7WaZZvibWsoPDXbew0gbVgewItBiceG0ia9vVWHuUicAwJb0MvydA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqHEVT9SIYOFVJIicWlllRJgHcnFq3cWUniarfLeTo6e0uqlWw86icHPQcnXgaCE2wMzaNdrEEAeKAXxKhagudzia4yaA9NU0to8CCk/640?wx_fmt=png&from=appmsg)
...
*   专注于学习单一特征的神经元数量更少，对于每个特征，至少有![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqEjHQWk53xWcjd3MItlzyliav97cuxtC3NVgHWSx9Js0iaExUXcJgwmR9yX0L5811baWj5DNibS16VadOZppyZ0KxcDRwjFRMIwkI/640?wx_fmt=png&from=appmsg)个神经元专门学习该特征。
...
*   更多神经元专注于学习少数特征。对于每个特征，至少有 ![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqEZhsLuKsdUyMUAJoQYavA1dmc7n63x2ICVBJxiaM0sHesFtkhFfLMibqn4H83W9dAuzclfzhAe0oFD4Xgvzc8XlhYfyicUkUaZ4I/640?wx_fmt=png&from=appmsg)个神经元专门学习该特征。
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqHaZsAPvr4UCI0FlAjibU9dIcx5BIYP88kPhL5VnAeTMeDN3QCmuPoFddkXZtOnggbvrvCK7liccjsVhSakKTfrDXcoXj9VGicicVI/640?wx_fmt=png&from=appmsg)

表 1：CIFAR10-LT、CIFAR100-LT 和 ImageNet-LT 上的线性探测准确率（%）。![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGpLnLsRPenyibxlc0eI9eibJ3zqniaFoMNQZficibZJydJT35Kr9phUqTE4feGXPoj4WRNpGRTgL8vpniavjLlicqb6TfD2NKmPMdDPk/640?wx_fmt=png&from=appmsg)表示前 20% 头部类别与后 20% 尾部类别之间的准确率差距

  

表 1 展示了在长尾分布设置下，对 CIFAR10-LT、CIFAR100-LT 和 ImageNet-LT 进行线性探测评估，对比了不使用剪枝与使用剪枝的结果。不平衡比例![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqETTBSPoCnNrp0btNrOxryfpHgdHWE8kATglEtdA6HfJ3vPg9LPHFptxVD0ibkjYXXLYF68hmTORYfDRca7Xncl5ialtQmvXThqg/640?wx_fmt=png&from=appmsg)定义为多数类与少数类样本数量之比，数值越大表示不平衡程度越严重。

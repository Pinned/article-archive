...
publish_time: "2026-05-01 13:27:51"
account_name: "量子位"
read_count: 35294
like_count: 704
share_count: 2094
see_count: 228
comment_count: 11
stats_updated_at: "2026-07-08T10:05:06.704Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"Scaling\",\"模型降智\",\"大模型\"]"
entities: "[\"智谱\"]"
---
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/A6fTew8FFGH0XBzFDJkBPczbmpB3FXbgX9wHt4qGzJ7zZ5HLFN8diciauwHkbgYPM6WPDbLBStYoyWxv8JeYARSXCIic7j1VuzNaTEZK49ic3ick/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGEKtkMWY2M1YsicQjLnsZSGTHJpuzQlVt0iaaiaMEYFYyZJNDDSrNkpXyrcics4DDYLHD96MLRq1HrxKicNibAyjVSBiaU0gnymdIa3f8/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/A6fTew8FFGEIL8p10BKJQPuy4KKBkicr8bff46Xlk98qKLFRn5g1XaXTYexRuiaLOEM8cvmZSA45TEsQdAzgjE0eHibGUeTot46z6aXFOaLHTs/640?wx_fmt=jpeg&from=appmsg)
...
于是智谱团队继续对异常输出的检测方法进行优化。他们发现**投机采样**_（Speculative Decoding）_指标可作为异常检测的重要参考。

投机采样原本用于提升模型推理性能，它先由小模型生成草稿_（draft tokens）_，再由大模型验证是否接受这些token，最终能够在不改变输出分布的情况下提升decode效率。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGGheiaZfQbLXtxJWv8iaaib5QK5x6Lc3CKiaaFrAJJWRJveNSadaUWM9LCfibtAyt4kOnxZXZALnkxicu9ia9NIibB7CK55XozpVbW5ACg/640?wx_fmt=png&from=appmsg)

而在GLM-5的三类异常中，乱码和生僻字的spec\_accept\_length非常低，也就是说目标模型的KV缓存状态与草稿模型之间存在明显不匹配。

复读则拥有过高的spec\_accept\_length，表明损坏的KV缓存可能导致注意力模式退化，将生成过程推向高置信度的重复循环。

基于以上观察，智谱总结出了一套**在线异常监控策略**：

当spec\_accept\_length持续低于1.4且生成长度超过128 token，或者spec\_accept\_rate超过0.96，系统就会主动中止当前生成，并将请求重新交回给负载均衡器。

紧接着，智谱开始进一步解析异常原因：

#### PD分离架构下的KV Cache竞态

![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGF86uhLecKG8nFnEyUeF7qdLTWXXJiaDJwb0upUAAEmBVPzEKeKXW8IQ625ibqKflvgYnav5bFA2R3JWsE5JicwofBLbZqEgBgiaWU/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGHPNicHINQZjia1un2LCZe7PwvXZicNZnsicNxbHclPnD1ffYHlRf4mcgmPA0iaU2amCZibWrnHmJxUEryhIz0nia6LF3EB3CL5icXYG2c/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGG9lEdJW76GRxyDBY2xtJyyPKTwiaLlDiaS83CicepG2ZnkRlib7cfo15XRgGdVnHchCMxImZ2IeIibHgRCbYnYOQhicUEfEZY74bFoo/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGHWdfzRsB3rwIKiaSPgcDMlSjVWJBkIAf0Dc8sSaepqd5mph1Ff7BldZQXqC6QecJHwU09qZibriaWVeWibdeYibsTrvPibQwFleIdGw/640?wx_fmt=png&from=appmsg)
...
\[2\]https://www.zhipuai.cn/zh/research/159_

...
url: "https://mp.weixin.qq.com/s/3TvHU6vvGtwJ_9ard9Q6BQ"
...
see_count: 10
comment_count: 9
stats_updated_at: "2026-07-09T02:21:34.161Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"软件质量\",\"资源消耗\",\"Bug问题\"]"
entities: "[\"Codex\"]"
---
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/Rvq8Ow69CYVVY5oNRTTmPdDS3AlGLg5IrOox7ibnQgQUiccicXs99ZAN6xKaviafLZARve9W16icws7uXnqLhRUdQj1OHjdVUxmrkp2bbHozHfnQ/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYW1rwnORasicdVibhAIGeRvjWzeQEYViazBPckvjtjgzq61ALhdlf42L67hg8JsN9oy9Y97rcnv4MoJxPtKbuBlpp8rmW9VD6gG18/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYWcVtTb22PpfxnQPHL1FUZicR423gxePmEtx3qVQzDIPz5DR2Hq76JC5F16rm6ZmlNF2iaianTpJEiaB1zrLRgT57jGz9fk9GIYX2I/640?from=appmsg)
...
Codex在本地维护着一个SQLite数据库logs\_2.sqlite，专门记录反馈日志。这位用户抓了15秒——数据库被插入36211行，而保留的总行数，从头到尾都是681774，一个没多。
...
一边写一边删，留下的logs\_2.sqlite能多大？大约1GB。
...
答案在Codex源码的一行配置里：SQLite反馈日志的sink，初始化时用的是Targets::new().with\_default(Level::TRACE)。
...
Codex的日志框架是Rust生态的tracing，标准做法是读RUST\_LOG环境变量。用户当然试过，把RUST\_LOG调成info、warn，甚至直接关掉。
...
with\_default(Level::TRACE)把全局默认硬钉死在TRACE，RUST\_LOG在这条路径上根本不生效。你以为自己关掉了日志，它照写不误。
...
把保留的日志按类别拆开，TRACE占了70.7%，约732.5 MB。再加上codex\_otel那两路镜像遥测日志（log\_only和trace\_safe），又占了25.3%。

  

![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYVabQf5NUG7bUsFpdic7KBMvouS0BTVj2qljAgZBg82oXkicI2DJzKnt540tzrwnhQx0zEbuRZjrVc7wx1QNhDHV2UiamwibjFcVyM/640?from=appmsg)
...
#17320，流式响应期间WAL狂写，根因和这次一模一样，都是TRACE无视RUST\_LOG。

  

#24275，桌面版logs\_2.sqlite疯涨。
...
#27911，一个4KB的goals\_1.sqlite，被写成11MB/s。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYXmSO8KNJMibaRuJuAfEkgEFaibeBM6fl75EMod8IHp9cyhLA5yQmlXTph8Nmxon3AXqCfjMTdbGyJOmfdwRLF4RM3SJWk8IXjH0/640?from=appmsg)

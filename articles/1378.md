...
see_count: 258
comment_count: 7
stats_updated_at: "2026-07-04T11:57:57.154Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"Agent\",\"开源框架\",\"自进化训练\"]"
entities: "[\"卡帕西\"]"
---
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGH224rlRSoHcic1Io1xl6ByjaGuMPkKpzB4D8YGLf32waRHFWuYEAoBp8uWNgztOWvhK67DmusNwbaDzaqSRgRQ9S2yVm8gn6Bs/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGEUjKLgTgLSfIOUmqOpV4pJvrFDnQy9XXZ6NjYwEQ8J6BhNM8IHmsJao4ThTcHnX6dgG34pUZh7OLFSaEygeGP8z43V2ib6ibAhM/640?wx_fmt=png&from=appmsg)

在X上，Karpathy的帖子也有580多万次围观。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGGxG0PB92ZlLNgA5U5GqtZqwscJ0TibOKC0wMr4FwMgLCGlE8NY9hAsHPcGiauvoocMTAEwpdQGIZJqkRib3waib6edhZDGlROpchA/640?wx_fmt=png&from=appmsg)

Shopify CEO看了Karpathy的项目之后表示膜拜，直言这个项目实在是太疯狂了。

![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGGHkiaX71txWJmBZOW0hiaic36sbIRIDMPb67RId1ZSujMALdbqzYibWVEl8O4EhyicP7701WibSia3QM1YXCA2UHoMukakgxystvZOyI/640?wx_fmt=png&from=appmsg)
...
二是**只看val\_bpb**，这个指标的数值越低，就代表模型效果越好，而且它和模型的大小无关。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGFlJmdxcRsVZWwdeAXEJeS4o8nVaricxY3ubP58ibvjfwBW5CrGsf4sCMcRUBIT2dwYt6WRLBNljgpGBIH1XK5kOuGJQeFRvV8qQ/640?wx_fmt=png&from=appmsg)

prepare.py用于定义训练的固定常量，比如模型基础维度、下载模型训练需要的原始数据、训练适配的分词器等，同时还提供实验过程中需要的工具。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGGS9ib7N0hBHQldJ8GicIaruAcaLV89x5ynmfqJdXHqFrickw4qPyp06wnibHq38S8acTGeCOkDEpP21JSOicIMqEIr7NQhmSQqPZR8/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGHylqvItwV4CicsIIXEDXGLibLqXm7agqhOCoKwccwibLQtJWG1G2twricqVG3snA619Ef4rzdOqhkCDDP8pFCC9U8T0W3DHicySk8c/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGHdoT5YU52TeaWIKv2e59gJTKvVzd8LU11Jp1hx8KiaP4lgpCBLBs9x3VsqIzv8Rah9HpzJLictiajjXrkQOc7gffzwAYEtCA0Lia4/640?wx_fmt=png&from=appmsg)
...
修改完成后，AI会自动启动训练程序，严格遵守框架设定的规则，纯训练时间固定为5分钟，时间一到，训练结束，框架会自动用val\_bpb指标给这次的模型打分。

根据打分结果作出决策，如果这次的val\_bpb分数更低，说明模型进步了，AI就会保留这次对train.py的修改，把这个版本作为下一次实验的基础；
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGFQNzlicpY1zVLsoq17ppM4lIxUJRHdaqEibfYaqPGOwpBV8qYCvkFHesPjWravuR78H3xYic52xWrbrnRQ6243ZNpJX5JT499iaKs/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGG4FPvDmZ2FRu3T2I7pibiaQDTkVu5KP9ickYx1IicmvAsbtnLIKgCFkIXg8icKp96g5MNRqBFgjyDS2l0RiaE7aKmeolHCbrHfxJsBc/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGEv1t3oJowEuPXicwicPsEwr8ibP3UdicSoT0tRda2Diaia9mrLlibmbibvetIRIycqVoPyU4G0tVSspsr1I2abG81Lx4aTfcHKeoJHtSE/640?wx_fmt=png&from=appmsg)

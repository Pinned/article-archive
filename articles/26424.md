...
publish_time: "2026-05-30 10:14:18"
account_name: "机器之心"
read_count: 6572
like_count: 98
share_count: 590
see_count: 63
comment_count: 0
stats_updated_at: "2026-07-09T02:58:15.353Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"优化器\",\"训练稳定\",\"大模型\"]"
entities: "[\"港中文\",\"Pion\",\"AdamW\",\"Muon\"]"
---
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqH2cDEOjUd8yK0jFMfxIMmL2eXREYZVpibzNKNM1Ts24mbicDdp1oZYPE7OR7fVfkImluCPBQ8I2ZCyUKgzseHsib28ES6bWNndcI/640?wx_fmt=png&from=appmsg)
...
过去几年，AdamW 与 Muon 等优化器的设计重点都集中在如何更快下降训练损失与提升训练效率，但它们本质上都采用加法更新：![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqH00JyYMUCXPVz8qMrZHCAnoXqOVib9Jic8T9j2H6MrRHA7jPRibWWrJd6mYVCM6LIeZPpibm0icqDO2yQuuvTcicDGbtVJg7pII4zek/640?wx_fmt=png&from=appmsg)。这种更新方式天然关注的是 “如何沿梯度快速下降”，但并不会主动约束权重矩阵的几何结构。
...
近期工作 POET \[1\] 提出了一个新的思路：通过控制参数矩阵本身的谱结构实现稳定的训练。POET 的核心做法，是通过正交矩阵对权重进行双侧变换：![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqHE8EvjsJQnRydH9HthlYQb7wYaKIvuqNiakcQXKyncPsRpqKvib9WmpviaBCoiaU2qXSl77NkiaiaSp14EoMYdNfd3OfyTc9hsazeNo/640?wx_fmt=png&from=appmsg)，其中 (R,P) 为正交矩阵。由于正交变换本质上只会旋转特征空间，而不会改变奇异值，因此这样的更新天然具有保谱性质（spectrum-preserving）。这意味着：
...
Pion 从一个非常简单但关键的观察出发。对于任意权重矩阵 ![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqFBBHGh2tB9gxqU4amkq0MP0A6bRuxrpJoicpM7gfGxCZ4NC26lxXz3kict8NNoyDpzF8ysMD72DqLGXDHUpJibnibR821Y5ZtcZmk/640?wx_fmt=png&from=appmsg)，都可以写成：

  

![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqHBiaJKAKJ9BuHGUZic262IsDAK7qKmIyH5SL1Prl9HswxCjzOicAJ54zdHPVD9n4ibrWibI48Pksk2as2OryHk9Upub7STGR1SFQWc/640?wx_fmt=png&from=appmsg)
...
Pion 的做法，并不是显式学习新的 (R,P)，而是直接在正交群上更新这两个 “单位因子”，从而对权重矩阵施加左右两侧的正交变换。我们将![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqFeCLkicy3cjMqxmNTnR31gN3pRvgYcWIvk8KL5Bs4BiaCYCVP0X6iauWDNaGc1cRO54iahiaUyuEobVtsAx42ejNW2Re10gBTiboPFo/640?wx_fmt=png&from=appmsg)的梯度记为![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGAHAt7yEsfIHNb7ync18ojoCE2h3wqsJ4eG3xvf8Q1U5HPCEJiaBnRhJwNs2FvyxahrobibUDcXt9HMO9Z3B42RhEp7ga2VeTDU/640?wx_fmt=png&from=appmsg)，Pion 的更新规则写为：

  

![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIq
---
id: 2264
title: "想让机器人春晚包饺子？阿里达摩院：别急，先把「大脑」优化一下"
url: "https://mp.weixin.qq.com/s/53UMfJL6VG-TAA4KJNv8Mg"
...
see_count: 55
comment_count: 9
stats_updated_at: "2026-07-04T13:08:48.499Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"机器人\",\"大脑优化\",\"具身智能\"]"
entities: "[\"阿里达摩院\"]"
---
...
阿里达摩院最近的一项工作 ——RynnBrain 也瞄准了这一方向。不过和一些表演叠衣服、做早餐的研究不同，他们关注的问题还要更底层一些：如果机器人在做家务的时候被打断，临时去门口接收快递，它还能不能回来接着刷碗？如果机器人被要求完成一件需要借助很多工具的任务，它制定的计划会不会包含手头压根没有的工具？

  

在关于机器人的各种宏大叙事里，这些问题可能没有那么起眼，甚至连相关的 benchmark 都是缺失的，但却是机器人走出实验室必须迈过的门槛。在 RynnBrain 的构建中，达摩院具身智能团队选择从底层出发，将时空记忆和物理空间推理直接训进模型里，并且达到了不错的效果，在 16 项具身的 Benchmark 上实现了 SOTA。
...
达摩院还一口气开源了 RynnBrain 全系列共计 7 个模型，其中包括 RynnBrain-30B-A3B。这是业界首个 MoE 具身基础模型，其只需要 3B 的推理激活参数就全面超越了当前规模最大的具身基础模型 Palican-VL-72B。使用这个模型，可以让机器人在保持最强大感知和规划能力的基础上拥有更加快速的动作响应和更加丝滑的行为模式。目前，包括模型权重、评测基准及完整训推代码在内的全套资源均已向社区开放。

  

![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqFstV9pRzEibFoIjLxMU2N44UbmjFiad5vKutG9KiczC059FoqLTf4HCU9dHfnQToe1Uw54a9OsgLpLePxYBX3JZric5QfhnG0BNJo/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqFmicZOOeq5JRO5QouclsTvG5FVymYSWm18HV5mg8icSF5icE6dOicPpA8gpO4yjqKViaQaHzdsVhGAM3iavEq0DmHr2DnfVqFRVDf4M/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGXaZG2WkB0W4cy0FJmCGUGn7EP1eUC0aXHESZ7RRp6uVCQrDpNeyUCJ5IJceefemEec0PiauVIVFmbmQhRM7xLbb6lqkXxMs3Y/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqH0WUDpkPkZnmZOyMicz7dp8fTuu7v2Cqwe898aRbICy2iabs6LXslYRuNwDbtbcXGwKQWSoSicEt4rxIJSewhV0FgN2IAkqFhvn8/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqHy7KJ2X7nDkzYRhsvuY4SUXiariboq3b0ibYU4NfFkCzIvibcjxA7b9Tp1DNicAES2KKia9ribtib3NLFkE7KPOE4NXJOm9T3f03SLwiaA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqHO13J7BH2wLib17LJhpGAMx6vV802vpy4enpvQs21QicxQ3djfLqFua0usqJgdeeOHZWEsRiaHB5IIlsE9vUPenkUfSMOhbqcWhE/640?wx_fmt=png&from=appmsg)
...
_模型能够理解用户的饮食需求，结合常识判断与中文 OCR 识别，从多个带文字标签的物品中筛选出符合条件的选项。_
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGZtmBkLLPWOZHFOHpXJuXbwa5M5vavRzrldVeWLVP0azaBnIiaibeAUEibojhiaMzFCE5Yogj0ickdv6z7HTq6OJdV4goSdhZLovZU/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqFyb1AHUUQDISUHkVYvLBLSl7icz19EO9oSQicGD5oa04ddXuKSZ6CLLicZLaypSV2ncUNWqEYmHUFzWohDX9RzI0lzReZ6HoLzgE/640?wx_fmt=png&from=appmsg)

...
see_count: 33
comment_count: 1
stats_updated_at: "2026-07-09T03:02:03.188Z"
is_unavailable: 0
...
最近有关算力的大新闻层出不穷。今天的最新消息：[马斯克的 SpaceX 与 Anthropic 宣布达成了重磅协议](https://mp.weixin.qq.com/s?__biz=MzA3MzI4MjgzMw==&mid=2651031726&idx=1&sn=e6eca005d102e4a279d9b460dfa0d35d&scene=21#wechat_redirect)，超过 22 万块英伟达 GPU 将为 Anthropic 所用。而 Anthropic 对与 SpaceX 合作开发未来的太空算力体系「表示有兴趣」。
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqE76allonrJFgRNZRPtlwwicViaMbt4ictwroc5mBhViauQ6myM3XpFZTiciaDnjbBice44KlOn4tnjxS7wC91ZCYtEgDcPkAicwV4GJYg/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqHH0bFxF9EbsfwzJYn1xictEdeDJo0uZrrTDh9m0aOo6IB9XIUPGkw585WWUU7CtCfCl2cWFcotoQRrOmc7fnHia1b67CNaIMH2E/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqEca6xw9c7g7fdGsWSlTaicAvficRZVoyV9dgkTn2HjzB9YJMV4EEWViayzKKsrbJ71hldO5nnJyUo8Pzxxtic9q0B1J8vph0VMTGY/640?wx_fmt=png&from=appmsg)
...
与此同时，团队还针对 NVIDIA Blackwell 架构进行了大量性能优化。例如，他们构建了当前智能体负载场景下速度最快的 MLA（Multi-head Latent Attention，多头潜在注意力）kernel 之一。在 decode kernel 中，由于部分场景下「num\_heads」较小，团队通过对「q\_seqlen」与「num\_heads」进行分组，以更充分利用 Tensor Core 的计算能力。而 binary prefill kernel 则包含了经过精细调优的 softmax 实现。
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqEQOo92tYEicyDicEOM0TEULPyCib3d3dENqw9zY3ibLdNghCibYibb5j36BicUeOSHzrCfTAh9gOLKibsmbeQptziakhhiaL5IIiat4PewwY/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqHphE7B6URnL0pOhGUiaLfKQ15GiaicUfD2H09a0T2ca9ldiaovxj1GwGpPRVaXbm2AWPWUoVFFbY6LtSJbjGRGBYSM6bFytYExwJA/640?wx_fmt=png&from=appmsg)

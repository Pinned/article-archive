...
see_count: 24
comment_count: 5
stats_updated_at: "2026-07-09T02:32:19.464Z"
is_unavailable: 0
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/Rvq8Ow69CYUVYvnWTsQ2d3wwqCpNNjDbjojFZKyGcIYqCiaSwxb92qKCA7M0lYRan4BMibr4YLibib5HBbbkeITFwPFy1LCibtspeB5bwmws9D7Y/640?wx_fmt=jpeg&from=appmsg)
...
##### **【新智元导读】红警不再只是童年游戏，而成了AI Agent的硬核训练场：OpenRA-RL把25Hz实时战场、50个工具调用和64局并发打包开源，让大模型第一次真正站上RTS战争迷雾里的公开考场。**

AI能自己打红警了。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYXDAolcZhNYp0zYXQFocicibS3CF7z1d1O0NFzVCsS94BBe63UH2vMPdCT8PYMxCACaYWia6BTtgc5sajuvYxXlhic3lf7ic7icbOMT0/640?wx_fmt=png&from=appmsg)

Hugging Face 刚扔出一个炸弹——**OpenRA-RL**，直接把经典 RTS《红色警戒》改造成了大模型的 Agent 训练场。

![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYVnwTNvgVcvZicF2Qfm9tuNZILcFLSTqIoBxPwaIPWQq6ykPD76EM73dWicMsp1PS3xj08KDTd7ZtQkicKJjia7VRVy77rC1RwEz6A/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYUXooRUjvic57ufmJDRVOwiaJhB1ehkmO5YvjTCWE9R3UVIWgicHGf1IelkKbReSTMSd3FYDDJCl6P1fj3ibXhgOTMeuOZvDrsc8os/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYWibsOw0DEgJicGbW4KvNJpBic0n1ycXU1UAhnRl6icwDrqXfbiaR0dQLXuXIN13bAb1Ajd9Pq4jc3jCP8hQXnGFKgt3lX6xFHVbfTQ/640?wx_fmt=png&from=appmsg)

Agent 在每一局都成功建起了经济体系，但从未生产出一支进攻部队。

有趣的是，如果只看胜负，5 局全平，故事就讲完了。

但 OpenRA-RL 提供了 8 维奖励向量，画面一下就丰富了：经济维度得分 0.58-0.80，基建表现稳定，但**战斗和骚扰两个维度是干脆的零**。
...
提示注入式学习能修复建造顺序，却填不上战斗维度的零分——**这恰恰就是从上下文适应到权重更新式****强化学习****应该产生可量化提升的地方。**
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYX1MRzMN7ywTku9KDwARkJzVKR0LqhoJAYszibtvgPhtlLG30pxDsJmbXE2o3BSfTK5gnfSHd3icaoicw8PFCiaOQBQ2jSDVHlBNW8/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYVu4Q9vrke1JzTjiaCjmg6MMswzAbESGicj2nvpexicHkJTbd5BwxFTgsArmQM0a4UWfKe1U42grHfUHqk6dibb0gib24vEOmUmDpr0/640?wx_fmt=png&from=appmsg)

对于 AI Agent 领域来说，这套工具的意义远不止红警本身。

AlphaStar 和 OpenAI Five 证明了 AI 能在 RTS 里达到超人水平，但那些成果被锁在高墙之后——几千块 TPU、定制架构、不可复现。

OpenRA-RL 第一次把这堵墙推倒了一部分：一台消费级显卡，一行 `pip install`，你就站在了 RTS Agent 研究的起跑线上。

...
url: "https://mp.weixin.qq.com/s/FmU7STuJLbDdLr1SwRe2yw"
publish_time: "2026-07-17 18:29:14"
account_name: "量子位"
read_count: 0
like_count: 0
share_count: 0
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGEk5cDAff2oWzR8d8q0o3upWsk2wWP4HRprSZJX5AnIeGH8icXicByjd4bv3JZzbCDzXNKFEDN644GBx5gy5hJ4H5L8Ew5PXq3ic4/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGECGkkEwa9OfT6nRKmORHQibT7kKFqbI2vxY5Subw1QKFticjCLOOuP0X0yTIfUvOUc80T0459x5LclBeyhMd2BGua0qOFh3caG0/640?wx_fmt=png&from=appmsg)

_GitHub开源链接：https://github.com/OpenBMB/StaffDeck_
...
它们像每一个普通职员一样，需要遵循SOP_（标准作业程序）_，需要依赖企业知识库支撑决策，更需要在日常工作中接受反馈、修正行为。
...
###### **![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGFTF78octQHEQRTKITe8COND9Oox3D4q9kNk1ialnQduNAavboTtwXQibjxqqiaWKiax01KXRwnrHdiaCmIBSVXib5mDTWwGic6uL7ydg/640?wx_fmt=png&from=appmsg)△**StaffDeck数字员工广场
...
###### **![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGES3XlP2NcsEIUO45Ej5BOFBibXiblWkibbF6h11yiaWpGuTqatjeSl7VXqtSwOxcBaBIn5qFRefGWsPuAZDCGpTQia5tXvTC89ExDM/640?wx_fmt=png&from=appmsg)△**流程型技能列表

######   

###### **![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGEjFX95Q0x0y8HFHAXbsibbaAj0m2VZ8TtYicptMXulpme9QY2cJ16USxicTMsFzjrdgYCdLKOdiaqaj0GqCRE12n0c0ekFib5DkJlY/640?wx_fmt=png&from=appmsg)△**SOP可视化编辑
...
StaffDeck率先引入了开放知识规范OKF_（Open Knowledge Format）_，给企业知识资产做了等级划分，划分结结果如下：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGEeUFWkGn9l4Mo56jACNwOIwN0V54ViaUsBhpvHBgIJwW7llpqe9L6CalsEqDSPvibkfqRYT5J5TCdZOdwW3OyWfQKXzWnVI06FA/640?wx_fmt=png&from=appmsg)

配合知识分桶管理和检索调试工具，管理员可以在后台清晰地看到每一次回答，命中了哪份文件的哪一个章节、相关度得分是多少，确保AI Agent的每次回答都可溯源、都有来处。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGHMmzZcKtH8QZljWpxE1br0x9b1piaVuVH9yGKz09pywU9Uw4OCZC4d3mgrbvwSyH8oyxFcsbsfnSe1kbhwibtPxn0O3bKhe6F9c/640?wx_fmt=png&from=appmsg)

![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGGfBHW8ONtlxF392Y0rXExaiaDW2sIfG0zxEicL39pW9Rf7SAJAXEvibxx2WAXPsswau7bAnDySqAVTvxBPGZq31VOkmickSfFjH5U/640?wx_fmt=png&from=appmsg)
...
当用户点了一个差评，系统会自动分类_（如「工具调用超时」）_，并直接给管理员指出SOP的修改方向。

更精妙的是**人工兜底机制**。

遇到制度里没有写明的灰色地带_（如「跨境差旅的汇率折算口径」）_，AI Agent绝不硬编答案，而是保留当前任务状态，向业务创建者发出求助。

人工搞定后，创建者可以顺手把这条经验手动补充到知识库中、或优化SOP。下次遇到同类问题时，它就已经是一名掌握该答案的「熟手」。

###### **![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGGEGWiaYFa8ThDXT2fUsOBUy3XTaGHdyRiaeS3I8HWMuPYW3WTSdBY2oW1Y53HXA1r6uYXVL2icY8oZ1zTnBnm47TZDh6IQzwqknM/640?wx_fmt=png&from=appmsg)△**数字员工工作记录

######   

###### **![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGGdrKcI1pR1hzzpjYLTM7YnHSiayAiclzNRVWOIFvneOpxDAno5moDJDavU0CKJEI8TOicOu1GEIPNNcKU9DMgfVNj5UibelcJert8/640?wx_fmt=png&from=appmsg)△**对话详情与任务结果
...
报销管家_（AI Agent）_就会自动执行操作：

识别出其中的两个任务，先进入报销流程，熟练地收集行程与金额——

在这个过程中，面对员工突然插入的提问_（「等一下，上海的餐补标准是多少来着？」）_，它暂停手头的活，去OKF知识库精准检索，附上文件链接和出处告知员工；
...
本次开源的**StaffDeck Preview预览版**，提供五个现成的数字员工_（包含财务报销、法务合规、人事服务、IT支持、行政管家）_，每个示例均配有完整的SOP和知识库。

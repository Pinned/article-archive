...
see_count: 80
comment_count: 0
stats_updated_at: "2026-07-08T10:05:56.953Z"
is_unavailable: 0
...
###### **![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGFwAWxtibTbibPm4KMiaD4WIgr8swmcrUho6Ql5O9skfNtNg3Ga95gHo8hsAW28LwhDHydfVzD1B88nlaX6bnaNnpNEpRdExMWCls/640?wx_fmt=png&from=appmsg)△**从计算机系统架构角度审视“程序语言”和“Skill语言”
...
###### **![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGEYnUA7C7fL85vh60ibenywZUseUuzIjNrcGicx2IEBXKzfmaXQYt3C8dOPs4RJu2Z9Zu7ricI9QSns55UmDoxVmDnGWURyNOsR1c/640?wx_fmt=png&from=appmsg)△**采取Skill前后，对于任务完成率的影响，红色表示下降，绿色表示上升
...
###### **![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGG8dmyiaIX3W7XawA89NetxeEbM2zWdfAoFoYv2woMXrNSiafCaXA9ibDvNj9MFP32BGmpxiaWMDyuGhXWSXEgbmWXSVYJGFWo1Gl0/640?wx_fmt=png&from=appmsg)△**SkVM整体架构：包含AOT编译优化和运行时优化两个部分
...
###### **![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGHSEgHhic0EntbkaclgfKICKhEHMfcXZYkCsRPHGK46Z8iae4ZFBicWWicRgUN8EicaricaicHDRQ7rdTfR3DXb9ONyzk7ITteHic67xR0/640?wx_fmt=png&from=appmsg)△**基于模型原子能力的skill编译
...
###### **![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGHicNR4pDgzdvfuticKzBxZL3QPHvbY7Q75jkzCtcCwl10ZStgrrlGjDCGiaibdWKlPyia84ZLEpUea26pjKkkVFWJ0d1tXtxs9u5icU/640?wx_fmt=png&from=appmsg)△**经过SkVM编译后和原始Skill在任务完成率上的对比，绿色深度表示提升的幅度，数字表示完成率分数

######   

###### **![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGEpiaEO7MrMUvVnQpeQU8QroeNbyYZjVcsYNLOL26F1eibgrNpnsNw75uJYicwb0icyfXZId4u53K6TZ2vibtFTVm7CM5Qb84cFV8ib4/640?wx_fmt=png&from=appmsg)△**不同模型+Harness下，没有Skill、原始Skill、Skill-creator、SkVM的任务完成率对比
...
###### **![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGFs0EjibzdqPmic9v32gcntoibFWaEP7BOtib9mYJbiagZVfYkSbrbTnpBEk465QAc7vueEur9ZBoWTQfExRv8klz7iam9fzib81Ydfe8/640?wx_fmt=png&from=appmsg)△**触发JIT-代码固化优化前后，token消耗量和执行延迟间的对比

目前，SkVM能够无缝键入openClaw，Hermes Agent，openJiuwen Agent、PI Agent等主流的Agent框架，支持Clawhub等主流的Skill生态。

_SkVM论文：https://arxiv.org/abs/2604.03088_  
_项目网站：https://skillvm.ai/_  
_项目仓库：https://github.com/SJTU-IPADS/SkVM/_

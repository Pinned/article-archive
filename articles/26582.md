---
id: 26582
title: "C罗刚头球破门，AI解说脱口而出！全模态实时流太狠了"
url: "https://mp.weixin.qq.com/s/WHxw4bQ213970kipWrad9Q"
...
see_count: 45
comment_count: 3
stats_updated_at: "2026-07-09T02:22:30.424Z"
is_unavailable: 0
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/Rvq8Ow69CYVV4XVLiaibRSCFU1liajs1OPic1yF6bcOLuAgCLNvvVDiabpwoicwictoZNp7Lq2YsPdYTOIUyBUPrJJN7FicYIyxU2CtboJurnwIODgA/640?wx_fmt=jpeg&from=appmsg)
...
##### **【新智元导读】只会聊天的Agent要下岗了！AI盯直播自己解说世界杯，懂战术还会切粤语，背后竟藏着一个流式Agent引擎。**
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYWvVJiasHMzJOZwlCZOaTBicqM0cg9JJ2wbZe8m33pQfJAAAqJt5VlflEibM19ck4NWYpwa31ibRAPNIlhosib0gV4B70xTOmy7SEA4/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/Rvq8Ow69CYVvib1565cic1ThTTnBtQul1ib2YFawfEl80jrxYOVFw0zaxe7lOXtnSs4zj54zBh0OuyRvrqOq0ia7Jw0xywPbkYS81NuZGlnUlak/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_gif/Rvq8Ow69CYXfrG25Za36cGiazG4fZlib7Nh90CKtDSD6snJOGUnucKxo3ovBKmOfmNKO902H1uVnIl2sgnvyCSXajGHDXKRppkp5kw1dauQsA/640?wx_fmt=gif&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/Rvq8Ow69CYXR50tsVpM6v3ut6ia5JiaKqIWtD5CjWZPJeTux6GxlfY4UPGQzdjQvfjlLF4ApUibIOWUQ3Rfd8G04nCEJ36CEygXNnGPqqaCXvY/640?wx_fmt=png&from=appmsg)
...
过去十几年，数据基础设施服务的是BI——做报表、跑分析、算指标。它处理的对象，是订单、点击、日志这类**结构化数据**，整整齐齐躺在数据库里。

驱动这一切的逻辑，是**BI-Driven**：人来提问，系统给出图表。

但今天，喂给AI的「燃料」变了。

在AI Agent时代，进来的数据变成了图像、语音、PDF文档、摄像头信号、车联网等全模态数据。

这意味着数据计算的驱动力，已经从**BI-Driven转向了AI-Driven**。

...
see_count: 12
comment_count: 7
stats_updated_at: "2026-07-09T02:58:08.789Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"思维链\",\"推理成本\",\"抽象符号\"]"
entities: "[]"
---
...
然而，推理模型的出现打破了这一预期。OpenAI 的 o 系列、Anthropic 的 Claude Extended Thinking、DeepSeek R1—— 这些模型在生成最终回答之前，会先在内部进行大量「思考」，产生数以千计的中间推理步骤，然后再吐出最终答案。这些中间步骤在账单上有个专门的名字：推理 token（reasoning tokens）。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqF9jNjNfnrcUP4obViapiczGxYvaU7yc1xeIr4f9sVPlNE0220PwUfYLvsFqSZl7b6bNmR6e4Dia9COK9zibEvGFMIEcTNNRCqoEKE/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqFBOWrGthBBjSiaNkH9rUBO33EWdYQ66iabIxQm7RDZXKUCV9fboB01AYZlbzfUyUibIybxSxyJzN741O9GDp6lia2Wh5e4MTwA1fU/640?wx_fmt=png&from=appmsg)
...
这套词汇表里没有任何一个人类能读懂的单词。它由一组特殊的占位符 token 组成，比如 <TOKEN\_A>、<TOKEN\_B>…… 一直到 <TOKEN\_Z>，之后继续用双字母扩展。这些符号对人类来说毫无意义，就像密码一样。但在论文的实验结果中，它们能够替代动辄数百步的自然语言推理链，把推理步骤压缩到几十个符号以内。
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGbNzhlWjf8mfVeHcgQuy5hFFXrygnyPs9YtyGcj9XNibMrYu6ws7icfcFkVh7UaQXjYg2S8gNGnzUibPlgurLiaTWIT3cmbSS9H30/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGe6BG8bHwjgwaKpx7OzdFiaP0Cx6ZnSy7kJVvFqeYQY5qnkJH9lemYBtxF1ibuXY6Xia6KDibIQN3g5QKDdibt2FTuyEbVf84ltu6w/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGo4y5CjJsWicdFkqgiblYiavb4O4UL7z2bFfEKespdHyg7kSV0A6gLUZPGaSl87licAkQRYEoZRKuJjSyzFmjrRglHMmKKfcVjpRc/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqEaQSLXpEfGEibHb3elvCFsZxS5Gt2nubbDc8QBiaNPOqjia7GlibuNgGESckn9cORI150zFS999NqmDyOm4djibrvLGQiaBiaIoDjC0Q/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqFbhZ9JBQuzCorjGjZl74Vl6aMrHNY3WraIebtW5owty1SBwMJfCMVavtiazeGicFcwvxkh5G9fuskvFvQmNQIiafSo7KS2KawnjA/640?wx_fmt=png&from=appmsg)

  

具体而言，一个叫做 <TOKEN\_F> 的符号，使用频率远超其他所有符号，成了这套「语言」中类似「的」或「是」一样的高频词。另一些符号，则像生僻字一样，只在特定情境下出现。

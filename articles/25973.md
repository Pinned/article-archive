...
see_count: 6
comment_count: 0
stats_updated_at: "2026-07-08T10:00:55.522Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"视频生成\",\"加速优化\",\"高分辨率\"]"
entities: "[]"
---
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGHfNyvZauk7zEjAkWjGxDqfmnlryV13FUHWBwfYkXNnriavicZy0jPJibZeYNjlJ2XCxhB6icXv3fZDOTFUBZexbNibVmBHmN5QCzwU/640?wx_fmt=png&from=appmsg)  
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGG1Lj0SCWCYDTDNrXnVO4gfJSQwF7EyibwTrCMeta9Kz9RxEY7DnjngO6h4snKxvPibcm7fWWhnG9BAsDsSO3TNDC1wATmrsG27Q/640?wx_fmt=png&from=appmsg)
...
*   基础模型像“原模型导演”，负责定下镜头语言、主体关系和运动走向。
    
*   “快速预览”负责让创作者更快看到多个候选方案，先挑中满意的内容。
    
*   Refiner则像“高清修图师”，把选中的预览补足纹理、结构和细节，最终输出高清成片。
    

这套分工的关键在于，SURF没有粗暴替换原模型，而是把原模型最有价值的生成先验保留下来，再把昂贵计算集中用在真正需要的地方。  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGHloKCbPibCuzZiajuJWtlvwibiceA4z0xBiceubg9vFm9icjo0zjtS3BB1Bx1Mq9lKffic5oGd6qceFRqOryQr0libqaTky6pcJ0UVrKo/640?wx_fmt=png&from=appmsg)
...
SURF的第一个关键技术，是**Noise Reshifting**。
...
它会先让模型在最优分辨率上完成**早期去噪**，让视频主体内容和整体结构先稳定下来。

到达转折步k后，系统再估计干净latent，将其下采样到低分辨率，并重新注入与当前时间步匹配的噪声，让后续去噪过程在低分辨率上继续推进。

这样一来，SURF既避免了一开始就低分辨率推理造成的先验损失，又能在后半段大幅减少token数和计算量。

###### **![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGHsY6Ku4jfUIlIsgbNoGdaUXrrtiaQ4TtUTFoKIamTjhia2nP9TkX053gctiaNYVFg6FEwS6IeFHJdEoibibTg0D1tnjF3xic59oLzbU/640?wx_fmt=png&from=appmsg)△**AI生成
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGEhkhb0nCAia2D90QQCa5Qd2zO3icr1Uf5icfFfjHS4C10nHut97AgJiaMkCaZs4aP9Yws3nWGcrQJSPkre3eDZvGQEc20mmB0FsDo/640?wx_fmt=png&from=appmsg)  
...
###### **![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGHuugN8aianjnp8oFZJKl26uUvjJDUVvwo5j86RcgSsZYx6KelmicdIBgZcpEjGvHKAMmRNQdGIJVFK9edibOmoOTxftGMVePKJPY/640?wx_fmt=png&from=appmsg)△**AI生成

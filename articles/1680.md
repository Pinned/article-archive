---
id: 1680
title: "蚂蚁具身智能明牌了：做大脑，和宇树们错位竞争"
url: "https://mp.weixin.qq.com/s/5d_nTy6YnkHJqA0C0QIOdQ"
...
see_count: 127
comment_count: 5
stats_updated_at: "2026-07-04T12:32:49.776Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"具身智能\",\"机器人大脑\",\"错位竞争\"]"
entities: "[\"蚂蚁\",\"宇树\"]"
---
...
真实世界数据里的**Scaling Law**，直接喂出了个**最强VLA（Vision-Language-Action）基座模型！**

![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtDSB8Ex7bxvSepA21zRsCZo1bVlaT37bgtq7uQibRGOhaGoVIoDFoBPUOFImLvhkJgukvkSRyyC83Q/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtDSB8Ex7bxvSepA21zRsCZo0uTWVwh4L8yCBOwnejiamvWW3sPymvJ2cSsFtQ7mm9BATPSu3864Bwg/640?wx_fmt=png&from=appmsg)
...
从3000小时到20000小时，首次在真实世界场景中，系统性地验证了VLA模型性能会随着数据规模扩大而持续提升的**Scaling Law**。
...
![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtDSB8Ex7bxvSepA21zRsCZoxCqgDtc25ErSeHG4EnzFG1tnw57niaGAcNXTnhHXNj29Y8icL51PozCQ/640?wx_fmt=png&from=appmsg)

> 一个大脑，多个身体，这就是规模化之道。

![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtDSB8Ex7bxvSepA21zRsCZofOsTria4uF0JVKXXRTwSmtv2NELibWthyianRe40PPntqQW1n2tvb99oQ/640?wx_fmt=png&from=appmsg)
...
因此，蚂蚁灵波团队的选择是这样的：仿真的不好使，那就**全部采用真实世界的机器人操作数据**。
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/YicUhk5aAGtDSB8Ex7bxvSepA21zRsCZoBTkKAuRDgrrBUK5KhGHAmDMZ5d3M4onicewllicSArcB7AjGadsnIVCQ/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtDSB8Ex7bxvSepA21zRsCZo5luAYrQwKkAY6QhFhF2K3Yaiaovw1iabLCftyXo5ib8miclYCXzqdmZjCQ/640?wx_fmt=png&from=appmsg)

它采用了一种名为**专家混合Transformer**的架构，可以将其理解为为机器人设计了一套大脑与小脑协同工作的系统：
...
为的就是让机器人不仅看得见，还能感知距离——引入了自研的[LingBot-Depth](https://mp.weixin.qq.com/s?__biz=MzIzNjc1NzUzMw==&mid=2247864464&idx=1&sn=c666041b76ef36ba1072faf0609457aa&scene=21#wechat_redirect)深度估计模型提供的深度信息。
...
![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtDSB8Ex7bxvSepA21zRsCZofia9K7xysiaU9G6HPC9XMxZ1UWqBaCuwOBCJWHnoBr6jwQG9tq3SPL5w/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtDSB8Ex7bxvSepA21zRsCZoPduysJ9VYyXEJxlgfs5d4lMibgMJkiaDzqA2g7SibSnVRdJFQrEXnDfOQ/640?wx_fmt=png&from=appmsg)

在仿真基准RoboTwin 2.0上，优势依旧明显。

在物体位置、背景、灯光高度随机化的复杂场景中，LingBot-VLA相比π0.5取得了近10个百分点的绝对成功率提升。

![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtDSB8Ex7bxvSepA21zRsCZoiaFQnicoVD4bOWicGsBJehGVkZNxgUecyc2tCGM635KX60S5vde9xnocg/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtDSB8Ex7bxvSepA21zRsCZovG5xSaDc0tZtWh88aN96CNSUTuNVro1vQhWbKWJickWActuekzEy2aA/640?wx_fmt=png&from=appmsg)
...
LingBot-VLA提供的是一种**通用智能基座**思路，也就是不做机器人的本体，但求做一个通用大脑：通过在海量异构真实数据上预训练，模型学会了跨越不同硬件平台的、本质性的操作逻辑和物理理解。
...
1.  可复现的评估：GM-100基准与全部22500次测试录像开源，树立了行业评测新标准。
    
2.  低成本后训练：高效的代码库与数据高效性优势（实验显示，仅用对手60%的数据量就能达到更好效果），让企业能用更少的数据、更低的算力成本完成对特定场景的适配。

...
see_count: 95
comment_count: 12
stats_updated_at: "2026-07-04T11:28:44.749Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"Codex架构\",\"规模用户\",\"竞品对抗\"]"
entities: "[\"OpenAI\",\"Codex\",\"Claude\"]"
---
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/UicQ7HgWiaUb1rN7ibhhNwUdggUfPs8G8BibErVx5aJ4yELFn8NMngO1sO8jn82w2EpmXHHoibiaGlM0eUhEpp8qhxmg/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/UicQ7HgWiaUb1rN7ibhhNwUdggUfPs8G8BibicMVMeIhf0MUuPhrIjgiaJgTXADZicWLvYy2M7iaIJP9F7HTvJ3Zvzia3qw/640?wx_fmt=png&from=appmsg)![](https://mmbiz.qpic.cn/sz_mmbiz_png/UicQ7HgWiaUb1rN7ibhhNwUdggUfPs8G8BibGMmJToiaicLC3YFYblDlYsl7b5LC0KhGGavNO1kM5qu8icg6DkCh6jIlA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/UicQ7HgWiaUb1rN7ibhhNwUdggUfPs8G8Bib0Pn8W6gGFQbYICu9FIe7XKfT8cUMQqGGYgcib9PXbmqK2KiakW1NkzFA/640?wx_fmt=png&from=appmsg)![](https://mmbiz.qpic.cn/sz_mmbiz_png/UicQ7HgWiaUb1rN7ibhhNwUdggUfPs8G8BibJibFOBOmBRXAAcliaWAfK57dW3ldXDFn6mdEalm9PPJqQkvTU7zpvicJg/640?wx_fmt=png&from=appmsg)
...
答案就藏在一个叫**Agent Loop（智能体循环）**的东西里。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/UicQ7HgWiaUb1rN7ibhhNwUdggUfPs8G8BibzamW54tjxicniaQorxZAZtRZLUm6wQ6KwdvOwLqX9BwfKgjLkddHnLTA/640?wx_fmt=png&from=appmsg)

简单来说，Agent Loop就像一个「总指挥」，它负责把「用户意图」「模型大脑」和「执行工具」串成一个完美的闭环。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/UicQ7HgWiaUb1rN7ibhhNwUdggUfPs8G8Bib0Pn8W6gGFQbYICu9FIe7XKfT8cUMQqGGYgcib9PXbmqK2KiakW1NkzFA/640?wx_fmt=png&from=appmsg)

这不是普通的「你问我答」，而是一个包含了「观察-思考-行动-反馈」的**能干活的系统**。
...
*   **我有什么****工具****（Tools）**：有哪些工具可以调用（比如shell命令、文件操作）
    
*   **环境上下文****（Context）**：当前在哪个目录、用的什么shell
    
*   **用户****指令**：给README.md加一个架构图。
...
_「用户想加架构图，我得先看看现在的README是什么样的……__」_

然后模型做出决定：**调用shell工具，执行**catREADME.md。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/UicQ7HgWiaUb1rN7ibhhNwUdggUfPs8G8BibWo0TK5wEjlBLetR5B1Y2KMr6gicNicGe6kv2VEfG3yPrQaSvUibcNGOiaA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/UicQ7HgWiaUb1rN7ibhhNwUdggUfPs8G8BibYDvtMcrtK3fH1fVQwZFxgbRtakGYV7vzrF1TrZqzgt05alO7T9sIXQ/640?wx_fmt=png&from=appmsg)

普通的总结（Summary）只是把长文本变成短文本，会丢失大量细节。

OpenAI的Compaction返回的是一段**encrypted\_content（加密内容），**保留了模型对原始对话的「隐性理解」。
...
它**只用1个PostgreSQL主节点+50个只读副本就****做到****了。**

![](https://mmbiz.qpic.cn/sz_mmbiz_png/UicQ7HgWiaUb1rN7ibhhNwUdggUfPs8G8BibylJzxa5GG7uceoo94rPyjt7VR7ziaQ2rIABibkqZe7ViaibibpggxXJ65cQ/640?wx_fmt=png&from=appmsg)

8亿用户，这简直是在开玩笑！有网友惊叹。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/UicQ7HgWiaUb1rN7ibhhNwUdggUfPs8G8Bibf6Spd2AZTXsT2bSd1vt6pqR2sG9TibEvibr3l1geBxX6D9pDv3esREdg/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/UicQ7HgWiaUb1rN7ibhhNwUdggUfPs8G8Bibcs9CSZc72r94w7tE2jbYC8cjSfKkcmzMvwxDL4l8VIxYyJGyiaia1muQ/640?wx_fmt=png&from=appmsg)

他们是怎么做到的？

![](https://mmbiz.qpic.cn/sz_mmbiz_png/UicQ7HgWiaUb1rN7ibhhNwUdggUfPs8G8BibjT8TJuFunosSCajQzlsHVFDFjicUCwyf7daA2fXJNYnSIibplQnianNGw/640?wx_fmt=png&from=appmsg)
...
当缓存未命中时，只允许**一个请求**去数据库查询并回填缓存，其他请求等待。

这避免了「缓存雪崩」——大量请求同时涌向数据库的灾难场景。

3.查询优化与负载隔离

团队发现并修复了一个涉及**12张表连接**的复杂查询。
...
PostgreSQL的多版本并发控制（MVCC）机制会导致**写放大**（更新一行需要复制整行）和**读放大**（扫描时需要跳过死元组）。对于写密集型负载，这是个硬伤。
...
1\. 把可分片的、高写入负载迁移到**Azure****Cosmos****DB**等分布式系统；

2\. 测试**级联复制**：让中间副本向下游副本转发WAL，目标是支持**超过100个副本****。**
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/UicQ7HgWiaUb1rN7ibhhNwUdggUfPs8G8BibfQb8opIzo7ZicJjOGianSrtwYammI83p31Aou8MJGicib0fml3SPEZwpJw/640?wx_fmt=png&from=appmsg)

![](https://mmbiz.qpic.cn/sz_mmbiz_png/UicQ7HgWiaUb3uEdSPKrwGNmZEOaaGyzVvZ8dTtE9jU1rFsda3llYbCZpmWfiazUYjWBLTGvlPpXucH8Q0lEUJN3Q/640?wx_fmt=png&from=appmsg)

**Codex VS Claude Code的争霸赛**

Claude Code的杀手锏是什么？是**端到端的开发体验**。

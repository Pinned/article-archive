...
url: "https://mp.weixin.qq.com/s/eiFXdsi56FGVsjaZF1RUnA"
publish_time: "2026-07-14 18:44:17"
account_name: "机器之心"
read_count: 23828
like_count: 133
share_count: 756
see_count: 90
comment_count: 9
stats_updated_at: "2026-07-16T06:45:10.418Z"
is_unavailable: 0
snapshot_reason: "success"
topics: "[\"视频理解\",\"音频理解\",\"物理情境\"]"
entities: "[]"
---
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqHTiaSPNVibovo53I8kgIWIxe9rWAnm8GtuEyxjuyAXjsTzKscA0CWdxIDX2OV1TGAHnQIsRz7KUAkTOtKtRfvrFw6TFrwkKdcF0/640?wx_fmt=png&from=appmsg)
...
而在 WAIC 世界人工智能大会前夕，模思智能与 OpenMOSS 团队又在多模态理解侧连续发布新进展：一边面向实时视频流理解的 MOSS-VL-Realtime 开源，一边推出多说话人转写模型 MOSS-Transcribe-Diarize-0.9B。与此同时，面向创作者和开发者的 Mossland AIGC 音视频创作平台与 Moss 开放平台也进入公测阶段。
...
1.  随时应答：用户可以在视频播放任意时刻提问，模型基于当前已观测画面即时回应，而不必等待整段视频结束。
    
2.  主动沉默：当画面中没有关键事件，或信息不足以形成判断时，模型将保持沉默，持续观察。
    
3.  边看边答，及时纠正：模型在生成回答时，新的画面仍会持续进入上下文。一旦视频内容发生突发转折，模型可立刻打断甚至修正此前回答。
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGjxejibAzvpXdgq4S75ic70iaPzBhj1rpTM4f0RQQwPu5phuPUr47IL43iaLuNBjFJ7o9GIy2s200QzMkI7ria3gtia0bJj0B7GFUwo/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGowpbKH2Xo72n4yTVGATS3XRZNcuAzDFA7N6yMPYEriavicR3lfRXlgNsOicS6iaEU3MVlDvMHS62w9cULhxCrjCV66QpLTfSaUgM/640?wx_fmt=png&from=appmsg)
...
*   推理性能实现跨越式提升。目前模型已完成从底层训练代码到推理引擎的全链路适配，包含 SGLang 官方支持。实测视频推理端到端吞吐较 Transformers 原生实现提升超 4.57 倍；在同使用 SGLang 框架的条件下，推理性能较 Qwen3-VL 提升 5.48 倍。
...
![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqHNMGalObBfnzJabWYmB0Y7GSdlicDHSrxv5n2ka4Bs8wcrev5LjwXN1BgDUhCYkcLSUz8sxSsian5sHSmmZZntvV8ZClkN6DiaPc/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGO7m092wQCqMa3nGHGiaQWPF5v2x9PH7U4asbBLxdFFlx7ShUZdHDr2eSCk26KXy6cricUxEcj419ibSibdL97lgibUx3CCI2QBNKI/640?wx_fmt=png&from=appmsg)

  

此次，MOSS-Transcribe-Diarize 在性能升级的同时，首次推出并开源仅 0.9B 参数的轻量版本，让这套端到端多说话人转录能力能够以更低成本部署和使用。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/5L8bhP5dIqGBYbPCPvmuj4jSYTBGpKmAgWicHdH69BRWPJk3j1ZgkNZCoVugzch4ueeLvoBw8ezbqTXMlnpswXRAjiatWb2OCwqYE0zgiaOCSk/640?wx_fmt=png&from=appmsg)
...
开源后，MOSS-Transcribe-Diarize-0.9B 很快登上 Hugging Face Audio-Text-to-Text 模型 Trending 榜单第一名。而在7/14 公布的「INTERSPEECH2026 多语种对话语音语言模型挑战赛」 （MLC-SLM）中，MOSS-Transcribe-Diarize 也拿到了冠军。

  

![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqEY4ibGMpNBB8cvE1FibOr0sygjKiaFfOS8gevX8Muj1WjZdzw4CHnpdhFnwAfmNMBuuKPTwHicuic7l3gvElibLy9weYFa4mNsBibwF8/640?wx_fmt=png&from=appmsg)
...
与此同时，模思智能还上线了更强的 MOSS-Transcribe-Diarize Pro 版本。相比开源版本，Pro 版本面向商业场景，在说话人区分、上下文理解、转写准确率和多语言能力等方面进一步增强，可服务于企业会议转录、客服质检、访谈整理和内容生产等场景。开发者可以在模思开放平台（platform.mosi.cn）进行调用。

  

模思智能还同步发布了面向复杂英语场景的语音识别模型 MOSS-Transcribe。据介绍，该模型针对标准英语、多样口音、低声耳语等真实场景进行了专项优化，并在 OPENASR Leaderboard 中取得全球开源模型第一的表现。

  

![](https://mmbiz.qpic.cn/mmbiz_png/5L8bhP5dIqGyGsLRyfzjDSBAAmEj50F7icRWEsOicicLKl0dl894z82ib5gtQSG1FDY0II6bVREdiaVkHyc4Op8WQ1tC8A3yZlV2zBIXZ0OFibClk/640?wx_fmt=png&from=appmsg)
...
在连续开源理解侧模型的同时，模思智能也上线了面向创作者和开发者的产品入口：Mossland AIGC 音视频创作平台与 Moss 开放平台。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_gif/5L8bhP5dIqGxVLFkN8yky0RTLjnUn6zyMYNwvSrcpnzGh9rAmOYsNYNcYdXmzRYBaOL5ibC22jbBjSW4svhKcWMUzG1JGNABd8UN8NhEQqf0/640?wx_fmt=gif&from=appmsg)

  

其语音合成能力来自模思智能自研的 MOSS-TTS Family，包括千种音色以上的音色库、高保真零样本音色克隆、多角色对话、角色声音设计、音效生成与实时流式语音等能力，并围绕视频配音、AI 播客、图视频模板、多模态内容制作工作流等真实创作场景，为创作者提供以声音为起点的智能创作体验。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_gif/5L8bhP5dIqE1NYewCK194mDGP2rI6ibKMuFZymPOU9DE1gBVFT75vNXaRozSrl7ZWRmqnaQo47sGV2rZdzOm5vUwr85oWBOmPM60HLD2Mjus/640?wx_fmt=gif&from=appmsg)

  

MossAPI（Moss 开放平台）则面向开发者开放 MOSS 系列模型能力，强调开放接入和灵活集成。开发者可以通过 API 调用语音合成、语音识别、音视频理解等能力，并与 Mossland 创作者平台共用积分系统。平台中的 Playground 支持开发者在线体验最新上线的 MOSS 模型。其中，MOSS-Transcribe-Diarize Pro 和 MOSS-VL 已经或即将通过 Moss 开放平台提供 API 调用服务。前者可用于企业会议转录、客服质检和内容生产；后者则可应用于更广泛的视频理解与视觉理解场景。
...
本代共开源三个同源模型：Realtime 面向持续视频流，Instruct 承接离线任务，Base 供继续预训练与微调，均为 Apache-2.0 协议。

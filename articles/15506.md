---
id: 15506
title: "深度拆解 Hermes Agent 的记忆系统：它如何修正 OpenClaw 的误区"
url: "https://mp.weixin.qq.com/s/Oq33YStOaYOdzQ7wXHii9w"
publish_time: "2026-04-30 03:07:58"
account_name: "宝玉AI"
read_count: 3676
like_count: 100
share_count: 661
see_count: 52
comment_count: 4
stats_updated_at: "2026-07-09T05:46:42.022Z"
is_unavailable: 0
snapshot_reason: "网络同步补齐"
topics: "[\"记忆系统\",\"智能体\",\"架构设计\"]"
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/ZlwY8rlDcFOicnolagRLc90ibpU7CibWmd00b9yz7Eiazkdua9bG2j2OeNef8OksMofHEORIhPuyEdVhibyObX2CQnFp65gsl2av0hLC0ECXKic0Q/640?from=appmsg)

让我们深入聊聊。

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/ZlwY8rlDcFPFic7BXeLribXiadNhmZ9X0SHXuhwiamZ4WOavNhEvG9v7lDicV5PcvJXL2DciaJ5Xq9VkJEWDU1dgpkTickoXZe8IdeDywHQyZvHxCU/640?from=appmsg)
...
`[0] 默认智能体身份   [1] 工具使用行为指南   [2] Honcho 集成模块（可选）   [3] 可选系统消息   [4] 固化的 MEMORY.md 快照   [5] 固化的 USER.md 快照   [6] 技能索引   [7] 上下文文件（AGENTS.md, SOUL.md 等规则文件）   [8] 日期/时间 + 平台信息   [9] 对话历史   [10] 当前用户消息`
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/ZlwY8rlDcFOBN4Em6p1vB6GJmBLKkOiayDXUy8O9IdjXJmYKkUclNQxVYMbNU46SlXv5IzwO9eG7zBSVS2WEWk8Zy98hoYKZh2zYtVNtLEL0/640?from=appmsg)
...
`══════════════════════════════════════════════   MEMORY (你的个人笔记) [67% — 1,474/2,200 字符]   ══════════════════════════════════════════════   用户的项目是一个位于 ~/code/myapi 的 Rust Web 服务，使用 Axum + SQLx   §   这台机器运行 Ubuntu 22.04，安装了 Docker 和 Podman   §   用户喜欢简洁的回复，讨厌冗长的解释`
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/ZlwY8rlDcFNOenichwEanAtUtrDsnjFPXjX03Ldt0wicwasbd04AncyQ07RY0n9Ak52JPnRXO8GbAnoRPH317zTFY8xNEYPzH5DYWwOOwrSpI/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/ZlwY8rlDcFOnIM3Mkcoa0IibxVhJYgmgfOVFicTkoHwlO8olCQaV18sCkYp9dicy4IRCO7OcSTGyIqrps4ofQtO7ts0lJuePnNPjBKKsZFeMic0/640?from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/ZlwY8rlDcFPXXNIt0tTvNRpnXwwAmEAHrPicCpvaauEXaR6IyGPWMRrM4k2ib3OMAp38NCHbdA4Sbu5iaIoQFdXib8CAAFRLqIIibIET3I2zOwq4/640?from=appmsg)
...
`[1]` I Read Hermes Agent's Memory System, and It Fixes What OpenClaw Got Wrong: _https://x.com/manthanguptaa/status/2034849672985288957_
